...
public final class TextViewKt$addTextChangedListener$1 extends Lambda implements y1a<CharSequence, Integer, Integer, Integer, xhv> {
    ...
    public static /* synthetic */ Object ipc$super(TextViewKt$addTextChangedListener$1 textViewKt$addTextChangedListener$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/core/widget/TextViewKt$addTextChangedListener$1");
    }
