...
public final class PersistableBundleKt {
    ...
    public static final PersistableBundle persistableBundleOf(Pair<String, ? extends Object>... pairArr) {
        ...
        if (ipChange instanceof IpChange) {
            return (PersistableBundle) ipChange.ipc$dispatch("7aef972e", new Object[]{pairArr});
        }
    ...
    public static final PersistableBundle toPersistableBundle(Map<String, ? extends Object> map) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (PersistableBundle) ipChange.ipc$dispatch("ad08df7", new Object[]{map});
        }
    ...
    public static final PersistableBundle persistableBundleOf() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PersistableBundle) ipChange.ipc$dispatch("d66e8db2", new Object[0]) : PersistableBundleApi21ImplKt.createPersistableBundle(0);
    }
}
