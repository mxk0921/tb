...
public class FindAddress {
    ...
    public static boolean isValidLocationName(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("415bb07", new Object[]{str})).booleanValue();
        }
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("3e0d2a1e", new Object[]{str, matchResult})).booleanValue();
        }
        if (matchResult == null) {
            return false;
        }
    ...
    public static MatchResult matchState(String str, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MatchResult) ipChange.ipc$dispatch("13fa369d", new Object[]{str, new Integer(i)});
        }
    ...
    */
    ...
    private static boolean checkHouseNumber(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("ab8ed036", new Object[]{str})).booleanValue();
        }
        int i = 0;
    ...
    public static MatchResult matchHouseNumber(String str, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MatchResult) ipChange.ipc$dispatch("f468b1e5", new Object[]{str, new Integer(i)});
        }
    ...
    public static boolean isValidZipCode(String str, String str2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("db177d7b", new Object[]{str, str2})).booleanValue() : isValidZipCode(str, matchState(str2, 0));
    }

    public static boolean isValidZipCode(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("1d22d4f1", new Object[]{str})).booleanValue() : sZipCodeRe.matcher(str).matches();
    }
}
