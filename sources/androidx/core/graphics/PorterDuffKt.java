...
public final class PorterDuffKt {
    ...
    public static final PorterDuffColorFilter toColorFilter(PorterDuff.Mode mode, int i) {
        ...
        if (ipChange instanceof IpChange) {
            return (PorterDuffColorFilter) ipChange.ipc$dispatch("eae2315c", new Object[]{mode, new Integer(i)});
        }
    ...
    public static final PorterDuffXfermode toXfermode(PorterDuff.Mode mode) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (PorterDuffXfermode) ipChange.ipc$dispatch("252bd2fb", new Object[]{mode});
        }
