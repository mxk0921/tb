...
public final class CursorKt {
    ...
    public static final byte[] getBlobOrNull(Cursor cursor, int i) {
        ...
        if (ipChange instanceof IpChange) {
            return (byte[]) ipChange.ipc$dispatch("dfe1698d", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Double getDoubleOrNull(Cursor cursor, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Double) ipChange.ipc$dispatch("7a911b5c", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Float getFloatOrNull(Cursor cursor, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Float) ipChange.ipc$dispatch("d9e872ac", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Integer getIntOrNull(Cursor cursor, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Integer) ipChange.ipc$dispatch("113ea49d", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Long getLongOrNull(Cursor cursor, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Long) ipChange.ipc$dispatch("d7889086", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Short getShortOrNull(Cursor cursor, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Short) ipChange.ipc$dispatch("8f5de6ac", new Object[]{cursor, new Integer(i)});
        }
        if (cursor.isNull(i)) {
            return null;
        }
