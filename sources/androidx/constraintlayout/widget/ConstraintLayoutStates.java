...
public class ConstraintLayoutStates {
    ...
    public static class State {
        ...
        public void add(Variant variant) {
            ...
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("832c42c6", new Object[]{this, variant});
            } else {
    ...
    public void updateConstraints(int i, float f, float f2) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("e9afd60f", new Object[]{this, new Integer(i), new Float(f), new Float(f2)});
            return;
        }
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("b20555f9", new Object[]{this, context, xmlPullParser});
            return;
        }
        ConstraintSet constraintSet = new ConstraintSet();
