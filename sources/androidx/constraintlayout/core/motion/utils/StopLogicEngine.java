...
public class StopLogicEngine implements StopEngine {
    ...
    private float calcY(float f) {
        ...
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("88d769e5", new Object[]{this, new Float(f)})).floatValue();
        }
        this.mDone = false;
    ...
    public float getVelocity(float f) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("2e697596", new Object[]{this, new Float(f)})).floatValue();
        }
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            float f3 = this.mStage1Velocity;
    ...
    public static class Decelerate implements StopEngine {
        ...
        public float getVelocity() {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("aeea9d4a", new Object[]{this})).floatValue() : this.mLastVelocity;
        }
    }
    ...
    private void setup(float f, float f2, float f3, float f4, float f5) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("cb56f1bc", new Object[]{this, new Float(f), new Float(f2), new Float(f3), new Float(f4), new Float(f5)});
            return;
        }
        this.mDone = false;
    ...
    public float getVelocity() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("aeea9d4a", new Object[]{this})).floatValue() : this.mBackwards ? -getVelocity(this.mLastTime) : getVelocity(this.mLastTime);
    }
}
