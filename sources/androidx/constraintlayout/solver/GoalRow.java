...
public class GoalRow extends ArrayRow {
    ...
    public static /* synthetic */ Object ipc$super(GoalRow goalRow, String str, Object... objArr) {
        if (str.hashCode() == 2052372106) {
            super.addError((SolverVariable) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/constraintlayout/solver/GoalRow");
    }
