...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initCubic(float f, float f2, float f3, float f4) {
        ...
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("18533721", new Object[]{this, new Float(f), new Float(f2), new Float(f3), new Float(f4)});
            return;
        }
        Path path = new Path();
    ...
    private void initPath(Path path) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("19c9e5dc", new Object[]{this, path});
            return;
        }
    ...
    private void initQuad(float f, float f2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("255a73fe", new Object[]{this, new Float(f), new Float(f2)});
            return;
        }
        Path path = new Path();
        path.moveTo(0.0f, 0.0f);
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("6544ba67", new Object[]{this, typedArray, xmlPullParser});
