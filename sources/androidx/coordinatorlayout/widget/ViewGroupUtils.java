...
public class ViewGroupUtils {
    ...
    public static void getDescendantRect(ViewGroup viewGroup, View view, Rect rect) {
        ...
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("78f95604", new Object[]{viewGroup, view, rect});
            return;
        }
    ...
    private static void offsetDescendantMatrix(ViewParent viewParent, View view, Matrix matrix) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("ff78d73a", new Object[]{viewParent, view, matrix});
            return;
        }
    ...
    public static void offsetDescendantRect(ViewGroup viewGroup, View view, Rect rect) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("f220c2c1", new Object[]{viewGroup, view, rect});
            return;
        }
