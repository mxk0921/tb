...
public final class LocalBroadcastManager {
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new Handler(context.getMainLooper()) { // from class: androidx.localbroadcastmanager.content.LocalBroadcastManager.1
            ...
            public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/localbroadcastmanager/content/LocalBroadcastManager$1");
            }
    ...
    public static LocalBroadcastManager getInstance(Context context) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (LocalBroadcastManager) ipChange.ipc$dispatch("7981b2c", new Object[]{context});
        }
        synchronized (mLock) {
            try {
                if (mInstance == null) {
                    ...
                    while (i2 < arrayList.size()) {
                        ...
                        if (receiverRecord.broadcasting) {
                            ...
                            if (match >= 0) {
                                ...
                                sb4.append("  Filter did not match: ");
                                sb4.append(str);
                            }
                        }
                        i2 = i + 1;
