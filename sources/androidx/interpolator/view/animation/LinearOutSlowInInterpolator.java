...
public class LinearOutSlowInInterpolator extends LookupTableInterpolator {
    ...
    public static /* synthetic */ Object ipc$super(LinearOutSlowInInterpolator linearOutSlowInInterpolator, String str, Object... objArr) {
        if (str.hashCode() == 583500507) {
            return new Float(super.getInterpolation(((Number) objArr[0]).floatValue()));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/interpolator/view/animation/LinearOutSlowInInterpolator");
    }
