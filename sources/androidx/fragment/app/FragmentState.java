...
public final class FragmentState implements Parcelable {
    public static final Parcelable.Creator<FragmentState> CREATOR = new Parcelable.Creator<FragmentState>() { // from class: androidx.fragment.app.FragmentState.1
        ...
        public FragmentState createFromParcel(Parcel parcel) {
            ...
            return ipChange instanceof IpChange ? (FragmentState) ipChange.ipc$dispatch("9fd1352e", new Object[]{this, parcel}) : new FragmentState(parcel);
        }
        ...
        public FragmentState[] newArray(int i) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (FragmentState[]) ipChange.ipc$dispatch("c7d617e5", new Object[]{this, new Integer(i)}) : new FragmentState[i];
        }
    };
