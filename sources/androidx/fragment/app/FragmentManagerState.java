...
public final class FragmentManagerState implements Parcelable {
    public static final Parcelable.Creator<FragmentManagerState> CREATOR = new Parcelable.Creator<FragmentManagerState>() { // from class: androidx.fragment.app.FragmentManagerState.1
        ...
        public FragmentManagerState createFromParcel(Parcel parcel) {
            ...
            return ipChange instanceof IpChange ? (FragmentManagerState) ipChange.ipc$dispatch("6ead3f3", new Object[]{this, parcel}) : new FragmentManagerState(parcel);
        }
        ...
        public FragmentManagerState[] newArray(int i) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (FragmentManagerState[]) ipChange.ipc$dispatch("9dfac55c", new Object[]{this, new Integer(i)}) : new FragmentManagerState[i];
        }
    };
