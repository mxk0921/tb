...
public final class Utf8Safe extends Utf8 {
    ...
    private static int computeEncodedLength(CharSequence charSequence) {
        ...
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("5281493b", new Object[]{charSequence})).intValue();
        }
    ...
    public static String decodeUtf8Array(byte[] bArr, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("1db4dc18", new Object[]{bArr, new Integer(i), new Integer(i2)});
        }
    ...
    */
    private static int encodeUtf8Array(java.lang.CharSequence r11, byte[] r12, int r13, int r14) {
        /*
    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("5aee2f1f", new Object[]{charSequence, byteBuffer});
            return;
        }
        int length = charSequence.length();
        ...
        while (i2 < length) {
            ...
            if (charAt2 < 128) {
                ...
                int i3 = position + 1;
                try {
                    byteBuffer.put(position, (byte) ((charAt2 >>> 6) | tck.DETECT_WIDTH));
                    byteBuffer.put(i3, (byte) ((charAt2 & f7l.CONDITION_IF) | 128));
                    position = i3;
                ...
                byteBuffer.put(position, (byte) ((charAt2 & f7l.CONDITION_IF) | 128));
            } else {
                int i5 = i2 + 1;
                if (i5 != length) {
                    try {
    ...
    public static /* synthetic */ Object ipc$super(Utf8Safe utf8Safe, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/emoji2/text/flatbuffer/Utf8Safe");
    }
    ...
    private static int encodedLengthGeneral(CharSequence charSequence, int i) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("ce7957f7", new Object[]{charSequence, new Integer(i)})).intValue();
        }
        int length = charSequence.length();
        while (i < length) {
            char charAt = charSequence.charAt(i);
    ...
    public static String decodeUtf8Buffer(ByteBuffer byteBuffer, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("fc0d61f5", new Object[]{byteBuffer, new Integer(i), new Integer(i2)});
        }
