...
public abstract class CreationExtras {
    ...
    public static final class Empty extends CreationExtras {
        ...
        public static /* synthetic */ Object ipc$super(Empty empty, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/lifecycle/viewmodel/CreationExtras$Empty");
        }
    ...
    public final Map<Key<?>, Object> getMap$lifecycle_viewmodel_release() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Map) ipChange.ipc$dispatch("7d4c3995", new Object[]{this});
        }
        return this.map;
    }
}
