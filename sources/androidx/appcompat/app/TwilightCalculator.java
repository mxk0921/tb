...
public class TwilightCalculator {
    ...
    public static TwilightCalculator getInstance() {
        ...
        if (ipChange instanceof IpChange) {
            return (TwilightCalculator) ipChange.ipc$dispatch("cf2578f1", new Object[0]);
        }
        if (sInstance == null) {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d86482c7", new Object[]{this, new Long(j), new Double(d), new Double(d2)});
            return;
        }
        double d4 = (0.01720197f * (((float) (j - UTC_2000)) / 8.64E7f)) + 6.24006f;
        double sin = d4 + (Math.sin(d4) * 0.03341960161924362d) + (Math.sin(2.0f * f2) * 3.4906598739326E-4d) + (Math.sin(f2 * 3.0f) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
