...
public class FitWindowsLinearLayout extends LinearLayout implements FitWindowsViewGroup {
    ...
    public static /* synthetic */ Object ipc$super(FitWindowsLinearLayout fitWindowsLinearLayout, String str, Object... objArr) {
        if (str.hashCode() == -857843821) {
            return new Boolean(super.fitSystemWindows((Rect) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/appcompat/widget/FitWindowsLinearLayout");
    }
