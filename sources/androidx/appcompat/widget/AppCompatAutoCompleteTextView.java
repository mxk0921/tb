...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatAutoCompleteTextView> {
        ...
        public void readProperties(AppCompatAutoCompleteTextView appCompatAutoCompleteTextView, PropertyReader propertyReader) {
            ...
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("169bcba", new Object[]{this, appCompatAutoCompleteTextView, propertyReader});
    ...
    public static /* synthetic */ Object ipc$super(AppCompatAutoCompleteTextView appCompatAutoCompleteTextView, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1919838530:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/appcompat/widget/AppCompatAutoCompleteTextView");
        }
    }
