...
public final class SystemBarStyle$Companion$light$1 extends Lambda implements g1a<Resources, Boolean> {
    ...
    public static /* synthetic */ Object ipc$super(SystemBarStyle$Companion$light$1 systemBarStyle$Companion$light$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/activity/SystemBarStyle$Companion$light$1");
    }
