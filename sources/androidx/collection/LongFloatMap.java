...
public abstract class LongFloatMap {
    ...
    public /* synthetic */ LongFloatMap(a07 a07Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("127fcaba", new Object[]{longFloatMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, new Integer(i2), obj});
        }
        if (obj == null) {
            if ((i2 & 1) != 0) {
                charSequence = ", ";
            ...
            return longFloatMap.joinToString(charSequence, charSequence6, charSequence5, i3, charSequence4);
        }
    ...
    public final void forEach(u1a<? super Long, ? super Float, xhv> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            u1aVar.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4]));
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    public final float get(long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("72fc1977", new Object[]{this, new Long(j)})).floatValue();
        }
    ...
    public final float getOrDefault(long j, float f) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("958d865b", new Object[]{this, new Long(j), new Float(f)})).floatValue();
        }
        int findKeyIndex = findKeyIndex(j);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
    ...
    public final float getOrElse(long j, d1a<Float> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("1c828702", new Object[]{this, new Long(j), d1aVar})).floatValue();
        }
    ...
    public final boolean any(u1a<? super Long, ? super Float, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4])).booleanValue()) {
                                return true;
                            }
                        }
                        j >>= 8;
    ...
    public final int count(u1a<? super Long, ? super Float, Boolean> u1aVar) {
        int i;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (u1aVar.invoke(Long.valueOf(jArr[i6]), Float.valueOf(fArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a u1aVar, int i2, Object obj) {
        int i3;
        int i4;
        char c = 7;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("3fdefa5f", new Object[]{longFloatMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, u1aVar, new Integer(i2), obj});
        }
        int i5 = i;
        if (obj == null) {
    ...
    public final boolean all(u1a<? super Long, ? super Float, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i2;
                ...
                if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb3.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i2 = 1;
                            i6++;
                        } else {
                            sb3 = sb3;
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i2 = 1;
                            i4++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i;
        int i2;
        int i3 = 0;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i3 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sb2.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i2 = 1;
                            i5++;
                            i6 = 8;
                        } else {
    ...
    public final String joinToString(u1a<? super Long, ? super Float, ? extends CharSequence> u1aVar) {
        int i = 0;
        int i2 = 1;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
