...
public abstract class IntLongMap {
    ...
    public /* synthetic */ IntLongMap(a07 a07Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("92b9268f", new Object[]{intLongMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, new Integer(i2), obj});
        }
        if (obj == null) {
            if ((i2 & 1) != 0) {
                charSequence = ", ";
            ...
            return intLongMap.joinToString(charSequence, charSequence6, charSequence5, i3, charSequence4);
        }
    ...
    public final void forEach(u1a<? super Integer, ? super Long, xhv> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            u1aVar.invoke(Integer.valueOf(iArr[i4]), Long.valueOf(jArr[i4]));
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    public final long getOrDefault(int i, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("958d2104", new Object[]{this, new Integer(i), new Long(j)})).longValue();
        }
        int findKeyIndex = findKeyIndex(i);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
    ...
    public final long getOrElse(int i, d1a<Long> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("b5a9c745", new Object[]{this, new Integer(i), d1aVar})).longValue();
        }
    ...
    public final boolean any(u1a<? super Integer, ? super Long, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Integer.valueOf(iArr[i4]), Long.valueOf(jArr[i4])).booleanValue()) {
                                return true;
                            }
                        }
                        j >>= 8;
    ...
    public final int count(u1a<? super Integer, ? super Long, Boolean> u1aVar) {
        int i;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (u1aVar.invoke(Integer.valueOf(iArr[i6]), Long.valueOf(jArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a u1aVar, int i2, Object obj) {
        int i3;
        int i4;
        char c = 7;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("6bc234", new Object[]{intLongMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, u1aVar, new Integer(i2), obj});
        }
        int i5 = i;
        if (obj == null) {
    ...
    public final boolean all(u1a<? super Integer, ? super Long, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i2;
                ...
                if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb3.append((CharSequence) u1aVar.invoke(Integer.valueOf(i9), Long.valueOf(j2)));
                            i2 = 1;
                            i6++;
                        } else {
                            sb3 = sb3;
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) u1aVar.invoke(Integer.valueOf(i9), Long.valueOf(j2)));
                            i2 = 1;
                            i4++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6 += i2) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) u1aVar.invoke(Integer.valueOf(i8), Long.valueOf(j2)));
                            i2 = 1;
                            i4++;
                        } else {
                            i2 = 1;
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i;
        int i2;
        int i3 = 0;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i3 < i7) {
                        if ((j & 255) < 128) {
                            ...
                            sb2.append((CharSequence) u1aVar.invoke(Integer.valueOf(i9), Long.valueOf(j2)));
                            i2 = 1;
                            i5++;
                            i6 = 8;
                        } else {
    ...
    public final String joinToString(u1a<? super Integer, ? super Long, ? extends CharSequence> u1aVar) {
        int i = 0;
        int i2 = 1;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
