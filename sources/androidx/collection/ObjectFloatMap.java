...
public abstract class ObjectFloatMap<K> {
    ...
    public /* synthetic */ ObjectFloatMap(a07 a07Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("be00defd", new Object[]{objectFloatMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, new Integer(i2), obj});
        }
        if (obj == null) {
            if ((i2 & 1) != 0) {
                charSequence = ", ";
    ...
    public final void forEach(u1a<? super K, ? super Float, xhv> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            u1aVar.invoke(objArr[i4], Float.valueOf(fArr[i4]));
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    public final float get(K k) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("c3dfcb69", new Object[]{this, k})).floatValue();
        }
    ...
    public final float getOrDefault(K k, float f) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("6fbd5245", new Object[]{this, k, new Float(f)})).floatValue();
        }
        int findKeyIndex = findKeyIndex(k);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
    ...
    public final float getOrElse(K k, d1a<Float> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("ff11dd2c", new Object[]{this, k, d1aVar})).floatValue();
        }
    ...
    public final boolean any(u1a<? super K, ? super Float, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(objArr[i4], Float.valueOf(fArr[i4])).booleanValue()) {
                                return true;
                            }
                        }
                        j >>= 8;
    ...
    public final int count(u1a<? super K, ? super Float, Boolean> u1aVar) {
        int i;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (u1aVar.invoke(objArr[i6], Float.valueOf(fArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a u1aVar, int i2, Object obj) {
        int i3;
        int i4;
        char c = 7;
        int i5 = 8;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("718642a2", new Object[]{objectFloatMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, u1aVar, new Integer(i2), obj});
        }
        int i6 = i;
        if (obj == null) {
                    ...
                    if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                sb.append((CharSequence) u1aVar.invoke(obj2, Float.valueOf(f)));
                                i4 = 1;
                                i10++;
                                i5 = 8;
                            } else {
    ...
    public final boolean all(u1a<? super K, ? super Float, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i2;
                ...
                if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb3.append((CharSequence) u1aVar.invoke(obj, Float.valueOf(f)));
                            i2 = 1;
                            i7++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) u1aVar.invoke(obj, Float.valueOf(f)));
                            i2 = 1;
                            i4++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        int i3 = 0;
        IpChange ipChange = $ipChange;
    ...
    public final String joinToString(u1a<? super K, ? super Float, ? extends CharSequence> u1aVar) {
        int i = 0;
        int i2 = 1;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
