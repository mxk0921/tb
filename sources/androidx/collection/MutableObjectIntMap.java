...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
                ...
                if (j == 254) {
                    ...
                    if (((findFirstAvailableSlot - i12) & i5) / 8 == ((i6 - i12) & i5) / 8) {
                        ...
                        if (((j2 >> i14) & 255) == 128) {
                            ...
                            objArr[findFirstAvailableSlot] = objArr[i6];
                            objArr[i6] = objArr[i7];
                            iArr[i7] = iArr[findFirstAvailableSlot];
                            iArr[findFirstAvailableSlot] = iArr[i6];
                            iArr[i6] = iArr[i7];
                            i6--;
                        }
    ...
    public static /* synthetic */ Object ipc$super(MutableObjectIntMap mutableObjectIntMap, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableObjectIntMap");
    }
    ...
    public final int getOrPut(K k, d1a<Integer> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("e9773df3", new Object[]{this, k, d1aVar})).intValue();
        }
        ...
        int intValue = d1aVar.invoke().intValue();
        set(k, intValue);
        return intValue;
    }
    ...
    public final void plusAssign(ObjectIntMap<K> objectIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("da3355e8", new Object[]{this, objectIntMap});
            return;
        }
        ckf.g(objectIntMap, "from");
        putAll(objectIntMap);
    }
    ...
    public final void put(K k, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("bc2d2d1", new Object[]{this, k, new Integer(i)});
        } else {
            set(k, i);
        }
    }
    ...
    public final void set(K k, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("ce49fc1e", new Object[]{this, k, new Integer(i)});
            return;
        }
    ...
    public /* synthetic */ MutableObjectIntMap(int i, int i2, a07 a07Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(K k, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("6c97fa45", new Object[]{this, k, new Integer(i), new Integer(i2)})).intValue();
        }
        int findIndex = findIndex(k);
        if (findIndex < 0) {
            findIndex = ~findIndex;
    ...
    public final boolean remove(K k, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("999239c0", new Object[]{this, k, new Integer(i)})).booleanValue();
        }
        int findKeyIndex = findKeyIndex(k);
    ...
    public final void putAll(ObjectIntMap<K> objectIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("8c05c011", new Object[]{this, objectIntMap});
            return;
        }
        ckf.g(objectIntMap, "from");
    ...
    public final void removeIf(u1a<? super K, ? super Integer, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(this.keys[i4], Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
