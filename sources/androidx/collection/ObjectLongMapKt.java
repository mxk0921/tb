...
public final class ObjectLongMapKt {
    ...
    public static final <K> ObjectLongMap<K> emptyObjectLongMap() {
        ...
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("8cd3756", new Object[0]);
        }
        MutableObjectLongMap<Object> mutableObjectLongMap = EmptyObjectLongMap;
        ckf.e(mutableObjectLongMap, "null cannot be cast to non-null type androidx.collection.ObjectLongMap<K of androidx.collection.ObjectLongMapKt.emptyObjectLongMap>");
        return mutableObjectLongMap;
    }

    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (MutableObjectLongMap) ipChange.ipc$dispatch("4ff84b66", new Object[0]) : new MutableObjectLongMap<>(0, 1, null);
    }

    public static final <K> ObjectLongMap<K> objectLongMap() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("50d925e3", new Object[0]);
        }
        MutableObjectLongMap<Object> mutableObjectLongMap = EmptyObjectLongMap;
        ckf.e(mutableObjectLongMap, "null cannot be cast to non-null type androidx.collection.ObjectLongMap<K of androidx.collection.ObjectLongMapKt.objectLongMap>");
        return mutableObjectLongMap;
    }
    ...
    public static final <K> ObjectLongMap<K> objectLongMapOf(K k, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("e1c5bd64", new Object[]{k, new Long(j)});
        }
    ...
    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf(K k, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MutableObjectLongMap) ipChange.ipc$dispatch("4d1202d0", new Object[]{k, new Long(j)});
        }
    ...
    public static final <K> ObjectLongMap<K> objectLongMapOf(K k, long j, K k2, long j2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("9243721a", new Object[]{k, new Long(j), k2, new Long(j2)});
        }
        MutableObjectLongMap mutableObjectLongMap = new MutableObjectLongMap(0, 1, null);
        mutableObjectLongMap.set(k, j);
    ...
    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf(K k, long j, K k2, long j2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MutableObjectLongMap) ipChange.ipc$dispatch("b899af26", new Object[]{k, new Long(j), k2, new Long(j2)});
        }
        MutableObjectLongMap<K> mutableObjectLongMap = new MutableObjectLongMap<>(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> ObjectLongMap<K> objectLongMapOf(K k, long j, K k2, long j2, K k3, long j3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("66fa5a4", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3)});
        }
        MutableObjectLongMap mutableObjectLongMap = new MutableObjectLongMap(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf(K k, long j, K k2, long j2, K k3, long j3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MutableObjectLongMap) ipChange.ipc$dispatch("6188710", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3)});
        }
        MutableObjectLongMap<K> mutableObjectLongMap = new MutableObjectLongMap<>(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> ObjectLongMap<K> objectLongMapOf(K k, long j, K k2, long j2, K k3, long j3, K k4, long j4) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("5b621da", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3), k4, new Long(j4)});
        }
        MutableObjectLongMap mutableObjectLongMap = new MutableObjectLongMap(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf(K k, long j, K k2, long j2, K k3, long j3, K k4, long j4) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MutableObjectLongMap) ipChange.ipc$dispatch("c0d242e6", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3), k4, new Long(j4)});
        }
        MutableObjectLongMap<K> mutableObjectLongMap = new MutableObjectLongMap<>(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> ObjectLongMap<K> objectLongMapOf(K k, long j, K k2, long j2, K k3, long j3, K k4, long j4, K k5, long j5) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ObjectLongMap) ipChange.ipc$dispatch("84a95de4", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3), k4, new Long(j4), k5, new Long(j5)});
        }
        MutableObjectLongMap mutableObjectLongMap = new MutableObjectLongMap(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
    ...
    public static final <K> MutableObjectLongMap<K> mutableObjectLongMapOf(K k, long j, K k2, long j2, K k3, long j3, K k4, long j4, K k5, long j5) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MutableObjectLongMap) ipChange.ipc$dispatch("8a59db50", new Object[]{k, new Long(j), k2, new Long(j2), k3, new Long(j3), k4, new Long(j4), k5, new Long(j5)});
        }
        MutableObjectLongMap<K> mutableObjectLongMap = new MutableObjectLongMap<>(0, 1, null);
        mutableObjectLongMap.set(k, j);
        mutableObjectLongMap.set(k2, j2);
