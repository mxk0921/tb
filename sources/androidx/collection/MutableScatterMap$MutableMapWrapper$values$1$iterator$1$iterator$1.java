...
public final class MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 extends RestrictedSuspendLambda implements u1a<vbp<? super Integer>, ar4<? super xhv>, Object> {
    ...
    public MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, ar4<? super MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1> ar4Var) {
        super(2, ar4Var);
        this.this$0 = mutableScatterMap;
    }

    public static /* synthetic */ Object ipc$super(MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 mutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1");
    }
    ...
    public final ar4<xhv> create(Object obj, ar4<?> ar4Var) {
        ...
        MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 mutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 = new MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1(this.this$0, ar4Var);
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r21) {
        /*
            ...
            r2 = 2
            r3 = 1
            com.android.alibaba.ip.runtime.IpChange r4 = androidx.collection.MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1.$ipChange
    ...
    public final Object invoke(vbp<? super Integer> vbpVar, ar4<? super xhv> ar4Var) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ipChange.ipc$dispatch("d1c4479a", new Object[]{this, vbpVar, ar4Var}) : ((MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1) create(vbpVar, ar4Var)).invokeSuspend(xhv.INSTANCE);
    }
}
