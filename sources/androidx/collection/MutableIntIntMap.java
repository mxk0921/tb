...
public final class MutableIntIntMap extends IntIntMap {
                ...
                if (j == 254) {
                    ...
                    if (((findFirstAvailableSlot - i11) & i4) / 8 == ((i5 - i11) & i4) / 8) {
                        ...
                        if (((j2 >> i13) & 255) == 128) {
                            ...
                            iArr[i5] = 0;
                            iArr3[findFirstAvailableSlot] = iArr3[i5];
                            iArr3[i5] = 0;
                            i6 = i5;
                            i2 = i4;
                        } else {
                            ...
                            iArr[findFirstAvailableSlot] = iArr[i5];
                            iArr[i5] = iArr[i6];
                            iArr3[i6] = iArr3[findFirstAvailableSlot];
                            iArr3[findFirstAvailableSlot] = iArr3[i5];
                            iArr3[i5] = iArr3[i6];
                            i5--;
                        }
    ...
    public static /* synthetic */ Object ipc$super(MutableIntIntMap mutableIntIntMap, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableIntIntMap");
    }
    ...
    private final void resizeStorage(int i) {
        ...
        while (i3 < i4) {
            if (((jArr[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                iArr3[findFirstAvailableSlot] = i6;
    ...
    public final int getOrPut(int i, d1a<Integer> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("76503600", new Object[]{this, new Integer(i), d1aVar})).intValue();
        }
    ...
    public final void plusAssign(IntIntMap intIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("c72f2b60", new Object[]{this, intIntMap});
            return;
        }
        ckf.g(intIntMap, "from");
        putAll(intIntMap);
    }
    ...
    public final void put(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a101caf6", new Object[]{this, new Integer(i), new Integer(i2)});
        } else {
            set(i, i2);
        }
    }
    ...
    public /* synthetic */ MutableIntIntMap(int i, int i2, a07 a07Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("7f3806c0", new Object[]{this, new Integer(i), new Integer(i2), new Integer(i3)})).intValue();
        }
        int findInsertIndex = findInsertIndex(i);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
    ...
    public final boolean remove(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("89bc64af", new Object[]{this, new Integer(i), new Integer(i2)})).booleanValue();
        }
        int findKeyIndex = findKeyIndex(i);
    ...
    public final void putAll(IntIntMap intIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("594419d7", new Object[]{this, intIntMap});
            return;
        }
        ckf.g(intIntMap, "from");
    ...
    public final void removeIf(u1a<? super Integer, ? super Integer, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Integer.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
