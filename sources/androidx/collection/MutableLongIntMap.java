...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public static /* synthetic */ Object ipc$super(MutableLongIntMap mutableLongIntMap, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableLongIntMap");
    }
    ...
    public final int getOrPut(long j, d1a<Integer> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("dd28f5c1", new Object[]{this, new Long(j), d1aVar})).intValue();
        }
    ...
    public final void plusAssign(LongIntMap longIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("243c024b", new Object[]{this, longIntMap});
            return;
        }
        ckf.g(longIntMap, "from");
        putAll(longIntMap);
    }
    ...
    public final void put(long j, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a1023f55", new Object[]{this, new Long(j), new Integer(i)});
        } else {
            set(j, i);
        }
    }
    ...
    public final void set(long j, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dfbcbe68", new Object[]{this, new Long(j), new Integer(i)});
            return;
        }
    ...
    public /* synthetic */ MutableLongIntMap(int i, int i2, a07 a07Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(long j, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("7f461e41", new Object[]{this, new Long(j), new Integer(i), new Integer(i2)})).intValue();
        }
        int findInsertIndex = findInsertIndex(j);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
    ...
    public final boolean remove(long j, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("89bcd90e", new Object[]{this, new Long(j), new Integer(i)})).booleanValue();
        }
        int findKeyIndex = findKeyIndex(j);
    ...
    public final void putAll(LongIntMap longIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d4c4e2b4", new Object[]{this, longIntMap});
            return;
        }
        ckf.g(longIntMap, "from");
    ...
    public final void removeIf(u1a<? super Long, ? super Integer, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Long.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
