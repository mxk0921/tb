...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public static /* synthetic */ Object ipc$super(MutableFloatIntMap mutableFloatIntMap, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableFloatIntMap");
    }
    ...
    public final int getOrPut(float f, d1a<Integer> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("41c5f6bd", new Object[]{this, new Float(f), d1aVar})).intValue();
        }
    ...
    public final void plusAssign(FloatIntMap floatIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("ee3fe693", new Object[]{this, floatIntMap});
            return;
        }
        ckf.g(floatIntMap, "from");
        putAll(floatIntMap);
    }
    ...
    public final void put(float f, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a1006dd9", new Object[]{this, new Float(f), new Integer(i)});
        } else {
            set(f, i);
        }
    }
    ...
    public final void set(float f, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dfbaecec", new Object[]{this, new Float(f), new Integer(i)});
            return;
        }
    ...
    public /* synthetic */ MutableFloatIntMap(int i, int i2, a07 a07Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(float f, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("7f0dc03d", new Object[]{this, new Float(f), new Integer(i), new Integer(i2)})).intValue();
        }
        int findInsertIndex = findInsertIndex(f);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
    ...
    public final boolean remove(float f, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("89bb0792", new Object[]{this, new Float(f), new Integer(i)})).booleanValue();
        }
        int findKeyIndex = findKeyIndex(f);
    ...
    public final void putAll(FloatIntMap floatIntMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("4ed3134a", new Object[]{this, floatIntMap});
            return;
        }
        ckf.g(floatIntMap, "from");
    ...
    public final void removeIf(u1a<? super Float, ? super Integer, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Float.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
