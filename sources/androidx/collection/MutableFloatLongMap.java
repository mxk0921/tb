...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public static /* synthetic */ Object ipc$super(MutableFloatLongMap mutableFloatLongMap, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in androidx/collection/MutableFloatLongMap");
    }
    ...
    public final long getOrPut(float f, d1a<Long> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("41c5f6be", new Object[]{this, new Float(f), d1aVar})).longValue();
        }
    ...
    public final void plusAssign(FloatLongMap floatLongMap) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("181caeb0", new Object[]{this, floatLongMap});
            return;
        }
        ckf.g(floatLongMap, "from");
        putAll(floatLongMap);
    }
    ...
    public final void put(float f, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a100719a", new Object[]{this, new Float(f), new Long(j)});
        } else {
            set(f, j);
        }
    }
    ...
    public final void set(float f, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dfbaf0ad", new Object[]{this, new Float(f), new Long(j)});
            return;
        }
    ...
    public /* synthetic */ MutableFloatLongMap(int i, int i2, a07 a07Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final long put(float f, long j, long j2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("7f0e385e", new Object[]{this, new Float(f), new Long(j), new Long(j2)})).longValue();
        }
        int findInsertIndex = findInsertIndex(f);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
    ...
    public final boolean remove(float f, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("89bb0b53", new Object[]{this, new Float(f), new Long(j)})).booleanValue();
        }
        int findKeyIndex = findKeyIndex(f);
    ...
    public final void putAll(FloatLongMap floatLongMap) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("c9ef18d9", new Object[]{this, floatLongMap});
            return;
        }
        ckf.g(floatLongMap, "from");
    ...
    public final void removeIf(u1a<? super Float, ? super Long, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Float.valueOf(this.keys[i4]), Long.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
