...
public abstract class LongObjectMap<V> {
    ...
    public /* synthetic */ LongObjectMap(a07 a07Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("c5a07eab", new Object[]{longObjectMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, new Integer(i2), obj});
        }
        if (obj == null) {
            if ((i2 & 1) != 0) {
                charSequence = ", ";
    ...
    */
    public final boolean contains(long r21) {
        /*
            ...
            r3 = 1
            r4 = 0
            com.android.alibaba.ip.runtime.IpChange r5 = androidx.collection.LongObjectMap.$ipChange
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            } else if (!ckf.b(obj2, longObjectMap.get(j2))) {
                                return false;
                            }
                            i3 = 8;
                        } else {
    ...
    public final int findKeyIndex$collection(long j) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("5acc311a", new Object[]{this, new Long(j)})).intValue();
        }
    ...
    public final void forEach(u1a<? super Long, ? super V, xhv> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            u1aVar.invoke(Long.valueOf(jArr[i4]), objArr[i4]);
                        }
                        j >>= 8;
                    }
                    if (i2 != 8) {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0084, code lost:
        if (((r9 & ((~r9) << 6)) & (-9187201950435737472L)) == 0) goto L_0x008f;
     */
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0086, code lost:
        r15 = -1;
     */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final V getOrDefault(long r21, V r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
            ...
            r4 = 0
            r5 = 3
            com.android.alibaba.ip.runtime.IpChange r6 = androidx.collection.LongObjectMap.$ipChange
    ...
    public final V getOrElse(long j, d1a<? extends V> d1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (V) ipChange.ipc$dispatch("4eb55660", new Object[]{this, new Long(j), d1aVar});
        }
    ...
    public final boolean any(u1a<? super Long, ? super V, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (u1aVar.invoke(Long.valueOf(jArr[i4]), objArr[i4]).booleanValue()) {
                                return true;
                            }
                        }
                        j >>= 8;
    ...
    public final int count(u1a<? super Long, ? super V, Boolean> u1aVar) {
        int i;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (u1aVar.invoke(Long.valueOf(jArr[i6]), objArr[i6]).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a u1aVar, int i2, Object obj) {
        int i3;
        int i4;
        char c = 7;
        int i5 = 8;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("c38baa50", new Object[]{longObjectMap, charSequence, charSequence2, charSequence3, new Integer(i), charSequence4, u1aVar, new Integer(i2), obj});
        }
        int i6 = i;
        if (obj == null) {
                    ...
                    if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                sb.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), obj2));
                                i4 = 1;
                                i10++;
                                i5 = 8;
                            } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x008b, code lost:
        if (((r9 & ((~r9) << 6)) & (-9187201950435737472L)) == 0) goto L_0x0094;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean containsKey(long r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
    ...
    public final boolean all(u1a<? super Long, ? super V, Boolean> u1aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        StringBuilder sb;
        int i2;
                ...
                if ((((~j) << c) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb3.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), obj));
                            i2 = 1;
                            i7++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) u1aVar.invoke(Long.valueOf(j2), obj));
                            i2 = 1;
                            i4++;
                            i5 = 8;
                        } else {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public final String joinToString(CharSequence charSequence, u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        int i;
        int i2;
        int i3 = 0;
        IpChange ipChange = $ipChange;
    ...
    public final String joinToString(u1a<? super Long, ? super V, ? extends CharSequence> u1aVar) {
        int i = 0;
        int i2 = 1;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
