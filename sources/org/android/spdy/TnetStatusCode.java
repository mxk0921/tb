...
public final class TnetStatusCode {
    ...
    public static final int EASY_REASON_0RTT_HANDSHAKE_TIMEOUT = -5004;
    ...
    public static final int EASY_REASON_TUNNEL_CONN_TIMEOUT = -4993;
    public static final int EASY_REASON_TUNNEL_PROXY_CLOSE = -4990;
    @Deprecated
    ...
    public static final int TNET_SESSION_DNS_FAIL = -1106;
