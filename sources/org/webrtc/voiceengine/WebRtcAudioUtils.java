...
public final class WebRtcAudioUtils {
    ...
    private static final String[] BLACKLISTED_OPEN_SL_ES_MODELS = {"PCHM10", "PCHM30", "PDAM10"};
    ...
    public static boolean deviceIsBlacklistedForOpenSLESUsage() {
        ...
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("8f37632e", new Object[0])).booleanValue();
        }
    ...
    public static List<String> getBlackListedModelsForAecUsage() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (List) ipChange.ipc$dispatch("70246885", new Object[0]);
        }
    ...
    public static List<String> getBlackListedModelsForNsUsage() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (List) ipChange.ipc$dispatch("37a0e49d", new Object[0]);
        }
    ...
    private static boolean hasMicrophone() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("544641ef", new Object[0])).booleanValue();
        }
