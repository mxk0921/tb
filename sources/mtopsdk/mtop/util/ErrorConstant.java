...
public class ErrorConstant {
    ...
    private static final String ERRCODE_FAIL_BIZ_STREAM_ERROR = "FAIL_BIZ_STREAM_ERROR";
    ...
    private static final String ERRCODE_FAIL_SYS_STREAM_ERROR = "FAIL_SYS_STREAM_ERROR";
    private static final String ERRCODE_FAIL_SYS_STREAM_TIMEOUT = "FAIL_SYS_STREAM_TIMEOUT";
    ...
    public static final String ERRCODE_FAIL_SYS_UNIT_PROTECT = "FAIL_SYS_UNIT_PROTECT";
    ...
    public static final String ERRCODE_SYS_STREAM_BODY_TIMEOUT = "ANDROID_SYS_STREAM_BODY_TIMEOUT";
    public static final String ERRCODE_SYS_STREAM_UNKNOWN_ERROR = "ANDROID_SYS_STREAM_UNKNOWN_ERROR";
    ...
    public static final String ERRMSG_FAIL_SYS_UNIT_PROTECT = "单元保护";
    ...
    public static final String ERRMSG_SYS_STREAM_BODY_TIMEOUT = "包包超时";
    public static final String ERRMSG_SYS_STREAM_UNKNOWN_ERROR = "未知异常";
    ...
    private static final String MAPPING_CODE_FAIL_BIZ_STREAM_ERROR = "ES40005";
    ...
    private static final String MAPPING_CODE_FAIL_SYS_STREAM_ERROR = "ES40006";
    private static final String MAPPING_CODE_FAIL_SYS_STREAM_TIMEOUT = "ES40004";
    ...
    private static final String MAPPING_CODE_FAIL_SYS_UNIT_PROTECT = "ES10045";
    ...
    private static final String MAPPING_CODE_SYS_PARAM_TOO_LONG = "EC40012";
    private static final String MAPPING_CODE_SYS_STREAM_BODY_TIMEOUT = "EC40013";
    private static final String MAPPING_CODE_SYS_STREAM_UNKNOWN_ERROR = "EC40014";
    ...
    public static HashMap<String, String> errCodeMappingMap = new HashMap<>(128);
    public static HashMap<String, String> mtopSdkErrCodeMappingMap = new HashMap<>(24);
    public static HashMap<String, String> mtopServerErrCodeMappingMap;
    ...
    static {
        ...
        mtopServerErrCodeMappingMap.put("FAIL_SYS_UNIT_PROTECT", MAPPING_CODE_FAIL_SYS_UNIT_PROTECT);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_BIZ_STREAM_ERROR, MAPPING_CODE_FAIL_BIZ_STREAM_ERROR);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_STREAM_TIMEOUT, MAPPING_CODE_FAIL_SYS_STREAM_TIMEOUT);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_STREAM_ERROR, MAPPING_CODE_FAIL_SYS_STREAM_ERROR);
        ...
        mtopSdkErrCodeMappingMap.put("ANDROID_SYS_LOGIN_CANCEL", MAPPING_CODE_ANDROID_SYS_LOGIN_CANCEL);
        ...
        mtopSdkErrCodeMappingMap.put(ERRCODE_SYS_PARAM_TOO_LONG, MAPPING_CODE_SYS_PARAM_TOO_LONG);
        mtopSdkErrCodeMappingMap.put(ERRCODE_SYS_STREAM_BODY_TIMEOUT, MAPPING_CODE_SYS_STREAM_BODY_TIMEOUT);
        mtopSdkErrCodeMappingMap.put(ERRCODE_SYS_STREAM_UNKNOWN_ERROR, MAPPING_CODE_SYS_STREAM_UNKNOWN_ERROR);
    ...
    public static String appendMappingCode(int i, String str) {
        ...
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("1b246e9b", new Object[]{new Integer(i), str});
        }
        return i + "A" + str;
    }
    ...
    public static Integer getIntErrCodeByStrErrorCode(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Integer) ipChange.ipc$dispatch("ee9514ac", new Object[]{str});
        }
        return -1000;
    }
    ...
    public static String getMappingCodeByErrorCode(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("95289a76", new Object[]{str});
        }
    ...
    public static Integer getMtopSdkIntErrCode(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Integer) ipChange.ipc$dispatch("6e02e8b7", new Object[]{str});
        }
        return -1000;
    }
    ...
    public static boolean isExpiredRequest(String str) {
        ...
        if (ERRCODE_FAIL_SYS_EXPIRED_REQUEST.equals(str) || ERRCODE_FAIL_SYS_REQUEST_EXPIRED.equals(str)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isIllegelSign(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("cf40821a", new Object[]{str})).booleanValue();
        }
    ...
    public static boolean isMtopSdkError(String str) {
        ...
        if (StringUtils.isBlank(str) || mtopSdkErrCodeMappingMap.containsKey(str)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isNetworkError(String str) {
        ...
        if ("ANDROID_SYS_NETWORK_ERROR".equals(str) || ERRCODE_NO_NETWORK.equals(str)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isNoNetwork(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("45be4978", new Object[]{str})).booleanValue();
        }
    ...
    public static boolean isSessionInvalid(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("8af13aa0", new Object[]{str})).booleanValue();
        }
        if ("FAIL_SYS_SESSION_EXPIRED".equals(str) || ERRCODE_ANDROID_SYS_LOGIN_FAIL.equals(str)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isSuccess(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("bdc3f14e", new Object[]{str})).booleanValue();
        }
    ...
    public static boolean isUnitProtect(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("baea70f6", new Object[]{str})).booleanValue();
        }
        return "FAIL_SYS_UNIT_PROTECT".equals(str);
    }

    public static boolean isMtopServerError(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("f19fd68", new Object[]{str})).booleanValue();
        }
        if (str != null) {
            return mtopServerErrCodeMappingMap.containsKey(str) || str.startsWith(FAIL_SYS_PREFIX);
        }
        return false;
    }
}
