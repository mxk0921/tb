...
public class HttpUrlResponse extends Response {
    ...
    public static /* synthetic */ Object ipc$super(HttpUrlResponse httpUrlResponse, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/literpc/android/phone/mrpc/core/HttpUrlResponse");
    }
    ...
    public HttpUrlHeader getHeader() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (HttpUrlHeader) ipChange.ipc$dispatch("30d7d770", new Object[]{this});
        }
        return this.f;
    }
