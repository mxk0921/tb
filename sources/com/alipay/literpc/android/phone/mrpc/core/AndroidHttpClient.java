...
public final class AndroidHttpClient implements HttpClient {
    ...
    public static final HttpRequestInterceptor e = new HttpRequestInterceptor() { // from class: com.alipay.literpc.android.phone.mrpc.core.AndroidHttpClient.1
    ...
    public final HttpClient f3841a;
    ...
    public static class LoggingConfiguration {
        ...
        public static /* synthetic */ boolean access$400(LoggingConfiguration loggingConfiguration) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Boolean) ipChange.ipc$dispatch("58de7b68", new Object[]{loggingConfiguration})).booleanValue();
            }
            return loggingConfiguration.a();
        }

        public static /* synthetic */ void access$600(LoggingConfiguration loggingConfiguration, String str) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("5e0cf6ec", new Object[]{loggingConfiguration, str});
            } else {
                loggingConfiguration.b(str);
            }
        }
        ...
        public final boolean a() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Boolean) ipChange.ipc$dispatch("ec3441d2", new Object[]{this})).booleanValue();
            }
            return Log.isLoggable(this.f3842a, this.b);
        }
        ...
        public final void b(String str) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                Log.println(this.b, this.f3842a, str);
            }
        }
    ...
    public AndroidHttpClient(ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.f3841a = new DefaultHttpClient(clientConnectionManager, httpParams) { // from class: com.alipay.literpc.android.phone.mrpc.core.AndroidHttpClient.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public static /* synthetic */ Object ipc$super(AnonymousClass2 r2, String str, Object... objArr) {
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/literpc/android/phone/mrpc/core/AndroidHttpClient$2");
            }
            ...
            public ConnectionKeepAliveStrategy createConnectionKeepAliveStrategy() {
                ...
                return new ConnectionKeepAliveStrategy() { // from class: com.alipay.literpc.android.phone.mrpc.core.AndroidHttpClient.2.2
                    public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public RedirectHandler createRedirectHandler() {
                ...
                return new DefaultRedirectHandler() { // from class: com.alipay.literpc.android.phone.mrpc.core.AndroidHttpClient.2.1
                    public static volatile transient /* synthetic */ IpChange $ipChange;
                    ...
                    public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
                        ...
                        int hashCode = str.hashCode();
                        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/literpc/android/phone/mrpc/core/AndroidHttpClient$2$1");
                    }
    ...
    public static /* synthetic */ LoggingConfiguration access$300(AndroidHttpClient androidHttpClient) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (LoggingConfiguration) ipChange.ipc$dispatch("67545cbf", new Object[]{androidHttpClient});
        }
        return androidHttpClient.c;
    }

    public static /* synthetic */ String access$500(HttpUriRequest httpUriRequest, boolean z) throws IOException {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("c32c73f6", new Object[]{httpUriRequest, new Boolean(z)});
        }
        return c(httpUriRequest, z);
    }

    public static void b() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("53af224f", new Object[0]);
        } else {
            HttpsURLConnection.setDefaultHostnameVerifier(SSLSocketFactory.STRICT_HOSTNAME_VERIFIER);
        }
    }

    public static String c(HttpUriRequest httpUriRequest, boolean z) throws IOException {
        Header[] allHeaders;
        HttpEntity entity;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("5b0fa9a4", new Object[]{httpUriRequest, new Boolean(z)});
        }
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest) throws IOException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (HttpResponse) ipChange.ipc$dispatch("2e48d5a1", new Object[]{this, httpUriRequest}) : this.f3841a.execute(httpUriRequest);
    }
    ...
    public ClientConnectionManager getConnectionManager() {
        ...
        return this.f3841a.getConnectionManager();
    }
    ...
    public void setHttpRequestRetryHandler(HttpRequestRetryHandler httpRequestRetryHandler) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.f3841a.setHttpRequestRetryHandler(httpRequestRetryHandler);
        }
    }
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest, HttpContext httpContext) throws IOException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (HttpResponse) ipChange.ipc$dispatch("ef755873", new Object[]{this, httpUriRequest, httpContext}) : this.f3841a.execute(httpUriRequest, httpContext);
    }

    public static boolean a(HttpUriRequest httpUriRequest) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("fa72715", new Object[]{httpUriRequest})).booleanValue();
        }
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest) throws IOException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (HttpResponse) ipChange.ipc$dispatch("3908d64a", new Object[]{this, httpHost, httpRequest}) : this.f3841a.execute(httpHost, httpRequest);
    }

    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (HttpResponse) ipChange.ipc$dispatch("9bd8925c", new Object[]{this, httpHost, httpRequest, httpContext}) : this.f3841a.execute(httpHost, httpRequest, httpContext);
    }

    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler) throws IOException, ClientProtocolException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (T) ipChange.ipc$dispatch("dcc2fbcf", new Object[]{this, httpUriRequest, responseHandler}) : (T) this.f3841a.execute(httpUriRequest, responseHandler);
    }

    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) throws IOException, ClientProtocolException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (T) ipChange.ipc$dispatch("3d9a9c61", new Object[]{this, httpUriRequest, responseHandler, httpContext}) : (T) this.f3841a.execute(httpUriRequest, responseHandler, httpContext);
    }

    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler) throws IOException, ClientProtocolException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (T) ipChange.ipc$dispatch("8d40d4f8", new Object[]{this, httpHost, httpRequest, responseHandler}) : (T) this.f3841a.execute(httpHost, httpRequest, responseHandler);
    }

    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) throws IOException, ClientProtocolException {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (T) ipChange.ipc$dispatch("ab154eca", new Object[]{this, httpHost, httpRequest, responseHandler, httpContext}) : (T) this.f3841a.execute(httpHost, httpRequest, responseHandler, httpContext);
    }
