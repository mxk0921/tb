...
public class Constant {
    ...
    public static String EXTRA_AP_OBJECT_BIZTYPE = "alipay_object_bizType";
    ...
    public static String EXTRA_BASEREQ_EXTRA_DATA = "alipay_baseresp_extradata";
    ...
    public static String EXTRA_UI = "ui";
