...
public class d {
    ...
    public static Drawable a(String str, Context context) {
        ...
        return ipChange instanceof IpChange ? (Drawable) ipChange.ipc$dispatch("26c56e24", new Object[]{str, context}) : a(str, context, 480);
    }
    ...
    public static Drawable a(String str, Context context, int i) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Drawable) ipChange.ipc$dispatch("e30fc8ad", new Object[]{str, context, new Integer(i)});
        }
        try {
