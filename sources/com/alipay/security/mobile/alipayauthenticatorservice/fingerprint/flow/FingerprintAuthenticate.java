...
public class FingerprintAuthenticate extends FingerprintAuth {
    ...
    public static /* synthetic */ Object ipc$super(FingerprintAuthenticate fingerprintAuthenticate, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate");
    }
