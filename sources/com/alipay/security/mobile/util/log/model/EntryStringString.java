...
public final class EntryStringString extends Message {
    ...
    public static /* synthetic */ Object ipc$super(EntryStringString entryStringString, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/security/mobile/util/log/model/EntryStringString");
    }
    ...
    public EntryStringString fillTagValue(int i, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (EntryStringString) ipChange.ipc$dispatch("14516224", new Object[]{this, new Integer(i), obj});
        }
        if (i == 1) {
            this.key = (String) obj;
        } else if (i == 2) {
    ...
    public EntryStringString(String str, String str2) {
        this.key = str;
        this.value = str2;
    }
}
