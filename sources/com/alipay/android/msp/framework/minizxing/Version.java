...
public final class Version {
    ...
    public static final Version[] e = a();
    ...
    public static final class ECB {
        ...
        public final int getDataCodewords() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Number) ipChange.ipc$dispatch("1cf1db16", new Object[]{this})).intValue();
            }
            return this.b;
        }
    }
    ...
    public static final class ECBlocks {
        ...
        public final ECB[] getECBlocks() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return (ECB[]) ipChange.ipc$dispatch("596f324c", new Object[]{this});
            }
            return this.b;
        }
        ...
        public final int getECCodewordsPerBlock() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Number) ipChange.ipc$dispatch("341ea2d2", new Object[]{this})).intValue();
            }
            return this.f3641a;
        }
        ...
        public final int getNumBlocks() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Number) ipChange.ipc$dispatch("e7b73370", new Object[]{this})).intValue();
            }
            int i = 0;
            for (ECB ecb : this.b) {
                i += ecb.getCount();
        ...
        public final int getTotalECCodewords() {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Number) ipChange.ipc$dispatch("73d9d80a", new Object[]{this})).intValue();
            }
            return this.f3641a * getNumBlocks();
        }
    }
    ...
    public static Version getVersionForNumber(int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Version) ipChange.ipc$dispatch("2ba84c10", new Object[]{new Integer(i)});
        }
        if (i > 0 && i <= 40) {
            return e[i - 1];
        }
    ...
    public final int[] getAlignmentPatternCenters() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (int[]) ipChange.ipc$dispatch("3e25c082", new Object[]{this});
        }
        return this.b;
    }
    ...
    public final int getDimensionForVersion() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("c201f99", new Object[]{this})).intValue();
        }
        return (this.f3639a * 4) + 17;
    }

    public final ECBlocks getECBlocksForLevel(ErrorCorrectionLevel errorCorrectionLevel) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ECBlocks) ipChange.ipc$dispatch("a2f64aea", new Object[]{this, errorCorrectionLevel});
        }
        return this.c[errorCorrectionLevel.ordinal()];
    }

    public final int getTotalCodewords() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("2d92f468", new Object[]{this})).intValue();
        }
        return this.d;
    }
    ...
    public final int getVersionNumber() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("7dcce585", new Object[]{this})).intValue();
        }
        return this.f3639a;
    }
    ...
    public final String toString() {
        ...
        return String.valueOf(this.f3639a);
    }
}
