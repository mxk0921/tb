...
public final class MspReqExV3 extends Message {
    ...
    public MspReqExV3(MspReqExV3 mspReqExV3) {
        super(mspReqExV3);
        if (mspReqExV3 != null) {
            this.api_nsp = mspReqExV3.api_nsp;
            this.api_nm = mspReqExV3.api_nm;
            this.action = mspReqExV3.action;
            this.synch = mspReqExV3.synch;
            this.decay = mspReqExV3.decay;
            this.external_info = mspReqExV3.external_info;
            this.secData = mspReqExV3.secData;
            this.user_id = mspReqExV3.user_id;
            this.session = mspReqExV3.session;
            this.trid = mspReqExV3.trid;
            this.trdfrom = mspReqExV3.trdfrom;
            this.locLoginOnce = mspReqExV3.locLoginOnce;
            this.hasAlipay = mspReqExV3.hasAlipay;
            this.app_key = mspReqExV3.app_key;
            this.subua1 = mspReqExV3.subua1;
            this.subua2 = mspReqExV3.subua2;
            this.subua3 = mspReqExV3.subua3;
            this.extinfo = mspReqExV3.extinfo;
            this.certpay = mspReqExV3.certpay;
        }
    }

    public static /* synthetic */ Object ipc$super(MspReqExV3 mspReqExV3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/network/pb/rpcv3/MspReqExV3");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof MspReqExV3)) {
            return false;
        }
        MspReqExV3 mspReqExV3 = (MspReqExV3) obj;
        if (!equals(this.api_nsp, mspReqExV3.api_nsp) || !equals(this.api_nm, mspReqExV3.api_nm) || !equals(this.action, mspReqExV3.action) || !equals(this.synch, mspReqExV3.synch) || !equals(this.decay, mspReqExV3.decay) || !equals(this.external_info, mspReqExV3.external_info) || !equals(this.secData, mspReqExV3.secData) || !equals(this.user_id, mspReqExV3.user_id) || !equals(this.session, mspReqExV3.session) || !equals(this.trid, mspReqExV3.trid) || !equals(this.trdfrom, mspReqExV3.trdfrom) || !equals(this.locLoginOnce, mspReqExV3.locLoginOnce) || !equals(this.hasAlipay, mspReqExV3.hasAlipay) || !equals(this.app_key, mspReqExV3.app_key) || !equals(this.subua1, mspReqExV3.subua1) || !equals(this.subua2, mspReqExV3.subua2) || !equals(this.subua3, mspReqExV3.subua3) || !equals(this.extinfo, mspReqExV3.extinfo) || !equals(this.certpay, mspReqExV3.certpay)) {
            return false;
        }
        return true;
    }

    public final MspReqExV3 fillTagValue(int i, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MspReqExV3) ipChange.ipc$dispatch("1a3c14f6", new Object[]{this, new Integer(i), obj});
        }
        switch (i) {
            case 1:
