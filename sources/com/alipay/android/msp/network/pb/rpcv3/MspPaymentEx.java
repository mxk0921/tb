...
public final class MspPaymentEx extends Message {
    ...
    @ProtoField(tag = 16)
    public MspChannelValueEx channelValue;
    ...
    public MspPaymentEx(MspPaymentEx mspPaymentEx) {
        super(mspPaymentEx);
        if (mspPaymentEx != null) {
            this.paymentFlag = mspPaymentEx.paymentFlag;
            this.logo = mspPaymentEx.logo;
            this.name = mspPaymentEx.name;
            this.tail = mspPaymentEx.tail;
            this.detailAction = mspPaymentEx.detailAction;
            this.value = mspPaymentEx.value;
            this.detail = mspPaymentEx.detail;
            this.dlg = mspPaymentEx.dlg;
            this.children = mspPaymentEx.children;
            this.closeMsg = mspPaymentEx.closeMsg;
            this.availableTitle = mspPaymentEx.availableTitle;
            this.discountTitle = mspPaymentEx.discountTitle;
            this.fanTitle = mspPaymentEx.fanTitle;
            this.huiTitle = mspPaymentEx.huiTitle;
            this.endCode = mspPaymentEx.endCode;
            this.channelValue = mspPaymentEx.channelValue;
            this.extinfo = mspPaymentEx.extinfo;
        }
    }

    public static /* synthetic */ Object ipc$super(MspPaymentEx mspPaymentEx, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/network/pb/rpcv3/MspPaymentEx");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof MspPaymentEx)) {
            return false;
        }
        MspPaymentEx mspPaymentEx = (MspPaymentEx) obj;
        if (!equals(this.paymentFlag, mspPaymentEx.paymentFlag) || !equals(this.logo, mspPaymentEx.logo) || !equals(this.name, mspPaymentEx.name) || !equals(this.tail, mspPaymentEx.tail) || !equals(this.detailAction, mspPaymentEx.detailAction) || !equals(this.value, mspPaymentEx.value) || !equals(this.detail, mspPaymentEx.detail) || !equals(this.dlg, mspPaymentEx.dlg) || !equals(this.children, mspPaymentEx.children) || !equals(this.closeMsg, mspPaymentEx.closeMsg) || !equals(this.availableTitle, mspPaymentEx.availableTitle) || !equals(this.discountTitle, mspPaymentEx.discountTitle) || !equals(this.fanTitle, mspPaymentEx.fanTitle) || !equals(this.huiTitle, mspPaymentEx.huiTitle) || !equals(this.endCode, mspPaymentEx.endCode) || !equals(this.channelValue, mspPaymentEx.channelValue) || !equals(this.extinfo, mspPaymentEx.extinfo)) {
            return false;
        }
        return true;
    }

    public final MspPaymentEx fillTagValue(int i, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MspPaymentEx) ipChange.ipc$dispatch("a5ec9b0b", new Object[]{this, new Integer(i), obj});
        }
        switch (i) {
            case 1:
            ...
            case 15:
                ...
                break;
            case 16:
                this.channelValue = (MspChannelValueEx) obj;
                break;
            case 17:
    ...
    public final int hashCode() {
        ...
        int i33 = (i32 + i15) * 37;
        MspChannelValueEx mspChannelValueEx = this.channelValue;
        if (mspChannelValueEx != null) {
            i16 = mspChannelValueEx.hashCode();
        } else {
            i16 = 0;
        }
        int i34 = (i33 + i16) * 37;
