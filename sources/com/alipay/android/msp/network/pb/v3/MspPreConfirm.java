...
public final class MspPreConfirm extends Message {
    ...
    public static /* synthetic */ Object ipc$super(MspPreConfirm mspPreConfirm, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/network/pb/v3/MspPreConfirm");
    }
