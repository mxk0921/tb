...
public final class MspReqV3 extends Message {
    ...
    public static /* synthetic */ Object ipc$super(MspReqV3 mspReqV3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/network/pb/v3/MspReqV3");
    }
