...
public final class MspResV3 extends Message {
    ...
    public static /* synthetic */ Object ipc$super(MspResV3 mspResV3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/network/pb/v3/MspResV3");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!equals(this.code, mspResV3.code) || !equals(this.err_msg, mspResV3.err_msg) || !equals(this.memo, mspResV3.memo) || !equals(this.result, mspResV3.result) || !equals(this.end_code, mspResV3.end_code) || !equals(this.synch, mspResV3.synch) || !equals(this.trade_no, mspResV3.trade_no) || !equals(this.wpage, mspResV3.wpage) || !equals(this.noBack, mspResV3.noBack) || !equals(this.uname, mspResV3.uname) || !equals(this.uurl, mspResV3.uurl) || !equals(this.tplid, mspResV3.tplid) || !equals(this.tpl, mspResV3.tpl) || !equals(this.data, mspResV3.data) || !equals(this.time, mspResV3.time) || !equals(this.uac, mspResV3.uac) || !equals(this.dg, mspResV3.dg) || !equals(this.wnd, mspResV3.wnd) || !equals(this.page, mspResV3.page) || !equals(this.session, mspResV3.session) || !equals(this.tid, mspResV3.tid) || !equals(this.client_key, mspResV3.client_key) || !equals(this.ajax, mspResV3.ajax) || !equals(this.iajax, mspResV3.iajax) || !equals(this.onload, mspResV3.onload) || !equals(this.user_id, mspResV3.user_id) || !equals(this.pkey, mspResV3.pkey) || !equals(this.extinfo, mspResV3.extinfo) || !equals(this.tplv2, mspResV3.tplv2) || !equals(this.preConfirm, mspResV3.preConfirm) || !equals(this.channelLogo, mspResV3.channelLogo)) {
            return false;
        }
        return true;
    }

    public final MspResV3 fillTagValue(int i, Object obj) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (MspResV3) ipChange.ipc$dispatch("241c76ea", new Object[]{this, new Integer(i), obj});
        }
        switch (i) {
            case 1:
            ...
            case 28:
                ...
                break;
            case 29:
                this.tplv2 = (MspTpl) obj;
                break;
            case 30:
                this.preConfirm = (MspPreConfirm) obj;
                break;
            case 31:
                this.channelLogo = (MspChannelLogo) obj;
                break;
        }
        return this;
    }
