...
public class TidLocalApi extends JSPlugin {
    ...
    public static /* synthetic */ Object ipc$super(TidLocalApi tidLocalApi, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/drivers/legacyapi/TidLocalApi");
    }
