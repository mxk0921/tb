...
public class MetaSpmExposureStore extends LocalEventStore {
    ...
    public static /* synthetic */ Object ipc$super(MetaSpmExposureStore metaSpmExposureStore, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/msp/drivers/stores/store/metaevents/MetaSpmExposureStore");
    }
