package com.alipay.android.app.template.data;

/* compiled from: Taobao */
/* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes3.dex */
public class TplConstants {
    public static final String CACHE_STRATEGY_KEY = "cacheStrategy";
    public static final String CLIENT_A11Y_OLDER_VERSION = "fb.env.older_version";
    public static final String CLIENT_A11Y_TALKBACK = "fb.env.a11y.voice";
    public static final String CLIENT_ALIPAY_LANG = "fb.env.lang";
    ...
    public static final String SERVER_TIME_MAY_BE_OFFLINE = "fb.env.server_time_may_offline";
    public static final String SHOW_MODE_KEY = "showMode";
    public static final String SRC_MOBILE_TMS_QR = "mobiletms_qr_code";
