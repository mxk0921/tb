...
public abstract class IBiometricValidateNewDialog extends Dialog implements AuthenticatorManager.AuthNotify {
    ...
    public IBiometricValidateNewDialog(Context context, int i) {
        super(context, i);
    }

    public static /* synthetic */ Object ipc$super(IBiometricValidateNewDialog iBiometricValidateNewDialog, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/android/phone/seauthenticator/iotauth/fingerprint/IBiometricValidateNewDialog");
    }
    ...
    public abstract Dialog showDialog(int i, String str, int i2, IDialogActionListener iDialogActionListener);
