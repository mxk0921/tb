...
public class ExposeTracker extends BaseTracker {
    ...
    public static /* synthetic */ Object ipc$super(ExposeTracker exposeTracker, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/mobile/monitor/track/spm/monitor/tracker/ExposeTracker");
    }
