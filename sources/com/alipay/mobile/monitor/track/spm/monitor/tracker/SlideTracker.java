...
public class SlideTracker extends BaseTracker {
    ...
    public static /* synthetic */ Object ipc$super(SlideTracker slideTracker, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/mobile/monitor/track/spm/monitor/tracker/SlideTracker");
    }
