...
public class IPCResultDesc {
    ...
    public static final int RETURN_LOCAL_CALL_MNG_IS_NULL_CODE = 108;
    public static final String RETURN_LOCAL_CALL_MNG_IS_NULL_MSG = "LocalCallManager is null.";
    public static final int RETURN_LOCAL_IPCMANAGER_IS_NULL_CODE = 107;
    public static final String RETURN_LOCAL_IPCMANAGER_IS_NULL_MSG = "Local ipcManager is null.";
