...
public interface LogContext {
    ...
    public static final String IS_DANGEROUS_UPLOAD = "isDangerousUpload";
    ...
    public static final String LOG_HOST_HTTPS_RELEASE_METDS = "https://loggw.alipay.com";
    public static final String LOG_HOST_HTTPS_RELEASE_METDS_EX = "https://loggw-ex.alipay.com";
    public static final String LOG_HOST_RELEASE = "http://mdap.alipaylog.com";
    public static final String LOG_SWITCH_MDAP_CORE = "switch_mdap_core";
    ...
    String getHotpatchBundleVersion();

    String getHotpatchDesc();
    ...
    TraceLoggerInterceptor getTraceLoggerInterceptor();
    ...
    void setHotpatchBundleVersion(String str);

    void setHotpatchBundleVersionNoCommit(String str);

    void setHotpatchDesc(String str);

    void setHotpatchDescNoCommit(String str);
    ...
    void setTraceLoggerInterceptor(TraceLoggerInterceptor traceLoggerInterceptor);
