...
public class EditTextUtil {
    ...
    public final Map<Integer, String> f4333a = new ConcurrentHashMap();
    ...
    public void OnTextChanged(int i, String str, int i2, int i3, int i4) {
        ...
        String str2 = (String) ((ConcurrentHashMap) this.f4333a).get(Integer.valueOf(i));
        if (str2 == null) {
            str2 = "";
        }
        try {
            ...
            Map<Integer, String> map = this.f4333a;
    ...
    public void clear(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((ConcurrentHashMap) this.f4333a).remove(Integer.valueOf(i));
        }
    }

    public String getText(int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8f841a27", new Object[]{this, new Integer(i)}) : RsaUtils.encryptPassword((String) ((ConcurrentHashMap) this.f4333a).get(Integer.valueOf(i)));
    }
    ...
    public String getText(int i, String str, String str2, EncryptRandomType encryptRandomType) {
        ...
        String str4 = (String) ((ConcurrentHashMap) this.f4333a).get(Integer.valueOf(i));
        if (str4 == null) {
            return "";
        }
