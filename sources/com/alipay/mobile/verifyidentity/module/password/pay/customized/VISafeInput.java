...
public class VISafeInput implements VISafeInputInterface {
    ...
    public final SafeInputContext f4327a;

    public VISafeInput(Activity activity, boolean z) {
        VerifyLogCat.i("VISafeInput", "VISafeInput always new");
        this.f4327a = new SafeInputContext(activity, z);
    ...
    public void clearText() {
        ...
        SafeInputContext safeInputContext = this.f4327a;
