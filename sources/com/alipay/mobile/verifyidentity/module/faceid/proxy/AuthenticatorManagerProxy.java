package com.alipay.mobile.verifyidentity.module.faceid.proxy;
...
public class AuthenticatorManagerProxy implements ASProxy {
    ...
    private static JSONObject a(AuthenticatorMessage authenticatorMessage) {
        ...
        sb3.append(authenticatorMessage.getAuthenticatorType());
        jSONObject.put("authenticatorType", (Object) sb3.toString());
        try {
    ...
    public static /* synthetic */ SentryDelegate access$000(AuthenticatorManagerProxy authenticatorManagerProxy) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (SentryDelegate) ipChange.ipc$dispatch("aa76ac4a", new Object[]{authenticatorManagerProxy});
        }
    ...
    public static /* synthetic */ JSONObject access$100(AuthenticatorManagerProxy authenticatorManagerProxy, AuthenticatorResponse authenticatorResponse) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (JSONObject) ipChange.ipc$dispatch("60ff4a7d", new Object[]{authenticatorManagerProxy, authenticatorResponse});
        }
    ...
    public int startAuth(Context context, AuthenticatorMessage authenticatorMessage, final AuthenticatorManager.Callback callback, String str) {
        ...
        return this.authenticatorManager.startAuth(context, authenticatorMessage, new AuthenticatorManager.Callback() { // from class: com.alipay.mobile.verifyidentity.module.faceid.proxy.AuthenticatorManagerProxy.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
