...
public class SecureAccessibilityDelegate extends View.AccessibilityDelegate {
    ...
    public static /* synthetic */ Object ipc$super(SecureAccessibilityDelegate secureAccessibilityDelegate, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/mobile/verifyidentity/ui/utils/SecureAccessibilityDelegate");
    }
