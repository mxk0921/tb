...
public class HttpManager implements Transport {
    ...
    public static final ThreadFactory h = new ThreadFactory() { // from class: com.alipay.vi.android.phone.mrpc.core.HttpManager.2
        public static volatile transient /* synthetic */ IpChange $ipChange;

        /* renamed from: a  reason: collision with root package name */
        public final AtomicInteger f4561a = new AtomicInteger(1);
        ...
        public final Thread newThread(Runnable runnable) {
            ...
            Thread thread = new Thread(runnable, "com.alipay.vi.mobile.common.transport.http.HttpManager.HttpWorker #" + this.f4561a.getAndIncrement());
    ...
    /* renamed from: a  reason: collision with root package name */
    public ThreadPoolExecutor f4560a;
    public AndroidHttpClient b = AndroidHttpClient.newInstance("android");
    public long c;
    public long d;
    public long e;
    public int f;
    ...
    public HttpManager(Context context) {
        ...
        this.f4560a = threadPoolExecutor;
        try {
    ...
    public static final synchronized HttpManager a(Context context) {
    ...
    public void close() {
        ...
        ThreadPoolExecutor threadPoolExecutor = this.f4560a;
    ...
    public String dumpPerf() {
        ...
        return String.format("HttpManager" + hashCode() + ": Active Task = %d, Completed Task = %d, All Task = %d,Avarage Speed = %d KB/S, Connetct Time = %d ms, All data size = %d bytes, All enqueueConnect time = %d ms, All socket time = %d ms, All request times = %d times", Integer.valueOf(this.f4560a.getActiveCount()), Long.valueOf(this.f4560a.getCompletedTaskCount()), Long.valueOf(this.f4560a.getTaskCount()), Long.valueOf(getAverageSpeed()), Long.valueOf(getAverageConnectTime()), Long.valueOf(this.c), Long.valueOf(this.d), Long.valueOf(this.e), Integer.valueOf(this.f));
    }
        ...
        if (request instanceof HttpUrlRequest) {
            ...
            FutureTask<Response> futureTask = new FutureTask<Response>(generateWorker) { // from class: com.alipay.vi.android.phone.mrpc.core.HttpManager.1
                ...
                public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
                    ...
                    throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alipay/vi/android/phone/mrpc/core/HttpManager$1");
                }
            ...
            this.f4560a.execute(futureTask);
            return futureTask;
        }
    ...
    public HttpWorker generateWorker(HttpUrlRequest httpUrlRequest) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (HttpWorker) ipChange.ipc$dispatch("b785281e", new Object[]{this, httpUrlRequest});
        }
    ...
    public AndroidHttpClient getHttpClient() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (AndroidHttpClient) ipChange.ipc$dispatch("4672debe", new Object[]{this});
        }
        return this.b;
    }
}
