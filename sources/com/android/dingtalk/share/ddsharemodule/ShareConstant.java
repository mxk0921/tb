...
public class ShareConstant {
    ...
    public static final String ALI_DD_APP_PACKAGE = "com.alibaba.android.rimet.aliding";
    public static final int COMMAND_GETMESSAGE_FROM_DD = 3;
    public static final int COMMAND_SENDAUTH = 1;
    public static final int COMMAND_SENDAUTH_V2 = 100;
    ...
    public static final String DD_SEND_AUTH_ACTIVITY_SCHEME = "dingtalk://qr.dingtalk.com/im/send_auth.html";
    public static final int DINGDING_SDK_SHARE_VERSION_V1 = 20151201;
    public static final int DINGDING_SDK_SHARE_VERSION_V2 = 20160101;
    ...
    public static final String EXTRA_IMAGE_OBJECT_IMAGE_URI = "android.intent.ding.EXTRA_IMAGE_OBJECT_IMAGE_URI";
    ...
    public static final String EXTRA_SEND_AUTH_CODE = "android.intent.ding.EXTRA_SEND_AUTH_CODE";
    public static final String EXTRA_SEND_AUTH_SCOPE = "android.intent.ding.EXTRA_SEND_AUTH_SCOPE";
    public static final String EXTRA_SEND_AUTH_STATE = "android.intent.ding.EXTRA_SEND_AUTH_STATE";
    ...
    public static final int SDK_VERSION = 20160101;
