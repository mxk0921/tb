...
public class PluginUtil {
    ...
    public static boolean onDataMessage(Context context, String str, String str2, boolean z) {
        ...
        bundle.putString(Constant.PROP_MESSAGE_ID, str);
        bundle.putByteArray(RemoteMessageConst.MSGBODY, str2.getBytes(m.f5445a));
    ...
    public static void onMessage(Context context, String[] strArr) {
        HMSLog.i("PluginUtil", xpd.c.EVENT_ON_MESSAGE);
