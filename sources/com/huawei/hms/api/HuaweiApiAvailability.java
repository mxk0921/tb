...
public abstract class HuaweiApiAvailability {
    ...
    public abstract tct<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract tct<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract tct<Void> getHuaweiServicesReady(Activity activity);
