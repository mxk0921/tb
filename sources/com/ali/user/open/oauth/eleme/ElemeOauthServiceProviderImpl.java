...
public class ElemeOauthServiceProviderImpl extends BaseOauthServiceProviderImpl {
    ...
    public static /* synthetic */ Object ipc$super(ElemeOauthServiceProviderImpl elemeOauthServiceProviderImpl, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/open/oauth/eleme/ElemeOauthServiceProviderImpl");
    }
    ...
    public void logout(Context context, String str) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((SessionService) AliMemberSDK.getService(SessionService.class)).logout("eleme");
        }
    }
    ...
    public void refreshWhenLogin(String str, boolean z) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((SessionService) AliMemberSDK.getService(SessionService.class)).refreshWhenLogin("eleme", (LoginReturnData) JSON.parseObject(str, LoginReturnData.class));
        }
    }
}
