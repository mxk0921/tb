...
public interface OauthResultCode {
    ...
    public static final int OAUTH_ALIPAY_RESULT_CANCELL = 204;
    public static final int OAUTH_ALIPAY_RESULT_GETSIGN_FAIL = 203;
    public static final int OAUTH_ALIPAY_RESULT_IS_NULL = 201;
    public static final int OAUTH_ATB_RESULT_AUTHCODE_IS_NULL = 303;
    public static final int OAUTH_ERROR_APP_CREDENTIAL_IS_NULL = 101;
    public static final int OAUTH_ERROR_PARAM_IS_NULL = 102;
    public static final int OAUTH_JIUYOU_RESULT_ACTIVITY_IS_NULL = 801;
    public static final int OAUTH_JIUYOU_RESULT_BASE = 800;
    public static final int OAUTH_JIUYOU_RESULT_CANCEL = 804;
    public static final int OAUTH_JIUYOU_RESULT_CREDENTIAL_IS_NULL = 802;
    public static final int OAUTH_JIUYOU_RESULT_FAIL = 803;
