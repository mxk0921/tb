...
public class TaobaoUccServiceProviderImpl extends BaseUccServiceProvider {
    ...
    public static /* synthetic */ Object ipc$super(TaobaoUccServiceProviderImpl taobaoUccServiceProviderImpl, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/open/ucc/taobao/TaobaoUccServiceProviderImpl");
    }
