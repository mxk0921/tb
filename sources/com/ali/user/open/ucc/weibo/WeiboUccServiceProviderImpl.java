...
public class WeiboUccServiceProviderImpl extends BaseUccServiceProvider {
    ...
    public static /* synthetic */ Object ipc$super(WeiboUccServiceProviderImpl weiboUccServiceProviderImpl, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/open/ucc/weibo/WeiboUccServiceProviderImpl");
    }
    ...
    public void cleanUp(Context context) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((OauthService) AliMemberSDK.getService(OauthService.class)).logout(context, "weibo");
        }
    }
