...
public class ElemeUccServiceProviderImpl extends BaseUccServiceProvider {
    ...
    public static /* synthetic */ Object ipc$super(ElemeUccServiceProviderImpl elemeUccServiceProviderImpl, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/open/ucc/eleme/ElemeUccServiceProviderImpl");
    }
    ...
    public void cleanUp(Context context) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((OauthService) AliMemberSDK.getService(OauthService.class)).logout(context, "eleme");
        }
    }
    ...
    public void refreshWhenLogin(String str, String str2, boolean z) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ((OauthService) AliMemberSDK.getService(OauthService.class)).refreshWhenLogin("eleme", str2, z);
        }
    }
}
