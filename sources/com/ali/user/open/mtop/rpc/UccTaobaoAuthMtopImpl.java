...
import com.ali.user.open.ucc.util.MtopRemoteAuth;
...
public class UccTaobaoAuthMtopImpl implements rid {
    ...
    public void login(final iby ibyVar, boolean z) {
        ...
        if (z) {
            ...
            try {
                IpChange ipChange = MtopRemoteAuth.$ipChange;
                MtopRemoteAuth.class.getMethod("login", LoginCallback.class).invoke(null, loginCallback);
            } catch (Throwable th) {
                th.printStackTrace();
