...
public class RegistConstants {
    ...
    public static final String REGISTER_CODE_LENGTH = "codeLength";
    public static final String REGISTER_MOBILE_NUM = "mobile_num";
    public static final String REGISTER_SESSION_ID = "session_id";
    public static final String REGISTER_TRACE_PARAM = "trace_param";
    public static final String REGISTPARAM = "registParam";
    public static final String REG_PAGE_TYPE = "reg_page_type";
    public static final String REG_TOKEN = "token";
