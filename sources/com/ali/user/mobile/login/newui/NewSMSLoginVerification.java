...
public class NewSMSLoginVerification extends NewBaseLoginFragment implements UserMobileLoginView, View.OnClickListener {
    ...
    public static /* synthetic */ void access$000(NewSMSLoginVerification newSMSLoginVerification, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("e7e8f372", new Object[]{newSMSLoginVerification, str});
        } else {
            newSMSLoginVerification.addControl(str);
        }
    }

    public static /* synthetic */ void access$100(NewSMSLoginVerification newSMSLoginVerification, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("169a5d91", new Object[]{newSMSLoginVerification, str});
        } else {
            newSMSLoginVerification.addControl(str);
        }
    }

    public static /* synthetic */ IDialogHelper access$200(NewSMSLoginVerification newSMSLoginVerification) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (IDialogHelper) ipChange.ipc$dispatch("deea1699", new Object[]{newSMSLoginVerification});
        }
        return newSMSLoginVerification.mDialogHelper;
    }

    public static /* synthetic */ IDialogHelper access$300(NewSMSLoginVerification newSMSLoginVerification) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (IDialogHelper) ipChange.ipc$dispatch("e271b99a", new Object[]{newSMSLoginVerification});
        }
        return newSMSLoginVerification.mDialogHelper;
    }

    public static /* synthetic */ void access$400(NewSMSLoginVerification newSMSLoginVerification, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a2ae9bee", new Object[]{newSMSLoginVerification, str});
        } else {
            newSMSLoginVerification.addControl(str);
        }
    }

    public static /* synthetic */ void access$500(NewSMSLoginVerification newSMSLoginVerification, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d160060d", new Object[]{newSMSLoginVerification, str});
        } else {
            newSMSLoginVerification.addControl(str);
        }
    }

    public static /* synthetic */ Object ipc$super(NewSMSLoginVerification newSMSLoginVerification, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1504501726:
                super.onDestroy();
                return null;
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/newui/NewSMSLoginVerification");
        }
    }

    private boolean isNickSendSms() {
        LoginParam loginParam;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("ba7cc2cf", new Object[]{this})).booleanValue();
        }
        if (!TextUtils.isEmpty(this.mMaskMobile) || ((loginParam = this.loginParam) != null && loginParam.nickSms)) {
            return true;
        }
        return false;
    }
    ...
    public int getLayoutContent() {
        ...
        return R.layout.aliuser_fragment_sms_login_verification_new;
    }
    ...
    public String getPageName() {
        ...
        if (TextUtils.isEmpty(this.mOutterSourcePage)) {
    ...
    public boolean onBackPressed() {
        ...
        this.mAliUserDialog = AliUserDialog.Builder(getActivity()).setTitle(getString(R.string.aliuser_exit_smscode_hint)).setOnNegativeClickListener(getString(R.string.aliuser_title_back), new AliUserDialog.NegativeClickListener() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.8
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void onClick(View view) {
                ...
                AliUserDialog aliUserDialog = NewSMSLoginVerification.this.mAliUserDialog;
                if (aliUserDialog != null) {
                    aliUserDialog.dismiss();
                }
                NewSMSLoginVerification.access$500(NewSMSLoginVerification.this, UTConstans.Controls.UT_REG_BACK_BUTTON_CLICK);
                if (NewSMSLoginVerification.this.isActive() && NewSMSLoginVerification.this.getActivity() != null) {
                    NewSMSLoginVerification.this.goBack();
                }
            }
        }).setOnPositiveClickListener(getString(R.string.aliuser_wait_a_moment), new AliUserDialog.PositiveClickListener() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.7
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void onClick(View view) {
                ...
                NewSMSLoginVerification.access$400(NewSMSLoginVerification.this, UTConstans.Controls.UT_REG_BACK_BUTTON_CANCEL);
            }
        }).build().shown();
        return true;
    }
    ...
    public void onSendSMSAction() {
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (sMSNickLoginPresenter != null && sMSNickLoginPresenter.getLoginParam() != null) {
                ...
                this.mNickLoginPresenter.getLoginParam().regXianyu = this.regXianyu;
            ...
            if (userMobileLoginPresenter != null && userMobileLoginPresenter.getLoginParam() != null) {
                ...
                this.mMobileLoginPresenter.getLoginParam().regXianyu = this.regXianyu;
    ...
    public void sendCodeAction() {
        ...
        if (ipChange instanceof IpChange) {
            ...
            MainThreadExecutor.execute(new Runnable() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.6
                public static volatile transient /* synthetic */ IpChange $ipChange;
                ...
                public void run() {
                    ...
                    AliUserSmsCodeViewNew aliUserSmsCodeViewNew = NewSMSLoginVerification.this.mSmsCodeView;
                    if (aliUserSmsCodeViewNew != null) {
                        aliUserSmsCodeViewNew.clearText();
                    }
                    try {
                        NewSMSLoginVerification.this.onSendSMSAction();
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
                }
    ...
    public void showMoreLoginModeMenu(LoginModeState loginModeState) {
        ...
        this.mChangeLogin.postDelayed(new Runnable() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.4
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void run() {
                ...
                try {
                    if (NewSMSLoginVerification.access$200(NewSMSLoginVerification.this) != null) {
                        NewSMSLoginVerification.access$300(NewSMSLoginVerification.this).hideInputMethod();
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
        ...
        while (it.hasNext()) {
            ...
            if (!TextUtils.equals(loginModeState.name(), next)) {
                ...
                if (i > 0) {
                    ...
                    menuItem.setMenuItemOnClickListener(new MenuItemOnClickListener(bottomMenuFragment, menuItem) { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.5
                        public static volatile transient /* synthetic */ IpChange $ipChange;

                        public static /* synthetic */ Object ipc$super(AnonymousClass5 r2, String str, Object... objArr) {
                            str.hashCode();
                            int hashCode = str.hashCode();
                            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/newui/NewSMSLoginVerification$5");
                        }
                        ...
                        public void onClickMenuItem(View view, com.ali.user.mobile.ui.widget.MenuItem menuItem2) {
                            ...
                            } else if (NewSMSLoginVerification.this.isActive()) {
                                NewSMSLoginVerification.this.switchLoginModeHit(valueOf);
                                if (NewSMSLoginVerification.this.havanaId == 0 || !LoginModeState.SCAN_FACE.name().equals(next)) {
                                    ILoginMethodChange iLoginMethodChange = NewSMSLoginVerification.mLoginMethodChange;
                                    if (iLoginMethodChange != null) {
                                        iLoginMethodChange.onMethodChange(valueOf);
                                    }
                                    NewSMSLoginVerification.mLoginMethodChange = null;
                                    boolean supportOverseaSimLogin = CountryUtil.supportOverseaSimLogin(NewSMSLoginVerification.this.mUserLoginActivity.fireAppLaunchRes);
                                    if (supportOverseaSimLogin) {
                                        ...
                                        NewSMSLoginVerification.this.mUserLoginActivity.switchToRecommendLogin(intent);
                                    } else if (NewSMSLoginVerification.this.isActive() && NewSMSLoginVerification.this.getActivity() != null) {
                                        NewSMSLoginVerification.this.goBack();
                                    }
                                } else {
                                    NewSMSLoginVerification.this.onFaceLogin();
                                }
                            }
                        }
                    });
        ...
        if (arguments != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (loginParam != null) {
                    ...
                    loginParam.utPageName = getPageName();
                    this.regXianyu = this.loginParam.regXianyu;
                }
            }
            ...
            this.fromOversea = arguments.getBoolean(LoginConstant.FROM_OVERSEA, false);
    ...
    public void initViews(View view) {
        ...
        if (14050 == this.mErrorCode || (TextUtils.isEmpty(this.mMaskMobile) && (loginParam2 = this.loginParam) != null && loginParam2.nickSms)) {
        ...
        AliUserSmsCodeViewNew aliUserSmsCodeViewNew = (AliUserSmsCodeViewNew) view.findViewById(R.id.aliuser_login_sms_code_view);
        this.mSmsCodeView = aliUserSmsCodeViewNew;
        if (!(aliUserSmsCodeViewNew == null || (loginParam = this.loginParam) == null || TextUtils.isEmpty(loginParam.codeLength))) {
            this.mSmsCodeView.setTextCount(Integer.parseInt(this.loginParam.codeLength));
        }
        this.mSmsCodeView.setOnCompletedListener(new AliUserSmsCodeViewNew.OnCompletedListener() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void onCompleted(String str3) {
                ...
                if (ipChange2 instanceof IpChange) {
                    ...
                    NewSMSLoginVerification.this.submitLoginForm();
                }
            }
        });
        this.mSmsCodeView.focus();
        this.mSmsCodeView.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void onFocusChange(View view2, boolean z) {
                ...
                if (ipChange2 instanceof IpChange) {
                    ...
                    NewSMSLoginVerification.access$000(NewSMSLoginVerification.this, "inputcode_input");
                }
            }
        });
        ...
        if (textView2 != null) {
            if (!LoginSwitch.getSwitch("showOther", "true") || (arrayList = this.mAvailableLoginModes) == null || arrayList.size() <= 1) {
                ...
                setVisibility(this.mChangeLogin, 0);
                this.mChangeLogin.setOnClickListener(new View.OnClickListener() { // from class: com.ali.user.mobile.login.newui.NewSMSLoginVerification.3
                    public static volatile transient /* synthetic */ IpChange $ipChange;
                    ...
                    public void onClick(View view2) {
                        ...
                        NewSMSLoginVerification.access$100(NewSMSLoginVerification.this, UTConstans.Controls.UT_CHOOSE_OTHER);
                        NewSMSLoginVerification.this.showMoreLoginModeMenu(LoginModeState.SMS_LOGIN);
                    }
                });
            }
        }
