...
public class NickSmsSendTask extends SmsSendTask {
    ...
    public static /* synthetic */ Object ipc$super(NickSmsSendTask nickSmsSendTask, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/tasks/NickSmsSendTask");
    }
