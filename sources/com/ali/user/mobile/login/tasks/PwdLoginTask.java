...
public class PwdLoginTask extends BaseLoginTask {
    ...
    public static /* synthetic */ Object ipc$super(PwdLoginTask pwdLoginTask, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/tasks/PwdLoginTask");
    }
    ...
    public void invokeLoginRpc(LoginBaseParam loginBaseParam, RpcRequestCallback<LoginReturnData> rpcRequestCallback) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            LoginDataRepository.getInstance().unifyLoginWithTaobaoGW(loginBaseParam, rpcRequestCallback);
        }
    }
}
