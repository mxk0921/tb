...
public class EmailLoginTask extends BaseLoginTask {
    ...
    public static /* synthetic */ Object ipc$super(EmailLoginTask emailLoginTask, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/tasks/EmailLoginTask");
    }
    ...
    public void invokeLoginRpc(LoginBaseParam loginBaseParam, RpcRequestCallback<LoginReturnData> rpcRequestCallback) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            UserLoginServiceImpl.getInstance().emailLogin(loginBaseParam, rpcRequestCallback);
        }
    }
}
