...
public class NickSmsLoginTask extends BaseLoginTask {
    ...
    public static /* synthetic */ Object ipc$super(NickSmsLoginTask nickSmsLoginTask, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ali/user/mobile/login/tasks/NickSmsLoginTask");
    }
    ...
    public void invokeLoginRpc(LoginBaseParam loginBaseParam, RpcRequestCallback<LoginReturnData> rpcRequestCallback) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            LoginComponent.getInstance().smsLoginWithNick(loginBaseParam, rpcRequestCallback);
        }
    }
}
