...
public final class jo {
    ...
    private static final Comparator f14983a = new a();
    ...
    public static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return jo.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return jo.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return jo.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return jo.a((byte[]) obj, (byte[]) obj2);
            }
            return jo.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int compare = f14983a.compare(list.get(i), list2.get(i));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f14983a;
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int compare = f14983a.compare(it.next(), it2.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static ByteBuffer a(ByteBuffer byteBuffer) {
        return m932a(byteBuffer) ? byteBuffer : ByteBuffer.wrap(m933a(byteBuffer));
    }
    ...
    public static boolean m932a(ByteBuffer byteBuffer) {
        return byteBuffer.hasArray() && byteBuffer.position() == 0 && byteBuffer.arrayOffset() == 0 && byteBuffer.remaining() == byteBuffer.capacity();
    }

    /* renamed from: a  reason: collision with other method in class */
    public static byte[] m933a(ByteBuffer byteBuffer) {
        if (m932a(byteBuffer)) {
