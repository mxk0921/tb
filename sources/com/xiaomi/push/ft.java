...
public enum ft {
    ...
    CHANNEL_STATS_COUNTER(JosStatusCodes.RTN_CODE_COMMON_ERROR),
    ...
    GSLB_TCP_INVALARG(cdw.T_FONT_COLOR_SELECTOR),
    GSLB_TCP_UKNOWNHOST(cdw.T_TITLE_COLOR_SELECTOR),
    GSLB_TCP_ERR_OTHER(10199),
    GSLB_ERR(10999),
    CONN_SUCCESS(20000),
    CONN_TCP_NOACCESS(TaobaoMediaPlayer.FFP_PROP_INT64_HEVC_DECODE_OPT),
    ...
    CHANNEL_TIMER_DELAYED(TaobaoMediaPlayer.FFP_PROP_INT64_AUDIO_DISABLE);
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case TaobaoMediaPlayer.FFP_PROP_INT64_AUDIO_DISABLE /* 50001 */:
