...
public class e {
    private static PerfClientReport a(PerfClientReport perfClientReport, String str) {
        long[] a2;
        if (perfClientReport == null || (a2 = m423a(str)) == null) {
            return null;
        }
    ...
    private static HashMap<String, String> m422a(String str) {
        Throwable th;
        Exception e;
    ...
    */
    ...
    public static void a(String str, a[] aVarArr) {
        ...
        if (!(aVarArr == null || aVarArr.length <= 0 || TextUtils.isEmpty(str))) {
            ...
            try {
                ...
                HashMap<String, String> a2 = m422a(str);
                for (a aVar : aVarArr) {
                    if (aVar != null) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static long[] m423a(String str) {
