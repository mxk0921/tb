...
final class l extends aa {
    ...
    public final void a(v vVar) {
        ...
        int i = tVar.i();
        u.c("OnDelTagsTask", "doTask,删除成功的标签 = " + d + " 删除失败的= " + e + " 错误码= " + i);
        String h = tVar.h();
        if (d != null) {
            for (String str : d) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            u.c("OnDelTagsTask", "doTask1,删除成功的别名 = " + arrayList + " 删除失败的别名= " + arrayList3 + " 错误码= " + i);
            if (arrayList.size() > 0) {
                m.a();
                m.b(arrayList);
            }
        ...
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            u.c("OnDelTagsTask", "doTask1,删除成功的标签 = " + arrayList + " 删除失败的标签= " + arrayList3 + " 错误码= " + i);
