...
public final class fg {
    ...
    public static byte[] a(byte[] bArr) throws Exception {
        PublicKey generatePublic = KeyFactory.getInstance(man.KEY_ALGORITHM).generatePublic(new X509EncodedKeySpec(en.a(new StringBuilder(new String(b)).reverse().toString().getBytes())));
