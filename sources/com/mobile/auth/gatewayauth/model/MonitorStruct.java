...
public class MonitorStruct implements pxf, Serializable {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            setApiParams(wrf.h(jSONObject.optJSONObject("apiParams")));
        } catch (Throwable th) {
            try {
    ...
    public JSONObject toJson() {
        try {
            ...
            try {
                n.put("apiParams", new JSONObject(this.apiParams));
