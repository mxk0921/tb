...
import com.mobile.auth.gatewayauth.utils.O0000Oo;
...
public class UStruct implements pxf, Serializable {
    ...
    public UStruct(MonitorStruct monitorStruct) {
        ...
        this.startTime = O0000Oo.O000000o(monitorStruct.getStartTime());
        this.endTime = O0000Oo.O000000o(monitorStruct.getEndTime());
        ...
        this.carrierReturnTime = O0000Oo.O000000o(monitorStruct.getCarrierReturnTime());
    ...
    private UStruct(Builder builder) {
        ...
        this.startTime = O0000Oo.O000000o(Builder.access$1600(builder));
        this.endTime = O0000Oo.O000000o(Builder.access$1700(builder));
