...
public class OpenBusiLuckyMoney {
    ...
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            ...
            if (str5 == null || str5.length() <= 0 || (str = this.timeStamp) == null || str.length() <= 0 || (str2 = this.nonceStr) == null || str2.length() <= 0 || (str3 = this.signType) == null || str3.length() <= 0 || (str4 = this.signature) == null || str4.length() <= 0) {
                return false;
            }
            return true;
        }
