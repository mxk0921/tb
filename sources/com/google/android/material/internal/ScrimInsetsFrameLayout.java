...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public class a implements OnApplyWindowInsetsListener {
        ...
        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
            ...
            if (!windowInsetsCompat.hasSystemWindowInsets() || scrimInsetsFrameLayout.insetForeground == null) {
                z = true;
            } else {
                z = false;
            }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray h = xot.h(context, attributeSet, R.styleable.ScrimInsetsFrameLayout, i, R.style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = h.getDrawable(R.styleable.ScrimInsetsFrameLayout_insetForeground);
        h.recycle();
        setWillNotDraw(true);
