...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public class c implements AppBarLayout.d {
        ...
        public void a(AppBarLayout appBarLayout, int i) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                bfw viewOffsetHelper = CollapsingToolbarLayout.getViewOffsetHelper(childAt);
                int i4 = layoutParams.collapseMode;
                if (i4 == 1) {
                    viewOffsetHelper.e(MathUtils.clamp(-i, 0, collapsingToolbarLayout.getMaxOffsetForPinChild(childAt)));
                } else if (i4 == 2) {
                    viewOffsetHelper.e(Math.round((-i) * layoutParams.parallaxMult));
                }
            }
            ...
            collapsingToolbarLayout.collapsingTextHelper.c0(Math.abs(i) / ((collapsingToolbarLayout.getHeight() - ViewCompat.getMinimumHeight(collapsingToolbarLayout)) - i2));
        }
    }
    ...
    private void animateScrim(int i) {
        ...
        if (valueAnimator == null) {
            ...
            if (i > this.scrimAlpha) {
                timeInterpolator = pz0.FAST_OUT_LINEAR_IN_INTERPOLATOR;
            } else {
                timeInterpolator = pz0.LINEAR_OUT_SLOW_IN_INTERPOLATOR;
            }
    ...
    public static bfw getViewOffsetHelper(View view) {
        int i = R.id.view_offset_helper;
        bfw bfwVar = (bfw) view.getTag(i);
        if (bfwVar != null) {
            return bfwVar;
        }
        bfw bfwVar2 = new bfw(view);
        view.setTag(i, bfwVar2);
        return bfwVar2;
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < childCount2; i10++) {
            getViewOffsetHelper(getChildAt(i10)).d();
        }
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            boolean z3 = true;
            ...
            if (z2) {
                ...
                qd7.a(this, this.dummyView, this.tmpRect);
                com.google.android.material.internal.a aVar = this.collapsingTextHelper;
                int i11 = this.tmpRect.left;
                ...
                aVar.L(i12, titleMarginTop, i13 - i6, (this.tmpRect.bottom + maxOffsetForPinChild) - this.toolbar.getTitleMarginBottom());
                ...
                aVar2.T(i7, i14, i15 - i8, (i4 - i2) - this.expandedMarginBottom);
                this.collapsingTextHelper.J();
            }
        }
        if (this.toolbar != null) {
            if (this.collapsingTitleEnabled && TextUtils.isEmpty(this.collapsingTextHelper.A())) {
    ...
    public void setExpandedTitleTextColor(ColorStateList colorStateList) {
        this.collapsingTextHelper.X(colorStateList);
    }

    public void setExpandedTitleTypeface(Typeface typeface) {
        this.collapsingTextHelper.a0(typeface);
    }

    public void setMaxLines(int i) {
        this.collapsingTextHelper.e0(i);
    }
