...
public class SnackbarContentLayout extends LinearLayout implements fq4 {
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(l7i.f(l7i.c(this, R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
