...
public class MaterialTextView extends AppCompatTextView {
    ...
    private static boolean canApplyTextAppearanceLineHeight(Context context) {
        return k6i.b(context, R.attr.textAppearanceLineHeightEnabled, true);
    }
    ...
    private static int readFirstAvailableDimension(Context context, TypedArray typedArray, int... iArr) {
        ...
        for (int i2 = 0; i2 < iArr.length && i < 0; i2++) {
            i = u9i.c(context, typedArray, iArr[i2], -1);
        }
        return i;
    }
    ...
    public MaterialTextView(Context context, AttributeSet attributeSet, int i, int i2) {
        super(bai.c(context, attributeSet, i, i2), attributeSet, i);
