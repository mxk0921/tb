...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapter2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            /* JADX WARN: Code restructure failed: missing block: B:17:0x0038, code lost:
                if (java.lang.Integer.parseInt(r1) != 0) goto L_0x0070;
             */
            /* JADX WARN: Code restructure failed: missing block: B:18:0x003b, code lost:
                r5 = false;
             */
            /* JADX WARN: Code restructure failed: missing block: B:25:0x006e, code lost:
                if (r8.nextInt() != 0) goto L_0x0070;
             */
            @Override // com.google.gson.TypeAdapter
            /*
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + f7l.PLUS + cls2.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.33
            ...
            public String toString() {
                return "Factory[type=" + cls2.getName() + f7l.PLUS + cls.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
}
