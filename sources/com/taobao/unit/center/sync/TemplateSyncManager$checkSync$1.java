...
public final class TemplateSyncManager$checkSync$1 extends Lambda implements u1a<Integer, Integer, xhv> {
    ...
    public static /* synthetic */ Object ipc$super(TemplateSyncManager$checkSync$1 templateSyncManager$checkSync$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/unit/center/sync/TemplateSyncManager$checkSync$1");
    }
