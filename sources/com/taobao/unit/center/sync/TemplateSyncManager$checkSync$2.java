...
public final /* synthetic */ class TemplateSyncManager$checkSync$2 extends FunctionReference implements g1a<JSONObject, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public TemplateSyncManager$checkSync$2(TemplateSyncManager templateSyncManager) {
        super(1, templateSyncManager);
    }

    public static /* synthetic */ Object ipc$super(TemplateSyncManager$checkSync$2 templateSyncManager$checkSync$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/unit/center/sync/TemplateSyncManager$checkSync$2");
    }
