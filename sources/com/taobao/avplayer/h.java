...
public class h implements ValueAnimator.AnimatorUpdateListener {
    ...
    public h(DWVideoViewController dWVideoViewController, int i, int i2) {
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        layoutParams.width = (int) (this.f10185a + (((DWVideoViewController.w(this.c) - this.f10185a) * abs) / 90.0f));
