...
public class RedPackageResultRequestParams extends MtopUtils.b<JSONObject> {
    ...
    public RedPackageResultRequestParams() {
        HashMap hashMap = new HashMap();
        this.headers = hashMap;
        hashMap.put("asac", SECURITY_CODE_VALUE);
    }

    public static /* synthetic */ Object ipc$super(RedPackageResultRequestParams redPackageResultRequestParams, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tab2interact/core/redpackage/mtop/RedPackageResultRequestParams");
    }
