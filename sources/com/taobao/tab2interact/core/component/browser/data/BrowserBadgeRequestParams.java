...
public class BrowserBadgeRequestParams extends MtopUtils.b<JSONObject> {
    ...
    private String api = "mtop.cogman.container.center.login";
    ...
    public BrowserBadgeRequestParams() {
        ...
        hashMap.put("asac", SECURITY_CODE_VALUE);
        if (akt.O1()) {
            MtopModule.appendHeaderXBizInfo(this.headers, "ci_bucket=" + akt.E2());
            this.headers.put(MtopModule.KEY_MTOP_HEADER_XBIZTYPE, "guangguang");
        }
    }

    public static /* synthetic */ Object ipc$super(BrowserBadgeRequestParams browserBadgeRequestParams, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tab2interact/core/component/browser/data/BrowserBadgeRequestParams");
    }
