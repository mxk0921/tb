...
public class EmptyFragment extends Fragment {
    ...
    public static /* synthetic */ Object ipc$super(EmptyFragment emptyFragment, String str, Object... objArr) {
        ...
        if (hashCode == -1512649357) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/oversea/live/fragment/EmptyFragment");
        }
    }
    ...
    public static /* synthetic */ c p2(EmptyFragment emptyFragment) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (c) ipChange.ipc$dispatch("f5886836", new Object[]{emptyFragment});
        }
    ...
    public final TBErrorView r2(Context context) {
        ...
        this.f11439a = tBErrorView;
        tBErrorView.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        this.f11439a.setButtonVisibility(TBErrorView.ButtonType.BUTTON_RIGHT, 8);
        this.f11439a.setButtonVisibility(TBErrorView.ButtonType.BUTTON_LEFT, 8);
        return this.f11439a;
    }
    ...
    public void s2(c cVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d0f99d9e", new Object[]{this, cVar});
        } else {
            this.c = cVar;
        }
    }
    ...
    public void u2(boolean z) {
        ...
        TBErrorView tBErrorView = this.f11439a;
        if (tBErrorView != null) {
            if (z) {
                tBErrorView.setTitle("正在加载中");
                this.f11439a.setSubTitle("请稍后...");
                TBErrorView tBErrorView2 = this.f11439a;
                TBErrorView.ButtonType buttonType = TBErrorView.ButtonType.BUTTON_LEFT;
                tBErrorView2.setButton(buttonType, "加载中", new a(this));
                this.f11439a.setButtonVisibility(buttonType, 4);
                return;
            }
            tBErrorView.setTitle(ErrorConstant.MappingMsg.NETWORK_MAPPING_MSG);
            this.f11439a.setSubTitle("别紧张，试试看刷新页面~");
            TBErrorView tBErrorView3 = this.f11439a;
            ...
            this.f11439a.setButtonVisibility(buttonType2, 0);
        }
    }
}
