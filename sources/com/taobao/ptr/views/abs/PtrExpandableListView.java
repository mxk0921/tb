...
public class PtrExpandableListView extends ExpandableListView implements v4n, com.taobao.ptr.a, n2n, AbsListView.OnScrollListener {
    ...
    public static /* synthetic */ Object ipc$super(PtrExpandableListView ptrExpandableListView, String str, Object... objArr) {
        if (str.hashCode() == -1488275586) {
            super.setOnScrollListener((AbsListView.OnScrollListener) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/ptr/views/abs/PtrExpandableListView");
    }
