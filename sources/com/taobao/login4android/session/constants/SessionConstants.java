...
public class SessionConstants {
    ...
    public static final String BIOMETRIC = "biometricId";
    ...
    public static final String INJECT_COOKIE_NEW = "injectCookieNew3";
    public static final String INJECT_COOKIE_OLD = "injectCookieOld3";
    public static final String INJECT_External_H5_COOKIE = "injectExternalH5Cookie";
    public static boolean IS_CHECK_COOKIE_VALID = false;
    ...
    public static final String OLD_ENCRYPTED_USERID = "old_encrypted_userid";
    ...
    public static final String UNINSTALL_RELOGIN_FLAG = "uninstallReloginFlag2";
