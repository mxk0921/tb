...
public final class RUMPageExtension$buildChildSpan$4 extends Lambda implements u1a<String, Object, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ uy8 $startLoadActionSpan;
    public final /* synthetic */ RUMPageExtension this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RUMPageExtension$buildChildSpan$4(uy8 uy8Var, RUMPageExtension rUMPageExtension) {
        super(2);
        this.$startLoadActionSpan = uy8Var;
        this.this$0 = rUMPageExtension;
    }

    public static /* synthetic */ Object ipc$super(RUMPageExtension$buildChildSpan$4 rUMPageExtension$buildChildSpan$4, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/kernel/extension/page/rum/RUMPageExtension$buildChildSpan$4");
    }
