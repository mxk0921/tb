...
public final class PubGameLoadingTitleBar extends TMSBaseTitleBar {
    ...
    public PubGameLoadingTitleBar(Context context) {
        super(context);
    ...
    public static /* synthetic */ Object ipc$super(PubGameLoadingTitleBar pubGameLoadingTitleBar, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/pub/splash/PubGameLoadingTitleBar");
    }
