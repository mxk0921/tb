...
public final class MTOPPrefetchExtension$translateTemplateParam$1 extends Lambda implements g1a<g6i, CharSequence> {
    ...
    public MTOPPrefetchExtension$translateTemplateParam$1(MTOPPrefetchExtension.b bVar, String str) {
        super(1);
        this.$dataProvider = bVar;
        this.$param = str;
    }

    public static /* synthetic */ Object ipc$super(MTOPPrefetchExtension$translateTemplateParam$1 mTOPPrefetchExtension$translateTemplateParam$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/uniapp/solution/extension/instance/MTOPPrefetchExtension$translateTemplateParam$1");
    }
