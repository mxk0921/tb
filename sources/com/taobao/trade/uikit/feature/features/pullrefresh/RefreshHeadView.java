...
public class RefreshHeadView extends LinearLayout {
    ...
    public static /* synthetic */ Object ipc$super(RefreshHeadView refreshHeadView, String str, Object... objArr) {
        ...
        if (hashCode == 949399698) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/trade/uikit/feature/features/pullrefresh/RefreshHeadView");
        }
    }
    ...
    public CustomProgressBar getProgressbar() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (CustomProgressBar) ipChange.ipc$dispatch("aee2ebba", new Object[]{this});
        }
