...
public class WidthProperty extends LayoutParamsProperty {
    ...
    public static /* synthetic */ Object ipc$super(WidthProperty widthProperty, String str, Object... objArr) {
        ...
        if (hashCode == -1368668786) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/weex/ui/animation/WidthProperty");
        }
    }
