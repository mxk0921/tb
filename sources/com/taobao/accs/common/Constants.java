...
public class Constants {
    ...
    public static final String ACTION_PUBLISH_BINDER = "com.taobao.accs.intent.action.PUBLISH_BINDER";
    ...
    public static final String ACTIVE_REPORT = "0";
    public static final String AMP_SYNC = "amp-sync";
    public static final int BG_MESSAGE_FILTER = 5;
    public static final int BLOCK_SERVICE = 8;
    public static final int CALLBACK_LISTENER = 4;
    ...
    public static final int CONNECTED_TO_PULL = 7;
    public static final String DB_NAME = "accs.db";
    public static final int DB_VERSION = 3;
    public static final int DEBUG = 2;
    public static final int DOWN_MESSAGE = 3;
    public static final int DOWN_RTT = 2;
    public static final String ERROR_CODE_INITIAL_VALUE = "-1";
    public static final String ERROR_CODE_SUCCESS = "200";
    public static final String FALSE = "false";
    public static final String HD_DDZ = "hd-doudizhu";
    public static final String IMPAAS = "accs-impaas";
    public static final String IMPAAS_MOCK = "accs-impass-mock";
    public static final int IPC_SERVICE_TO_LISTENER = 6;
    ...
    public static final int KEY_BIZ_ACK_REPORT_WAY = 20;
    ...
    public static final String KEY_DATA_RECEIVED_TIME = "onDataReceived";
    public static final String KEY_DELAY_CEILING = "delayCeiling";
    public static final String KEY_DEVICE_TOKEN = "deviceToken";
    public static final String KEY_DOWN_MONITOR = "d_monitor";
    ...
    public static final String KEY_FULL_LINK = "fullLink";
    public static final String KEY_HOST = "host";
    public static final String KEY_HTTP_CODE = "code";
    public static final String KEY_IMEI = "imei";
    public static final String KEY_IMSI = "imsi";
    public static final String KEY_INDEX = "index";
    public static final String KEY_INVOKE_MAIN = "invokeMain";
    ...
    public static final String KEY_REUSE_BINDER = "reuse_binder";
    ...
    public static final String KEY_STREAM_ID = "stm_id";
    public static final String KEY_STREAM_SEQ = "stm_seq";
    ...
    public static final String KEY_UP_RTT = "up_rtt";
    ...
    public static final String PASSIVE_REPORT = "1";
    public static final String PM = "powermsg";
    public static final String PM3 = "powermsg3";
    public static final String PM_MONITOR = "pmmonitor";
    public static final int PORT = 443;
    public static final int PREVIEW = 1;
    public static final byte PROTOCOL_V4 = 4;
    public static final byte PROTOCOL_VERSION = 2;
    public static final int RELEASE = 0;
    public static final int SDK_VERSION_CODE = 402;
    ...
    public static final String SP_KEY_BG_LIMIT_SWITCH = "bg_limit_switch";
    public static final String SP_KEY_BG_MSG_FILTER = "bg_msg_filter_ids";
    public static final String SP_KEY_BIND_USER_TIME = "bind_user_time";
    public static final String SP_KEY_CB_LISTENER = "cb_listener_ids";
    public static final String SP_KEY_CONNECT_TIMEOUT = "connect_timeout";
    public static final String SP_KEY_CONN_SERVICE_TYPE = "connection_service_type_v1";
    ...
    public static final String SP_KEY_DOWN_MESSAGE = "down_msg_ids";
    public static final String SP_KEY_DOWN_RTT = "down_rtt_ids";
    public static final String SP_KEY_EVENT_TRIGGER_TIMES = "event_trigger_times";
    public static final String SP_KEY_IPC_SVC_TO_LISTENER = "ipc_to_listener_ids";
    public static final String SP_KEY_KEEP_ALIVE_INIT_ENABLE = "keep_alive_init_enable";
    public static final String SP_KEY_KEEP_ALIVE_RANGE = "keep_alive_range_v1";
    ...
    public static final String SP_KEY_MAIN_CREATED_PID = "main_create_pid";
    public static final String SP_KEY_MASS_SWITCH = "mass_switch";
    public static final String SP_KEY_NEW_WV_IDS = "new_wv_ids";
    ...
    public static final String SP_KEY_ONLINE_TIME = "online";
    public static final String SP_KEY_REG_ID = "regid";
    public static final String SP_KEY_REPORT_TOKEN_TIME = "report_token_time";
    ...
    public static final String SP_KEY_UP_RETRY_IDS = "up_retry";
    public static final String SP_KEY_UTDID = "utdid";
    public static final String SP_KEY_VERSION = "version";
    public static final String SP_PROCESS_RECORD_FILE_NAME = "accs_process_record";
    public static final String STEPID_ACCS = "accs";
    public static final String TARGET_AServer_PING_CONTROL = "4|accs|ping";
    public static final String TARGET_BACK = "4|sal|bg";
    public static final String TARGET_BACK_LIMIT = "4|sal|bg-limit";
    ...
    public static final String TARGET_SERVICE_AGOO_CONTROL_CMD = "AgooControlCmd";
    ...
    public static final String TARGET_SYNC = "4|sal|sync";
    ...
    public static final int UP_RETRY = 0;
    ...
    /* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes4.dex */
    public @interface OrangeServiceIdType {
    }
