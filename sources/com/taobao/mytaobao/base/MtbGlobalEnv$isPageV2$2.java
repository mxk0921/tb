...
public final class MtbGlobalEnv$isPageV2$2 extends Lambda implements d1a<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$isPageV2$2 INSTANCE = new MtbGlobalEnv$isPageV2$2();

    public MtbGlobalEnv$isPageV2$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(MtbGlobalEnv$isPageV2$2 mtbGlobalEnv$isPageV2$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/mytaobao/base/MtbGlobalEnv$isPageV2$2");
    }
