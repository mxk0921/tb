...
public final class MtbGlobalEnv$enableDiffRefresh$2 extends Lambda implements d1a<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$enableDiffRefresh$2 INSTANCE = new MtbGlobalEnv$enableDiffRefresh$2();

    public MtbGlobalEnv$enableDiffRefresh$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(MtbGlobalEnv$enableDiffRefresh$2 mtbGlobalEnv$enableDiffRefresh$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/mytaobao/base/MtbGlobalEnv$enableDiffRefresh$2");
    }
