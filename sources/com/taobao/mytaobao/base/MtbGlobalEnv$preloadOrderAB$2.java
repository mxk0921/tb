...
public final class MtbGlobalEnv$preloadOrderAB$2 extends Lambda implements d1a<Integer> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$preloadOrderAB$2 INSTANCE = new MtbGlobalEnv$preloadOrderAB$2();

    public MtbGlobalEnv$preloadOrderAB$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(MtbGlobalEnv$preloadOrderAB$2 mtbGlobalEnv$preloadOrderAB$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/mytaobao/base/MtbGlobalEnv$preloadOrderAB$2");
    }
