...
public final class MtbGlobalEnv$noTraceLog$2 extends Lambda implements d1a<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$noTraceLog$2 INSTANCE = new MtbGlobalEnv$noTraceLog$2();

    public MtbGlobalEnv$noTraceLog$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(MtbGlobalEnv$noTraceLog$2 mtbGlobalEnv$noTraceLog$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/mytaobao/base/MtbGlobalEnv$noTraceLog$2");
    }
