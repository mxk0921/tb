...
public class NewPaySettingsActivity extends BaseActivity {
    ...
    public static /* synthetic */ Object ipc$super(NewPaySettingsActivity newPaySettingsActivity, String str, Object... objArr) {
        ...
        if (hashCode == -641568046) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/mytaobao/newsetting/NewPaySettingsActivity");
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            Nav.from(this).toUri("https://m.taobao.com/go/tbcashier/paysettings");
        } catch (Exception e) {
            e.printStackTrace();
        }
        finish();
