...
public final class MTBLogoutAccountEventHandler implements EventHandler {
    ...
    public void handle(Action action, ActionDispatcher actionDispatcher, CommandHandler commandHandler, final ServiceProvider serviceProvider) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            gl6.Companion.d("Page_MYTBSettingVC", "2101", "Page_MYTBSettingVC_退出登录", "spm=a2141.20998086.1.11");
            uuu.a(new Runnable() { // from class: com.taobao.mytaobao.newsetting.dx.setting.MTBLogoutAccountEventHandler$handle$1
                public static volatile transient /* synthetic */ IpChange $ipChange;
                ...
                public final void run() {
                    ...
                    if (serviceProvider2 != null && (pageService = (PageService) serviceProvider2.service(PageService.class)) != null && (activity = pageService.getActivity()) != null) {
                        LoginBroadcastHelper.registerLoginReceiver(Globals.getApplication(), new BroadcastReceiver() { // from class: com.taobao.mytaobao.newsetting.dx.setting.MTBLogoutAccountEventHandler$handle$1.1
                            public static volatile transient /* synthetic */ IpChange $ipChange;

                            public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
                                str.hashCode();
                                int hashCode = str.hashCode();
                                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/mytaobao/newsetting/dx/setting/MTBLogoutAccountEventHandler$handle$1$1");
                            }
