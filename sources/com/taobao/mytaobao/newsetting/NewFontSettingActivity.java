...
public class NewFontSettingActivity extends BaseActivity {
    ...
    public static /* synthetic */ Object ipc$super(NewFontSettingActivity newFontSettingActivity, String str, Object... objArr) {
        ...
        if (hashCode == -641568046) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/mytaobao/newsetting/NewFontSettingActivity");
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        s32.c().i("NewFontSettingActivity");
