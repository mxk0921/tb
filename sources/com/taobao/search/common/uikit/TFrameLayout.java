...
public class TFrameLayout extends FrameLayout implements ViewHelper, ViewGroupHelper, IFeatureList<FrameLayout> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    private FeatureList<FrameLayout> mFeatureList;
    ...
    public TFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        FeatureList<FrameLayout> featureList = new FeatureList<>(this);
        this.mFeatureList = featureList;
        featureList.init(context, attributeSet, i);
    }

    public static /* synthetic */ Object ipc$super(TFrameLayout tFrameLayout, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2012646654:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/search/common/uikit/TFrameLayout");
        }
    }

    @Override // com.taobao.uikit.utils.IFeatureList
    public boolean addFeature(AbsFeature<? super FrameLayout> absFeature) {
    ...
    @Override // com.taobao.uikit.utils.IFeatureList
    public AbsFeature<? super FrameLayout> findFeature(Class<? extends AbsFeature<? super FrameLayout>> cls) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    @Override // com.taobao.uikit.utils.IFeatureList
    public boolean removeFeature(Class<? extends AbsFeature<? super FrameLayout>> cls) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
