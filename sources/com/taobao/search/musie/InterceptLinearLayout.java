...
public class InterceptLinearLayout extends LinearLayout implements sif {
    ...
    public static /* synthetic */ Object ipc$super(InterceptLinearLayout interceptLinearLayout, String str, Object... objArr) {
        if (str.hashCode() == -407533570) {
            return new Boolean(super.onInterceptTouchEvent((MotionEvent) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/search/musie/InterceptLinearLayout");
    }
