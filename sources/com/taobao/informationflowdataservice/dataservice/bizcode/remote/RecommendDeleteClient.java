...
public class RecommendDeleteClient extends AbsMtopRequestClient<RecommendDeleteParams, RecommendDeleteResult> {
    ...
    public static /* synthetic */ Object ipc$super(RecommendDeleteClient recommendDeleteClient, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/informationflowdataservice/dataservice/bizcode/remote/RecommendDeleteClient");
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        if (g6jVar != null) {
            try {
                ...
                i65.b(TAG, "Call onSuccess exception", th);
            }
        }
    }
