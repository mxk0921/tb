...
public class ErrorMessage extends BaseMessage {
    ...
    public static ErrorMessage create() {
        ...
        if (ipChange instanceof IpChange) {
            return (ErrorMessage) ipChange.ipc$dispatch("7f3a9a9f", new Object[0]);
        }
    ...
    public static /* synthetic */ Object ipc$super(ErrorMessage errorMessage, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/messagekit/core/model/ErrorMessage");
    }
