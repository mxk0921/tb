...
public class RecommendEdgeClient extends AbsMtopRequestClient<RecommendEdgeParams, RecommendEdgeResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "RecommendEdgeClient";

    static {
        t2o.a(729809868);
    }

    public static /* synthetic */ Object ipc$super(RecommendEdgeClient recommendEdgeClient, String str, Object... objArr) {
        if (str.hashCode() == 1384478442) {
            super.setupMtopRequest((MtopRequest) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/recommend3/remote/RecommendEdgeClient");
    }
    ...
    public String getApiName() {
        ...
        return "mtop.taobao.wireless.home.awesome.recommend.edge";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        RecommendEdgeResultOutDo_ recommendEdgeResultOutDo_;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        if (baseOutDo != null) {
            recommendEdgeResultOutDo_ = (RecommendEdgeResultOutDo_) baseOutDo;
        } else {
            recommendEdgeResultOutDo_ = null;
        }
        g6j g6jVar = (g6j) this.mRequestListenerRef.get();
        if (g6jVar != null) {
            try {
                if (recommendEdgeResultOutDo_ != null) {
                    g6jVar.onSuccess(recommendEdgeResultOutDo_.getData());
                } else {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(RecommendEdgeResultOutDo_.class);
        }
    }
