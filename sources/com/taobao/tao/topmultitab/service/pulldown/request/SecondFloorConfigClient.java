...
public class SecondFloorConfigClient extends AbsMtopRequestClient<SecondFloorConfigParams, SecondFloorGetResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "SecondFloorConfigClient";

    static {
        t2o.a(729810288);
    }

    public static /* synthetic */ Object ipc$super(SecondFloorConfigClient secondFloorConfigClient, String str, Object... objArr) {
        if (str.hashCode() == 1384478442) {
            super.setupMtopRequest((MtopRequest) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/topmultitab/service/pulldown/request/SecondFloorConfigClient");
    }
    ...
    public String getApiName() {
        ...
        return "mtop.taobao.volvo.secondfloor.getconfig";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        SecondFloorGetResultOutDo_ secondFloorGetResultOutDo_;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        if (baseOutDo != null) {
            secondFloorGetResultOutDo_ = (SecondFloorGetResultOutDo_) baseOutDo;
        } else {
            secondFloorGetResultOutDo_ = null;
        }
        g6j g6jVar = (g6j) this.mRequestListenerRef.get();
        if (g6jVar != null) {
            try {
                if (secondFloorGetResultOutDo_ != null) {
                    g6jVar.onSuccess(secondFloorGetResultOutDo_.getData());
                } else {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(SecondFloorGetResultOutDo_.class);
        }
    }
