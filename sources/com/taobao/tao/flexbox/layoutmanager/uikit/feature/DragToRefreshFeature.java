...
public class DragToRefreshFeature extends AbsFeature<RecyclerView> implements TouchEventCallback, u9e, ScrollCallback {
    ...
    private lun mRefreshController;
    ...
    public DragToRefreshFeature(Context context, int i) {
        ...
        this.mRefreshController = new lun(this, context, this.mScroller, i);
        this.mOrientation = i;
    }

    public static /* synthetic */ lun access$000(DragToRefreshFeature dragToRefreshFeature) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (lun) ipChange.ipc$dispatch("d5a9a4c", new Object[]{dragToRefreshFeature});
        }
    ...
    public static /* synthetic */ int access$100(DragToRefreshFeature dragToRefreshFeature, RecyclerView recyclerView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("6edc21a", new Object[]{dragToRefreshFeature, recyclerView})).intValue();
        }
    ...
    public static /* synthetic */ boolean access$200(DragToRefreshFeature dragToRefreshFeature, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("58c8e2b8", new Object[]{dragToRefreshFeature, new Integer(i)})).booleanValue();
        }
        ...
        if (ipChange instanceof IpChange) {
            ...
            RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() { // from class: com.taobao.tao.flexbox.layoutmanager.uikit.feature.DragToRefreshFeature.1
                ...
                public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
                    ...
                    throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/flexbox/layoutmanager/uikit/feature/DragToRefreshFeature$1");
                }
                ...
                public void onScrolled(RecyclerView recyclerView2, int i, int i2) {
                    ...
                    } else if (!(i == 0 && i2 == 0) && DragToRefreshFeature.access$000(DragToRefreshFeature.this).t() && DragToRefreshFeature.access$000(DragToRefreshFeature.this).q() == 3) {
    ...
    */
    private boolean hasArrivedBottomEdgeOffset(int r9) {
        /*
            ...
            r0 = 0
            r1 = 1
            com.android.alibaba.ip.runtime.IpChange r2 = com.taobao.tao.flexbox.layoutmanager.uikit.feature.DragToRefreshFeature.$ipChange
        ...
        L_0x007d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.tao.flexbox.layoutmanager.uikit.feature.DragToRefreshFeature.hasArrivedBottomEdgeOffset(int):boolean");
    }
    ...
    public static /* synthetic */ Object ipc$super(DragToRefreshFeature dragToRefreshFeature, String str, Object... objArr) {
        ...
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/flexbox/layoutmanager/uikit/feature/DragToRefreshFeature");
    }
    ...
    public void beforeComputeScroll() {
        ...
        if (scroller2 == null || !scroller2.computeScrollOffset()) {
            lun lunVar = this.mRefreshController;
            if (lunVar != null && (scroller = this.mScroller) != null) {
        ...
        lun lunVar2 = this.mRefreshController;
        if (lunVar2 != null) {
            if (this.mOrientation == 1) {
    ...
    public void setOnDragToRefreshListener(a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("4f4333a5", new Object[]{this, aVar});
            return;
        }
        lun lunVar = this.mRefreshController;
        if (lunVar != null) {
    ...
    public void enablePositiveDrag(boolean z, View view, boolean z2, float f) {
        ...
        if (lunVar != null) {
            this.mEnablePositive = z;
            lunVar.j(z, R.string.tnode_uik_refresh_arrow, view, z2, f);
        }
    }
