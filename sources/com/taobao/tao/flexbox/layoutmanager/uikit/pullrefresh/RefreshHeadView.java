...
public class RefreshHeadView extends LinearLayout {
    ...
    public static /* synthetic */ Object ipc$super(RefreshHeadView refreshHeadView, String str, Object... objArr) {
        ...
        if (hashCode == 949399698) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/tao/flexbox/layoutmanager/uikit/pullrefresh/RefreshHeadView");
        }
    }
    ...
    public CustomProgressBar getProgressbar() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (CustomProgressBar) ipChange.ipc$dispatch("11495b88", new Object[]{this});
        }
    ...
    private void init(Context context, int i, View view, boolean z) {
        ...
        linearLayout.setId(R.id.tnode_refresh_header_view);
