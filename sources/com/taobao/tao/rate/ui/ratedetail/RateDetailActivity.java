...
public class RateDetailActivity extends CustomBaseActivity {
    ...
    public static /* synthetic */ Object ipc$super(RateDetailActivity rateDetailActivity, String str, Object... objArr) {
        ...
        if (hashCode == -641568046) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/tao/rate/ui/ratedetail/RateDetailActivity");
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getIntent() == null || getIntent().getData() == null || TextUtils.isEmpty(getIntent().getData().getQueryParameter("rateId"))) {
            ...
            if (!c || TextUtils.isEmpty(a2)) {
                ...
                from.toUri(zcu.b() + queryParameter);
            } else {
                Nav from2 = Nav.from(this);
                from2.toUri(a2 + queryParameter);
            }
        }
        finish();
    }
