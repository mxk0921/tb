...
public /* synthetic */ class Vatsb$min$2 extends FunctionReferenceImpl implements y1a<Object, String, KMPJsonObject, String, String> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final Vatsb$min$2 INSTANCE = new Vatsb$min$2();
    ...
    public static /* synthetic */ Object ipc$super(Vatsb$min$2 vatsb$min$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/kmp/nexus/arch/openArch/dto_and_do/response_declared_do/Vatsb$min$2");
    }
