...
public /* synthetic */ class Vatsb$max$2 extends FunctionReferenceImpl implements y1a<Object, String, KMPJsonObject, String, String> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final Vatsb$max$2 INSTANCE = new Vatsb$max$2();
    ...
    public static /* synthetic */ Object ipc$super(Vatsb$max$2 vatsb$max$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/kmp/nexus/arch/openArch/dto_and_do/response_declared_do/Vatsb$max$2");
    }
