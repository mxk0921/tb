...
public /* synthetic */ class BroadCaster$v$2 extends FunctionReferenceImpl implements y1a<Object, String, KMPJsonObject, String, String> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final BroadCaster$v$2 INSTANCE = new BroadCaster$v$2();

    public BroadCaster$v$2() {
    ...
    public static /* synthetic */ Object ipc$super(BroadCaster$v$2 broadCaster$v$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/kmp/nexus/arch/openArch/dto_and_do/response_declared_do/BroadCaster$v$2");
    }
