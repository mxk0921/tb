...
public class PopLayerWVNativePlugin extends TBNative {
    ...
    public static /* synthetic */ Object ipc$super(PopLayerWVNativePlugin popLayerWVNativePlugin, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tbpoplayer/view/jsbridge/PopLayerWVNativePlugin");
    }
    ...
    public boolean execute(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        try {
            ...
            wdm.h("PopLayerWVNativePlugin.executeError.", th);
