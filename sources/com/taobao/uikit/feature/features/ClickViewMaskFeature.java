...
public class ClickViewMaskFeature extends AbsFeature<View> implements CanvasCallback, TouchEventCallback {
    ...
    public static /* synthetic */ Object ipc$super(ClickViewMaskFeature clickViewMaskFeature, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/uikit/feature/features/ClickViewMaskFeature");
    }
    ...
    public void afterDraw(Canvas canvas) {
        ...
        } else if (this.mClickMaskEnable && this.mIsPressed) {
