...
public class ImageShapeFeature extends AbsFeature<ImageView> implements LayoutCallback, ImageCallback, CanvasCallback {
    ...
    public static /* synthetic */ Object ipc$super(ImageShapeFeature imageShapeFeature, String str, Object... objArr) {
        if (str.hashCode() == 1336372353) {
            super.setHost((ImageShapeFeature) ((View) objArr[0]));
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/uikit/feature/features/ImageShapeFeature");
    }
