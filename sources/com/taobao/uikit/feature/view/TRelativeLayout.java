...
public class TRelativeLayout extends RelativeLayout implements ViewHelper, ViewGroupHelper, IFeatureList<RelativeLayout> {
    ...
    private FeatureList<RelativeLayout> mFeatureList;
    ...
    public static /* synthetic */ Object ipc$super(TRelativeLayout tRelativeLayout, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2012646654:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/uikit/feature/view/TRelativeLayout");
        }
    }
