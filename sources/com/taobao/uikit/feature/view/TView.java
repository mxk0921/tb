...
public class TView extends View implements ViewHelper, IFeatureList<View> {
    ...
    public static /* synthetic */ Object ipc$super(TView tView, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2012646654:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/uikit/feature/view/TView");
        }
    }
