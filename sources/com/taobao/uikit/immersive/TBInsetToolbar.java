...
public class TBInsetToolbar extends Toolbar {
    ...
    public static /* synthetic */ Object ipc$super(TBInsetToolbar tBInsetToolbar, String str, Object... objArr) {
        if (str.hashCode() == 650865254) {
            super.onMeasure(((Number) objArr[0]).intValue(), ((Number) objArr[1]).intValue());
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/uikit/immersive/TBInsetToolbar");
    }
    ...
    public TBInsetToolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, -1);
    }

    /* JADX WARN: Finally extract failed */
    public TBInsetToolbar(Context context, AttributeSet attributeSet, int i) {
