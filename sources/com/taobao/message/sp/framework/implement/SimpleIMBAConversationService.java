...
public final class SimpleIMBAConversationService extends SimpleBaseConversationService {
    ...
    public SimpleIMBAConversationService(String str, String str2) {
        super(str, str2);
    ...
    public static /* synthetic */ Object ipc$super(SimpleIMBAConversationService simpleIMBAConversationService, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/message/sp/framework/implement/SimpleIMBAConversationService");
    }
