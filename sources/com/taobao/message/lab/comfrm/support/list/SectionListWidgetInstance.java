...
public class SectionListWidgetInstance extends AbsListWidgetInstance {
    ...
    public static /* synthetic */ Object ipc$super(SectionListWidgetInstance sectionListWidgetInstance, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/message/lab/comfrm/support/list/SectionListWidgetInstance");
    }
    ...
    public boolean isEmpty(JSONObject jSONObject) {
        ...
        if (jSONObject != null && getViewAdapterCount("content") == 0) {
            return true;
        }
        return false;
    }
