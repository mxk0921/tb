...
public class Constants {
    ...
    public static final String BINDER_INTERNAL_CLASS = "com.android.internal.os.BinderInternal";
    public static final int CALC_AND = 1;
    public static final int CALC_OR = 2;
    public static final int CALC_XOR = 3;
    public static final int CALL_TRANSACTION = 21;
    public static final String CLASS_SD_INNER_CONNECTION = "android.app.LoadedApk$ServiceDispatcher$InnerConnection";
    public static final String CLIENT_SERVICE_DESCRIPTOR = ClientServiceProvider.class.getName();
    public static final String CONTENT_PROVIDER = "mContentProvider";
    ...
    public static final String INTENT_KEY_SERVICE = "aranger_service_ipc";
    ...
    public static final int ONEWAY_FLAG = 17;
    ...
    public static final long PROVIDER_PUBLISH_TIME_OUT = 10000;
    public static final String PROXY_SUFFIX = "$$IPCProxy";
    public static final String SET_MAX_THREADS_METHOD_NAME = "setMaxThreads";
    public static final int TYPE_BIND_SERVICE = 4;
    ...
    public static final int TYPE_PROCESS_INFO = 6;
    public static final int TYPE_UNBIND_SERVICE = 5;
    ...
    public @interface CalcDefinition {
    }
