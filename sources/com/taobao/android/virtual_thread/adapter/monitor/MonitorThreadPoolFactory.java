...
public class MonitorThreadPoolFactory implements hrt {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    private static final ExecutorService sharedPool = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 3, TimeUnit.SECONDS, new SynchronousQueue(), new ThreadFactory() { // from class: tb.b0j
        @Override // java.util.concurrent.ThreadFactory
        public final Thread newThread(Runnable runnable) {
            Thread lambda$static$0;
            lambda$static$0 = MonitorThreadPoolFactory.lambda$static$0(runnable);
    ...
    public static final class a extends riw {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/virtual_thread/adapter/monitor/MonitorThreadPoolFactory$DefaultThreadFactory");
        }
        ...
        public VirtualThread newVirtualThread(Runnable runnable) {
            ...
            return new VirtualThread(runnable, this.f9887a.newThreadName());
        }
    }
    ...
    public ExecutorService createExecutorService(int i, int i2, long j, TimeUnit timeUnit, BlockingQueue<Runnable> blockingQueue, qqt qqtVar, RejectedExecutionHandler rejectedExecutionHandler) {
        ...
        return new MonitorThreadPoolExecutor(i, i2, j, timeUnit, blockingQueue, new a(qqtVar), rejectedExecutionHandler);
    }
    ...
    public ScheduledExecutorService createScheduledExecutorService(int i, qqt qqtVar, RejectedExecutionHandler rejectedExecutionHandler) {
        ...
        return new MonitorScheduledThreadPoolExecutor(i, new a(qqtVar), rejectedExecutionHandler);
    }
