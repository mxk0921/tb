...
@Exchange({ThreadPoolExecutor.class, VirtualThreadPoolExecutor.class})
...
public class MonitorThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public class a extends VirtualThreadPoolExecutor {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/virtual_thread/adapter/monitor/MonitorThreadPoolExecutor$1");
        }
        ...
        public void afterExecute(Runnable runnable, Throwable th) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                MonitorThreadPoolExecutor.this.afterExecute(runnable, th);
            }
        }
        ...
        public void beforeExecute(Thread thread, Runnable runnable) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                MonitorThreadPoolExecutor.this.beforeExecute(thread, runnable);
            }
        }
        ...
        public void terminated() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                MonitorThreadPoolExecutor.this.terminated();
            }
        }
    }
    ...
    public static class b implements VRejectedExecutionHandler {
        ...
        public final RejectedExecutionHandler f9886a;
        ...
        public b(RejectedExecutionHandler rejectedExecutionHandler, ThreadPoolExecutor threadPoolExecutor) {
            this.f9886a = rejectedExecutionHandler;
        ...
        public void vRejectedExecution(Runnable runnable, ExecutorService executorService) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.f9886a.rejectedExecution(runnable, this.b);
            }
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(MonitorThreadPoolExecutor monitorThreadPoolExecutor, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2140224945:
            ...
            default:
                int hashCode = str.hashCode();
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/virtual_thread/adapter/monitor/MonitorThreadPoolExecutor");
        }
    }
    ...
    public void afterExecute(Runnable runnable, Throwable th) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            MonitorUtils.c(this.isVirtualThreadPool, this.name, "afterExecute");
        }
    }
    ...
    public void beforeExecute(Thread thread, Runnable runnable) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            MonitorUtils.c(this.isVirtualThreadPool, this.name, "beforeExecute");
        }
    }
    ...
    public void execute(Runnable runnable) {
        ...
        MonitorUtils.c(this.isVirtualThreadPool, this.name, xpc.RECORD_EXECUTE);
        if (this.isVirtualThreadPool) {
    ...
    public RejectedExecutionHandler getRejectedExecutionHandler() {
        ...
        if (this.isVirtualThreadPool) {
            return ((b) this.vExecutor.getRejectedExecutionHandler()).f9886a;
        }
        return super.getRejectedExecutionHandler();
    }
    ...
    public MonitorThreadPoolExecutor(int i, int i2, long j, TimeUnit timeUnit, BlockingQueue<Runnable> blockingQueue, ThreadFactory threadFactory) {
        ...
        boolean z = !isExcludeThread && StubConfig.isVirtualThreadPool();
        this.isVirtualThreadPool = z;
        this.vExecutor = z ? initVirtualThread(i, i2, j, timeUnit, blockingQueue, threadFactory, null) : null;
    }
    ...
    public MonitorThreadPoolExecutor(int i, int i2, long j, TimeUnit timeUnit, BlockingQueue<Runnable> blockingQueue, ThreadFactory threadFactory, RejectedExecutionHandler rejectedExecutionHandler) {
        ...
        boolean z = !isExcludeThread && StubConfig.isVirtualThreadPool();
        this.isVirtualThreadPool = z;
        this.vExecutor = z ? initVirtualThread(i, i2, j, timeUnit, blockingQueue, threadFactory, rejectedExecutionHandler) : null;
    }
}
