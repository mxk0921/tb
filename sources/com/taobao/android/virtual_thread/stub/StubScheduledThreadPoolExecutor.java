...
public class StubScheduledThreadPoolExecutor extends ScheduledThreadPoolExecutor {
    ...
    public class a extends ScheduledVirtualThreadPoolExecutor {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/virtual_thread/stub/StubScheduledThreadPoolExecutor$1");
        }
        ...
        public void terminated() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                StubScheduledThreadPoolExecutor.access$000(StubScheduledThreadPoolExecutor.this);
            }
        }
    }
    ...
    public StubScheduledThreadPoolExecutor(int i) {
        super(i);
        String d = sqt.d();
        this.name = d;
    ...
    public static /* synthetic */ void access$000(StubScheduledThreadPoolExecutor stubScheduledThreadPoolExecutor) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("18012b51", new Object[]{stubScheduledThreadPoolExecutor});
        } else {
            stubScheduledThreadPoolExecutor.terminated();
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(StubScheduledThreadPoolExecutor stubScheduledThreadPoolExecutor, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2140224945:
            ...
            default:
                int hashCode = str.hashCode();
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/virtual_thread/stub/StubScheduledThreadPoolExecutor");
        }
    }
    ...
    private VRejectedExecutionHandler makeHandler(RejectedExecutionHandler rejectedExecutionHandler) {
        ...
        if (rejectedExecutionHandler != null) {
            return new StubThreadPoolExecutor.b(rejectedExecutionHandler, this);
        }
    ...
    public RejectedExecutionHandler getRejectedExecutionHandler() {
        ...
        if (this.isVirtualThreadPool) {
            return ((StubThreadPoolExecutor.b) this.vExecutor.getRejectedExecutionHandler()).f9903a;
        }
        return super.getRejectedExecutionHandler();
    }
    ...
    public StubScheduledThreadPoolExecutor(int i, riw riwVar) {
        super(i, riwVar);
        ...
        boolean z = !isExcludeThread && StubConfig.isVirtualThreadPool();
        this.isVirtualThreadPool = z;
        this.vExecutor = z ? initVirtualThread(i, riwVar, null) : null;
    }

    public StubScheduledThreadPoolExecutor(int i, RejectedExecutionHandler rejectedExecutionHandler) {
    ...
    public StubScheduledThreadPoolExecutor(int i, riw riwVar, RejectedExecutionHandler rejectedExecutionHandler) {
        super(i, riwVar, rejectedExecutionHandler);
        String e = sqt.e(riwVar);
        this.name = e;
        boolean isExcludeThread = StubConfig.isExcludeThread(e);
        this.isExcludeThreadPool = isExcludeThread;
        boolean z = !isExcludeThread && StubConfig.isVirtualThreadPool();
        this.isVirtualThreadPool = z;
        this.vExecutor = z ? initVirtualThread(i, riwVar, rejectedExecutionHandler) : null;
    }
}
