...
public class MoreFrame2 extends BaseFrame implements s3c {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                MoreFrame2.access$000(MoreFrame2.this);
            }
        }
    }
    ...
    public MoreFrame2(Context context, ux9 ux9Var) {
        super(context, ux9Var);
    }

    public static /* synthetic */ void access$000(MoreFrame2 moreFrame2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a112a5b1", new Object[]{moreFrame2});
        } else {
            moreFrame2.showInteractPanel();
        }
    }

    public static /* synthetic */ Object ipc$super(MoreFrame2 moreFrame2, String str, Object... objArr) {
        ...
        if (hashCode == -1272916118) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/live/plugin/atype/flexalocal/bottom/bottombar/MoreFrame2");
        }
    }
    ...
    public int getLayoutResId() {
        ...
        return R.layout.taolive_bottombar_more_layout2_flexalocal;
    }
    ...
    public void onDataReceived(TBLiveDataModel tBLiveDataModel) {
        ...
        o3s.b("MoreFrame", Constants.KEY_DATA_RECEIVED_TIME);
    ...
    public void onViewCreated(View view) {
        ...
        ((TUrlImageView) view.findViewById(R.id.taolive_bottombar_more_image)).setImageResource(R.drawable.taolive_icon_more_new_flexalocal);
