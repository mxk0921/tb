...
public enum BottomMode {
    ...
    public static BottomMode getBottomMode(String str) {
        ...
        if (ipChange instanceof IpChange) {
            return (BottomMode) ipChange.ipc$dispatch("7fc13bd", new Object[]{str});
        }
    ...
    public static /* synthetic */ Object ipc$super(BottomMode bottomMode, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/live/plugin/atype/flexalocal/good/view/bean/BottomMode");
    }

    public static BottomMode valueOf(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (BottomMode) ipChange.ipc$dispatch("cf59f481", new Object[]{str});
        }
