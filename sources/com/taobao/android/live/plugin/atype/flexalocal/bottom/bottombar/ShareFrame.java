...
public class ShareFrame extends BaseFrame implements s3c, fgv.e {
    ...
    public class a implements b0d {
        ...
        public void onSuccess(int i, NetResponse netResponse, NetBaseOutDo netBaseOutDo, Object obj) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                ShareFrame.access$000(ShareFrame.this, ((GetLiveShareConfigResponse) netBaseOutDo).getData());
            }
        }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            ShareFrame.access$100(ShareFrame.this, null);
            if (nh4.T0()) {
                sjr.g().e("com.taobao.taolive.room.share", ShareFrame.this.mFrameContext.C());
            }
        }
    }
    ...
    public class c implements Comparator<lip> {
        ...
        public c(ShareFrame shareFrame) {
        }
    ...
    /* compiled from: Taobao */
    /* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes5.dex */
    public class d implements Comparator<lip> {
        public static volatile transient /* synthetic */ IpChange $ipChange;

        public d(ShareFrame shareFrame) {
        }
    ...
    public ShareFrame(Context context, ux9 ux9Var) {
        super(context, ux9Var);
        boolean componentEntranceHidden = ComponentGroupConfig.componentEntranceHidden("BottomGroup", ComponentGroupConfig.BOTTOM_SHARE_BUTTON, this.mFrameContext);
        this.entranceHidden = componentEntranceHidden;
        if (!componentEntranceHidden) {
            this.mLiveShareBusiness = new e4h(new a());
        }
    }
    ...
    public static /* synthetic */ void access$100(ShareFrame shareFrame, Map map) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("25a95529", new Object[]{shareFrame, map});
        } else {
            shareFrame.showShare(map);
        }
    }
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (!TextUtils.isEmpty(str) && (map2 = this.mShareConfigOrderMap) != null && map2.containsKey(str)) {
                if (this.mShareConfigList == null) {
                    this.mShareConfigList = new OrderList<>(new c(this), new d(this));
                }
                lip lipVar = new lip();
                lipVar.b = str;
                lipVar.c = map.get("desc");
                lipVar.d = map.get("icon_url");
                lipVar.e = map.get("icon_url_v2");
    ...
    private void handleShareFrameVisiable(boolean z) {
        ...
        } else if (!giv.c().b() && bte.a(this.mFrameContext) && (tBLiveDataModel = this.mLiveDataModel) != null && !isRewardEnable(tBLiveDataModel, this.mFrameContext) && !this.entranceHidden) {
    ...
    public static /* synthetic */ Object ipc$super(ShareFrame shareFrame, String str, Object... objArr) {
        ...
        if (hashCode == -1272916118) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/live/plugin/atype/flexalocal/bottom/bottombar/ShareFrame");
        }
    }

    private boolean isRewardEnable(TBLiveDataModel tBLiveDataModel, ux9 ux9Var) {
        boolean z;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        VideoInfo.AdmireInfo admireInfo = videoInfo.admireInfo;
        if (admireInfo == null || !admireInfo.contributionEnabled) {
            z = false;
        } else {
            z = true;
        }
        if (!TextUtils.equals(videoInfo.roomStatus, "1") || tBLiveDataModel.mVideoInfo.status == 1 || tBLiveDataModel.mIsDiantaoTimeShift || !z || ux9Var.c) {
            return false;
        }
        return true;
    }
    ...
    private void requestInviteCodeOld(TBLiveDataModel tBLiveDataModel) {
        ...
        if (videoInfo != null && videoInfo.broadCaster != null) {
            ...
            if (!(giv.c().b() || (f = vx9.f(this.mFrameContext)) == null || f.k() == null || f.k().q() == null)) {
    ...
    private void shareClick() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("f73c80f0", new Object[]{this});
            return;
        }
        o3s.b(hjr.KMPTag, "share frame kmp send");
        new g44(this.mContext, this.mFrameContext).g("share");
    }
    ...
    private void updateShareIcon() {
        ...
        if (orderList == null || orderList.isEmpty()) {
            updateShareIcon(null);
        } else if (this.mContext == null || this.mRootView == null || this.mShareConfigList.get(0).e == null) {
            updateShareIcon(this.mShareConfigList.get(0).d);
        } else {
            ((TUrlImageView) this.mRootView.findViewById(R.id.taolive_bottombar_share_icon)).setImageUrl(this.mShareConfigList.get(0).e);
        }
    }
    ...
    public String bizCode() {
        ...
        return IBottomProxy.KEY_FRAME_CLASS_SHARE_FRAME;
    }
    ...
    public int getLayoutResId() {
        ...
        return R.layout.taolive_bottombar_share_layout_flexalocal;
    }
    ...
    public void onDataReceived(TBLiveDataModel tBLiveDataModel) {
        ...
        boolean isRewardEnable = isRewardEnable(tBLiveDataModel, this.mFrameContext);
        View view = this.mRootView;
        if (isRewardEnable || this.entranceHidden) {
            i = 8;
        } else {
            i = 0;
        }
    ...
    public void onViewCreated(View view) {
        ...
        TUrlImageView tUrlImageView = (TUrlImageView) view.findViewById(R.id.taolive_bottombar_share_icon);
        tUrlImageView.setImageResource(R.drawable.taolive_icon_new_style_share_flexalocal);
        NewStyleUtils.e(this.mContext, tUrlImageView);
        NewStyleUtils.b(this.mContext, this.mDefaultShareIcon, NewStyleUtils.NewStyleType.LARGE);
    ...
    private void updateShareIcon(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("1f4e8f80", new Object[]{this, str});
