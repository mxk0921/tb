...
public class DXNanoVerticalScrollView extends ScrollView implements knd {
    ...
    public DXNanoVerticalScrollView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void init(Context context) {
        ...
        dXNanoScrollViewContainer.setOrientation(1);
        super.addView(dXNanoScrollViewContainer, new FrameLayout.LayoutParams(-1, -1));
        a aVar = new a();
        this.dxScrollableViewImpl = aVar;
        aVar.g(this);
        this.dxScrollableViewImpl.f(dXNanoScrollViewContainer);
        this.isContainerInit = true;
    }

    public static /* synthetic */ Object ipc$super(DXNanoVerticalScrollView dXNanoVerticalScrollView, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1556944264:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamic_v35/view/DXNanoVerticalScrollView");
        }
    }
    ...
    public DXNanoVerticalScrollView(Context context, AttributeSet attributeSet) {
    ...
    public DXNanoVerticalScrollView(Context context) {
        super(context);
        init(context);
    }
