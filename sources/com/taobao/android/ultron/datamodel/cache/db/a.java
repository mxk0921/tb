...
public final class a {
    ...
    public static final class C0509a {
        ...
        public C0509a(String str, int i, boolean z, boolean z2, String str2, Field field, int i2) {
            this.f9845a = str.toLowerCase();
            this.b = i;
            this.c = z;
            this.d = z2;
            this.e = str2;
    ...
    public void a(SQLiteDatabase sQLiteDatabase) {
        ...
        for (C0509a aVar : this.b) {
            if (!aVar.a()) {
                sb.append(',');
                sb.append(aVar.f9845a);
                sb.append(' ');
                sb.append(e[aVar.b]);
        ...
        sb.setLength(0);
        for (C0509a aVar2 : this.b) {
            if (aVar2.c) {
                sb.append("CREATE INDEX ");
                sb.append(str);
                sb.append("_index_");
                sb.append(aVar2.f9845a);
                sb.append(" ON ");
                sb.append(str);
                sb.append(" (");
                sb.append(aVar2.f9845a);
        ...
        if (this.d) {
            ...
            for (C0509a aVar3 : this.b) {
                if (aVar3.d) {
                    String str3 = aVar3.f9845a;
                    sb.append(',');
                    sb.append(str3);
                    sb.append(" TEXT");
                }
            ...
            sb2.append(str2);
            sb2.append(" (_id");
            for (C0509a aVar4 : this.b) {
                if (aVar4.d) {
                    sb2.append(',');
                    sb2.append(aVar4.f9845a);
                }
            }
            sb2.append(") VALUES (new._id");
            for (C0509a aVar5 : this.b) {
                if (aVar5.d) {
                    sb2.append(",new.");
                    sb2.append(aVar5.f9845a);
                }
            }
            sb2.append(");");
    ...
    public long f(SQLiteDatabase sQLiteDatabase, Entry entry) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("82de06f5", new Object[]{this, sQLiteDatabase, entry})).longValue();
        }
        ...
        long replace = sQLiteDatabase.replace(this.f9844a, "_id", contentValues);
        entry.f9843a = replace;
        return replace;
    }
    ...
    public final void i(Class<?> cls, ArrayList<C0509a> arrayList) {
        int i;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        for (int i2 = 0; i2 != declaredFields.length; i2++) {
            ...
            if (column != null) {
                ...
                arrayList.add(new C0509a(column.value(), i, column.indexed(), column.fullText(), column.defaultValue(), field, arrayList.size()));
            }
        }
    }

    public final C0509a[] j(Class<?> cls) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (C0509a[]) ipChange.ipc$dispatch("e24b48e2", new Object[]{this, cls});
        }
        ...
        C0509a[] aVarArr = new C0509a[arrayList.size()];
