...
public class TBLOpenPlatformView extends RelativeLayout implements ncc, cpr.b, qlr, rlr {
    ...
    public static /* synthetic */ Object ipc$super(TBLOpenPlatformView tBLOpenPlatformView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/livehome/plugin/atype/flexalocal/homepage2/view/TBLOpenPlatformView");
    }
    ...
    public void setCoverImageSuccessCallBack(TBLiveMediaCardView.d dVar) {
        ...
        TBLiveMediaCardView tBLiveMediaCardView = this.mTBLiveOpenCardView;
        if (tBLiveMediaCardView != null) {
            tBLiveMediaCardView.setCoverImageSuccessCallBack(dVar);
        }
    }
    ...
    public void setNeedShowNodeWhenLiveStart(DinamicXEngine dinamicXEngine, DXWidgetNode dXWidgetNode, String str) {
        ...
        TBLiveMediaCardView tBLiveMediaCardView = this.mTBLiveOpenCardView;
        if (tBLiveMediaCardView != null) {
            tBLiveMediaCardView.setNeedShowNodeWhenLiveStart(dinamicXEngine, dXWidgetNode, str);
        }
    }
    ...
    public void setOpenPlatformViewEvent(a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("b34ecc14", new Object[]{this, aVar});
        }
    }
