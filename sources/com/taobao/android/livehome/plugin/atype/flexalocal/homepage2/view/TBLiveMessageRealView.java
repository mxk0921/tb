...
public class TBLiveMessageRealView extends LinearLayout {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            switch (str.hashCode()) {
                ...
                default:
                    ...
                    throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/livehome/plugin/atype/flexalocal/homepage2/view/TBLiveMessageRealView$1");
            }
        }
    ...
    public class b extends Handler {
        ...
        public static /* synthetic */ Object ipc$super(b bVar, String str, Object... objArr) {
            ...
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/livehome/plugin/atype/flexalocal/homepage2/view/TBLiveMessageRealView$2");
        }
    ...
    public static /* synthetic */ int access$000(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("a128f47b", new Object[]{tBLiveMessageRealView})).intValue();
        }
    ...
    public static /* synthetic */ Handler access$100(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Handler) ipChange.ipc$dispatch("70e3f9d", new Object[]{tBLiveMessageRealView});
        }
    ...
    public static /* synthetic */ int access$200(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("975c7d", new Object[]{tBLiveMessageRealView})).intValue();
        }
    ...
    public static /* synthetic */ int access$202(TBLiveMessageRealView tBLiveMessageRealView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("d358376a", new Object[]{tBLiveMessageRealView, new Integer(i)})).intValue();
        }
    ...
    public static /* synthetic */ int access$208(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("42c95e85", new Object[]{tBLiveMessageRealView})).intValue();
        }
    ...
    public static /* synthetic */ JSONArray access$300(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (JSONArray) ipChange.ipc$dispatch("3c913853", new Object[]{tBLiveMessageRealView});
        }
    ...
    public static /* synthetic */ int access$400(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("6005c47f", new Object[]{tBLiveMessageRealView})).intValue();
        }
    ...
    public static /* synthetic */ Object ipc$super(TBLiveMessageRealView tBLiveMessageRealView, String str, Object... objArr) {
        ...
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/livehome/plugin/atype/flexalocal/homepage2/view/TBLiveMessageRealView");
    }
