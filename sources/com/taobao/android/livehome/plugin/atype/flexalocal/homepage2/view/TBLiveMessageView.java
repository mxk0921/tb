    ...
    public static /* synthetic */ Object ipc$super(TBLiveMessageView tBLiveMessageView, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/livehome/plugin/atype/flexalocal/homepage2/view/TBLiveMessageView");
        }
    }
