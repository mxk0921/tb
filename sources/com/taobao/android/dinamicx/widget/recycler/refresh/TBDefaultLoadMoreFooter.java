...
public class TBDefaultLoadMoreFooter extends TBLoadMoreFooter {
    ...
    public static /* synthetic */ class a {
        public static final /* synthetic */ int[] $SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState;

        static {
            int[] iArr = new int[TBLoadMoreFooter.LoadMoreState.values().length];
            $SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState = iArr;
            try {
                iArr[TBLoadMoreFooter.LoadMoreState.NONE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState[TBLoadMoreFooter.LoadMoreState.PUSH_TO_LOAD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState[TBLoadMoreFooter.LoadMoreState.RELEASE_TO_LOAD.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState[TBLoadMoreFooter.LoadMoreState.LOADING.ordinal()] = 4;
    ...
    public TBDefaultLoadMoreFooter(Context context) {
        ...
        int i = R.string.dx_uik_load_more;
        String string = context2.getString(i);
        Context context3 = getContext();
        int i2 = R.string.dx_uik_release_to_load;
        String string2 = context3.getString(i2);
        Context context4 = getContext();
        int i3 = R.string.dx_uik_loading;
        String string3 = context4.getString(i3);
        Context context5 = getContext();
        int i4 = R.string.dx_uik_load_more_finished;
    ...
    public static /* synthetic */ Object ipc$super(TBDefaultLoadMoreFooter tBDefaultLoadMoreFooter, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx/widget/recycler/refresh/TBDefaultLoadMoreFooter");
    }
    ...
    public void changeToState(TBLoadMoreFooter.LoadMoreState loadMoreState) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            TBSwipeRefreshLayout.k kVar = this.mPushLoadMoreListener;
            if (kVar != null) {
                kVar.a(loadMoreState2, loadMoreState);
            }
            this.mState = loadMoreState;
            int i = a.$SwitchMap$com$taobao$android$dinamicx$widget$recycler$refresh$TBLoadMoreFooter$LoadMoreState[loadMoreState.ordinal()];
            if (i == 1) {
    ...
    public TBLoadMoreFooter.LoadMoreState getCurrentState() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (TBLoadMoreFooter.LoadMoreState) ipChange.ipc$dispatch("c2d1fcae", new Object[]{this});
        }
        return this.mState;
    }
