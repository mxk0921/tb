...
public class DXNativeFrameLayout extends FrameLayout implements jyc {
    ...
    public static /* synthetic */ Object ipc$super(DXNativeFrameLayout dXNativeFrameLayout, String str, Object... objArr) {
        ...
        if (hashCode == -244855388) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/dinamicx/view/DXNativeFrameLayout");
        }
    }
    ...
    public boolean isV2() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("f45ee6d1", new Object[]{this})).booleanValue();
        }
        return this.isV2;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        try {
            ...
            if ((b instanceof DXWidgetNode) && (dXRuntimeContext = b.getDXRuntimeContext()) != null) {
                ...
                f.a aVar = new f.a("native", "native_crash", f.DX_NATIVE_CRASH_3);
                if (fVar.c == null) {
