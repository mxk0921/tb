...
public class HGifView extends FrameLayout {
    ...
    private final String TAG = "HGifView";
    ...
    public static /* synthetic */ HImageView access$000(HGifView hGifView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (HImageView) ipChange.ipc$dispatch("33b8102c", new Object[]{hGifView});
        }
    ...
    public static /* synthetic */ Object ipc$super(HGifView hGifView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/home/component/view/HGifView");
    }

    public HImageView getBottomImageView() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (HImageView) ipChange.ipc$dispatch("925eb4e4", new Object[]{this});
        }
    ...
    public HImageView getGifImageView() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (HImageView) ipChange.ipc$dispatch("936577d7", new Object[]{this});
        }
