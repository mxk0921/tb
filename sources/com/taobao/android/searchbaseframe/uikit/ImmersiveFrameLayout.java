...
public class ImmersiveFrameLayout extends FrameLayout implements onb {
    ...
    public static /* synthetic */ Object ipc$super(ImmersiveFrameLayout immersiveFrameLayout, String str, Object... objArr) {
        ...
        if (hashCode == 623593120) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/searchbaseframe/uikit/ImmersiveFrameLayout");
        }
    }
    ...
    public ImmersiveFrameLayout(Context context, AttributeSet attributeSet, int i) {
