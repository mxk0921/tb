...
public final class DxContainer$createViewInner$3 extends Lambda implements d1a<xhv> {
    ...
    public DxContainer$createViewInner$3(DxContainer dxContainer, int i, int i2, DXTemplateItem dXTemplateItem, DxContainer.b bVar, g1a g1aVar, w1a w1aVar) {
        super(0);
    ...
    public static /* synthetic */ Object ipc$super(DxContainer$createViewInner$3 dxContainer$createViewInner$3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/turbo/subpage/component/dx/DxContainer$createViewInner$3");
    }
