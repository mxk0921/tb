...
public final class DataService$requestPageDataInternal$2 extends Lambda implements w1a<String, String, j7j, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ DataService this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DataService$requestPageDataInternal$2(DataService dataService) {
        super(3);
        this.this$0 = dataService;
    }

    public static /* synthetic */ Object ipc$super(DataService$requestPageDataInternal$2 dataService$requestPageDataInternal$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/turbo/service/data/DataService$requestPageDataInternal$2");
    }
    ...
    public final void invoke2(String str, String str2, j7j j7jVar) {
        ...
        DataService.g1(dataService, null);
    }
}
