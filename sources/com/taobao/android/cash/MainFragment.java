...
public class MainFragment extends WeexPageFragment {
    ...
    public CustomHalfWXActivity f6500a;
    public View c;
    ...
    public static /* synthetic */ Object ipc$super(MainFragment mainFragment, String str, Object... objArr) {
        ...
        if (hashCode == -1589549411) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/cash/MainFragment");
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f6500a = (CustomHalfWXActivity) getActivity();
        this.c = onCreateView;
        return onCreateView;
    }
}
