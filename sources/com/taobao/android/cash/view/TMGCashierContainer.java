...
public class TMGCashierContainer extends LinearLayout {
    ...
    public static /* synthetic */ Object ipc$super(TMGCashierContainer tMGCashierContainer, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/cash/view/TMGCashierContainer");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float a2 = c8s.a(getContext()) * 24.0f;
        Path path = new Path();
