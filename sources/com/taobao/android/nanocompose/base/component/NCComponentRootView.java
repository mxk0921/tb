...
public final class NCComponentRootView extends ViewGroup implements p9z {
    ...
    public NCComponentRootView(Context context) {
        super(context);
        ckf.g(context, "context");
        setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
    }

    public static final /* synthetic */ void access$setMeasuredDimension(NCComponentRootView nCComponentRootView, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("33e67939", new Object[]{nCComponentRootView, new Integer(i), new Integer(i2)});
        } else {
            nCComponentRootView.setMeasuredDimension(i, i2);
        }
    }

    public static /* synthetic */ Object ipc$super(NCComponentRootView nCComponentRootView, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/nanocompose/base/component/NCComponentRootView");
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            onMeasure(this, i, i2, new NCComponentRootView$onMeasure$1(this));
        }
    }
}
