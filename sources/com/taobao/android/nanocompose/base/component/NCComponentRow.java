...
public final class NCComponentRow extends ViewGroup implements p9z {
    ...
    public NCComponentRow(Context context) {
        super(context);
        ckf.g(context, "context");
    }

    public static final /* synthetic */ void access$setMeasuredDimension(NCComponentRow nCComponentRow, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("348dd236", new Object[]{nCComponentRow, new Integer(i), new Integer(i2)});
        } else {
            nCComponentRow.setMeasuredDimension(i, i2);
        }
    }

    public static /* synthetic */ Object ipc$super(NCComponentRow nCComponentRow, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/nanocompose/base/component/NCComponentRow");
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            onMeasure(this, i, i2, new NCComponentRow$onMeasure$1(this));
        }
    }
}
