...
public class DinamicASTNode {
    ...
    public DinamicASTNodeType f7260a;
    ...
    public enum DinamicASTNodeType {
        ...
        public static /* synthetic */ Object ipc$super(DinamicASTNodeType dinamicASTNodeType, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamic/expressionv2/DinamicASTNode$DinamicASTNodeType");
        }

        public static DinamicASTNodeType valueOf(String str) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return (DinamicASTNodeType) ipChange.ipc$dispatch("8b5567f4", new Object[]{str});
            }
    ...
    public void a(DinamicASTNode dinamicASTNode) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("efd7e4d6", new Object[]{this, dinamicASTNode});
