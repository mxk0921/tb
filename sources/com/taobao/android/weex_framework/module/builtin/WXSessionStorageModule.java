...
public final class WXSessionStorageModule extends WeexInnerModule {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    public static final String[] METHODS = {"setItem", "removeItem", "getItem"};
    public static final String NAME = "sessionStorage";
    ...
    private WeexValue getItem(WeexValue[] weexValueArr) {
        ...
        Object context = getWeexInstance().getContext();
        if (!(context instanceof Activity)) {
            context = getWeexInstance();
            dwh.f("SessionStorage", "context is not Activity, fallback to instance as session");
        }
        return WeexValueImpl.ofString(vvw.b(context, a2));
    }

    public static /* synthetic */ Object ipc$super(WXSessionStorageModule wXSessionStorageModule, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/weex_framework/module/builtin/WXSessionStorageModule");
    }
    ...
    private void setItem(WeexValue[] weexValueArr) {
        ...
        String a2 = p4x.a(getWeexInstance(), getArg(weexValueArr, 0).toStringValueOrNull());
        String stringValueOrNull = getArg(weexValueArr, 1).toStringValueOrNull();
        Object context = getWeexInstance().getContext();
        if (!(context instanceof Activity)) {
            context = getWeexInstance();
            dwh.f("SessionStorage", "context is not Activity, fallback to instance as session");
        }
        vvw.d(context, a2, stringValueOrNull);
    }
    ...
    */
    public com.taobao.android.weex.WeexValue callModuleMethod(com.taobao.android.weex.WeexInstanceImpl r7, java.lang.String r8, java.lang.String r9, com.taobao.android.weex.WeexValue[] r10) throws java.lang.Exception {
        /*
            ...
            r1 = 1
            r2 = 0
            com.android.alibaba.ip.runtime.IpChange r3 = com.taobao.android.weex_framework.module.builtin.WXSessionStorageModule.$ipChange
        ...
        L_0x005b:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.weex_framework.module.builtin.WXSessionStorageModule.callModuleMethod(com.taobao.android.weex.WeexInstanceImpl, java.lang.String, java.lang.String, com.taobao.android.weex.WeexValue[]):com.taobao.android.weex.WeexValue");
    }
}
