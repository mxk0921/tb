...
public class CartCustomProgressBar extends View {
    ...
    public static /* synthetic */ Object ipc$super(CartCustomProgressBar cartCustomProgressBar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/icart/widget/refresh/CartCustomProgressBar");
    }
