...
public class CirclePointLoadingView extends LinearLayout {
    ...
    public class CirclePointView extends View {
        ...
        public static /* synthetic */ Object ipc$super(CirclePointView circlePointView, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/pissarro/remote/CirclePointLoadingView$CirclePointView");
        }
    ...
    public static /* synthetic */ CirclePointView access$000(CirclePointLoadingView circlePointLoadingView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (CirclePointView) ipChange.ipc$dispatch("5d6fbf0", new Object[]{circlePointLoadingView});
        }
    ...
    public static /* synthetic */ CirclePointView access$100(CirclePointLoadingView circlePointLoadingView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (CirclePointView) ipChange.ipc$dispatch("9213b14f", new Object[]{circlePointLoadingView});
        }
    ...
    public static /* synthetic */ CirclePointView access$200(CirclePointLoadingView circlePointLoadingView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (CirclePointView) ipChange.ipc$dispatch("1e5066ae", new Object[]{circlePointLoadingView});
        }
    ...
    private void initView() {
        ...
        setOrientation(0);
        int a2 = bc7.a(getContext(), 4.0f);
        this.mLeftCircle = new CirclePointView(getContext());
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(a2, a2);
        layoutParams.rightMargin = bc7.a(getContext(), 6.0f);
    ...
    public static /* synthetic */ Object ipc$super(CirclePointLoadingView circlePointLoadingView, String str, Object... objArr) {
        ...
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/pissarro/remote/CirclePointLoadingView");
    }
