...
public final class InteractService$requestCollectMtop$2 extends Lambda implements w1a<String, String, j7j, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ qff $callback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InteractService$requestCollectMtop$2(qff qffVar) {
        super(3);
        this.$callback = qffVar;
    }

    public static /* synthetic */ Object ipc$super(InteractService$requestCollectMtop$2 interactService$requestCollectMtop$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dressup/common/service/interact/InteractService$requestCollectMtop$2");
    }
