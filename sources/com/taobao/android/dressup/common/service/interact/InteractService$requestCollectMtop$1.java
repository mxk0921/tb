...
public final class InteractService$requestCollectMtop$1 extends Lambda implements u1a<Map<String, ? extends Object>, j7j, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ qff $callback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InteractService$requestCollectMtop$1(qff qffVar) {
        super(2);
        this.$callback = qffVar;
    }

    public static /* synthetic */ Object ipc$super(InteractService$requestCollectMtop$1 interactService$requestCollectMtop$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dressup/common/service/interact/InteractService$requestCollectMtop$1");
    }
