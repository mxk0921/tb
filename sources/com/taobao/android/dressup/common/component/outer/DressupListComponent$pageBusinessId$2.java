...
public final class DressupListComponent$pageBusinessId$2 extends Lambda implements d1a<String> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ qpu $turboEngineContext;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DressupListComponent$pageBusinessId$2(qpu qpuVar) {
        super(0);
        this.$turboEngineContext = qpuVar;
    }

    public static /* synthetic */ Object ipc$super(DressupListComponent$pageBusinessId$2 dressupListComponent$pageBusinessId$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dressup/common/component/outer/DressupListComponent$pageBusinessId$2");
    }
