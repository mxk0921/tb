...
public class GridSpanSizeLookup extends GridLayoutManager.SpanSizeLookup {
    ...
    public final WeakReference<RecyclerViewFixed> f9594a;
    ...
    public GridSpanSizeLookup(RecyclerViewFixed recyclerViewFixed, GridLayoutManager gridLayoutManager, GridLayoutManager.SpanSizeLookup spanSizeLookup) {
        this.f9594a = new WeakReference<>(recyclerViewFixed);
    ...
    public static /* synthetic */ Object ipc$super(GridSpanSizeLookup gridSpanSizeLookup, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/tbsku/image/accessories/GridSpanSizeLookup");
    }
    ...
    public int getSpanSize(int i) {
        ...
        WeakReference<RecyclerViewFixed> weakReference2 = this.f9594a;
        if (!(weakReference2 == null || weakReference2.get() == null || (weakReference = this.b) == null || weakReference.get() == null)) {
            RecyclerViewFixed recyclerViewFixed = this.f9594a.get();
            RecyclerView.Adapter adapter = this.f9594a.get().getAdapter();
            if (adapter != null && (adapter instanceof FixedViewAdapter)) {
                int startViewsCount = recyclerViewFixed.getStartViewsCount() - 1;
                int itemCount = adapter.getItemCount() - recyclerViewFixed.getEndViewsCount();
