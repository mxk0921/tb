...
public class DetailApplication extends Application {
    ...
    public static /* synthetic */ Object ipc$super(DetailApplication detailApplication, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/wrapper/activity/DetailApplication");
    }
