...
public final /* synthetic */ class PriceAnimationLayout$isInit$7 extends MutablePropertyReference0 {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public PriceAnimationLayout$isInit$7(PriceAnimationLayout priceAnimationLayout) {
        super(priceAnimationLayout);
    }

    public static /* synthetic */ Object ipc$super(PriceAnimationLayout$isInit$7 priceAnimationLayout$isInit$7, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/animation/priceAnimation/PriceAnimationLayout$isInit$7");
    }
