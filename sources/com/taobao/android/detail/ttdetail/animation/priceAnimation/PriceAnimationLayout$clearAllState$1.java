...
public final /* synthetic */ class PriceAnimationLayout$clearAllState$1 extends MutablePropertyReference0 {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public PriceAnimationLayout$clearAllState$1(PriceAnimationLayout priceAnimationLayout) {
        super(priceAnimationLayout);
    }

    public static /* synthetic */ Object ipc$super(PriceAnimationLayout$clearAllState$1 priceAnimationLayout$clearAllState$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/animation/priceAnimation/PriceAnimationLayout$clearAllState$1");
    }
