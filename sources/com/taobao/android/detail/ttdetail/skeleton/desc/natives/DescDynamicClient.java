...
public class DescDynamicClient extends MtopRequestClient<DescDynamicParams, gf7> {
    ...
    public class a extends AsyncTask<MtopResponse, Void, gf7> {
        ...
        public final /* synthetic */ MtopResponse f6880a;

        public a(MtopResponse mtopResponse) {
            this.f6880a = mtopResponse;
        }

        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/skeleton/desc/natives/DescDynamicClient$1");
        }
        ...
        public void onPostExecute(gf7 gf7Var) {
            ...
            vc7 vc7Var = (vc7) DescDynamicClient.access$300(DescDynamicClient.this).get();
            if (vc7Var != null) {
                if (gf7Var == null) {
                    vc7Var.c(hashCode(), this.f6880a);
                    return;
                }
                if (DescDynamicClient.access$000(DescDynamicClient.this).b != null && DescDynamicClient.access$000(DescDynamicClient.this).b.containsKey(this.f6880a.getApi())) {
                    DescDynamicClient.access$000(DescDynamicClient.this).b.remove(this.f6880a.getApi());
                }
    ...
    public static /* synthetic */ gf7 access$000(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (gf7) ipChange.ipc$dispatch("fedd83a3", new Object[]{descDynamicClient});
        }
    ...
    public static /* synthetic */ gf7 access$002(DescDynamicClient descDynamicClient, gf7 gf7Var) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (gf7) ipChange.ipc$dispatch("bddbf1e5", new Object[]{descDynamicClient, gf7Var});
        }
    ...
    public static /* synthetic */ hf7 access$100(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (hf7) ipChange.ipc$dispatch("8a4ed60", new Object[]{descDynamicClient});
        }
    ...
    public static /* synthetic */ String access$200(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("3ea3daf", new Object[]{descDynamicClient});
        }
    ...
    public static /* synthetic */ WeakReference access$300(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (WeakReference) ipChange.ipc$dispatch("d21fd2a0", new Object[]{descDynamicClient});
        }
        return descDynamicClient.mRequestListenerRef;
    }

    public static /* synthetic */ Object ipc$super(DescDynamicClient descDynamicClient, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/skeleton/desc/natives/DescDynamicClient");
    }
