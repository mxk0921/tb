...
public class TouchImageView extends DetailImageView {
    ...
    public class a implements View.OnTouchListener {
        ...
        */
        public boolean onTouch(android.view.View r12, android.view.MotionEvent r13) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.a.onTouch(android.view.View, android.view.MotionEvent):boolean");
        }
    }
    ...
    public class b implements Runnable {
        ...
        public void a() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.f7004a = TouchImageView.access$2100(TouchImageView.this);
            }
        }
        ...
        public void run() {
            ...
            } else if (TouchImageView.this.isPressed() && TouchImageView.this.getParent() != null && this.f7004a == TouchImageView.access$1900(TouchImageView.this)) {
    ...
    public class c extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public static /* synthetic */ Object ipc$super(c cVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/widget/desc/picgallery/TouchImageView$ScaleListener");
        }
        ...
        */
        public boolean onScale(android.view.ScaleGestureDetector r13) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.c.onScale(android.view.ScaleGestureDetector):boolean");
        }
    ...
    public static class d extends TimerTask {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<Handler> f7006a;
        ...
        public d(Handler handler) {
            this.f7006a = new WeakReference<>(handler);
        }

        public static /* synthetic */ Object ipc$super(d dVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/widget/desc/picgallery/TouchImageView$Task");
        }
        ...
        public void run() {
            ...
            Handler handler = this.f7006a.get();
            if (handler != null) {
    ...
    public static class e extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final WeakReference<TouchImageView> f7007a;
        ...
        public class a implements Runnable {
            ...
            /* renamed from: a  reason: collision with root package name */
            public final /* synthetic */ TouchImageView f7008a;

            public a(TouchImageView touchImageView) {
                this.f7008a = touchImageView;
            }
        ...
        public e(TouchImageView touchImageView) {
            this.f7007a = new WeakReference<>(touchImageView);
        }

        public static /* synthetic */ void a(e eVar, TouchImageView touchImageView) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("211a896e", new Object[]{eVar, touchImageView});
            } else {
        ...
        public static /* synthetic */ Object ipc$super(e eVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/widget/desc/picgallery/TouchImageView$TimeHandler");
        }

        public final void b(TouchImageView touchImageView) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("301d065c", new Object[]{this, touchImageView});
                return;
            }
        ...
        public void handleMessage(Message message) {
            ...
            } else if (message.what != 10 || (touchImageView = this.f7007a.get()) == null) {
            } else {
    ...
    public static /* synthetic */ Object access$100(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ipChange.ipc$dispatch("5d9c3e0d", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ void access$1000(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dfc46c33", new Object[]{touchImageView});
        } else {
    ...
    public static /* synthetic */ void access$1100(TouchImageView touchImageView, float f, float f2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a7e2fd34", new Object[]{touchImageView, new Float(f), new Float(f2)});
        } else {
    ...
    public static /* synthetic */ Handler access$1200(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Handler) ipChange.ipc$dispatch("c356f871", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ void access$1300(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("81306e36", new Object[]{touchImageView});
        } else {
    ...
    public static /* synthetic */ double access$1400(TouchImageView touchImageView, PointF pointF, PointF pointF2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("5f6d645", new Object[]{touchImageView, pointF, pointF2})).doubleValue();
        }
        return touchImageView.distanceBetween(pointF, pointF2);
    }

    public static /* synthetic */ PointF access$1500(TouchImageView touchImageView, hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (PointF) ipChange.ipc$dispatch("c83a6467", new Object[]{touchImageView, hjxVar});
        }
        return touchImageView.midPointF(hjxVar);
    }

    public static /* synthetic */ void access$1600(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("229c7039", new Object[]{touchImageView});
        } else {
    ...
    public static /* synthetic */ View.OnClickListener access$1800(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (View.OnClickListener) ipChange.ipc$dispatch("f7ff00e4", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ int access$1900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("c408722f", new Object[]{touchImageView})).intValue();
        }
    ...
    public static /* synthetic */ void access$200(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("461491c6", new Object[]{touchImageView});
        } else {
    ...
    public static /* synthetic */ View.OnLongClickListener access$2000(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (View.OnLongClickListener) ipChange.ipc$dispatch("31dbb0d7", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ int access$2100(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("eeef2c46", new Object[]{touchImageView})).intValue();
        }
        return touchImageView.getWindowAttachCount();
    }
    ...
    public static /* synthetic */ boolean access$300(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("268de7cb", new Object[]{touchImageView})).booleanValue();
        }
    ...
    public static /* synthetic */ boolean access$302(TouchImageView touchImageView, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("67168faf", new Object[]{touchImageView, new Boolean(z)})).booleanValue();
        }
    ...
    public static /* synthetic */ PointF access$400(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (PointF) ipChange.ipc$dispatch("ff42b9ff", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ int access$500(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("e78093bc", new Object[]{touchImageView})).intValue();
        }
    ...
    public static /* synthetic */ int access$502(TouchImageView touchImageView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("c479240b", new Object[]{touchImageView, new Integer(i)})).intValue();
        }
    ...
    public static /* synthetic */ void access$600(TouchImageView touchImageView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("3743c279", new Object[]{touchImageView, new Integer(i)});
        } else {
            touchImageView.checkForLongClick(i);
        }
    }

    public static /* synthetic */ float access$700(TouchImageView touchImageView, hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("2d7368ad", new Object[]{touchImageView, hjxVar})).floatValue();
        }
        return touchImageView.spacing(hjxVar);
    }

    public static /* synthetic */ void access$800(TouchImageView touchImageView, PointF pointF, hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("9c60958d", new Object[]{touchImageView, pointF, hjxVar});
        } else {
            touchImageView.midPoint(pointF, hjxVar);
        }
    }
    ...
    public static /* synthetic */ Timer access$900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Timer) ipChange.ipc$dispatch("640f01b9", new Object[]{touchImageView});
        }
    ...
    public static /* synthetic */ Timer access$902(TouchImageView touchImageView, Timer timer) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Timer) ipChange.ipc$dispatch("91947039", new Object[]{touchImageView, timer});
        }
    ...
    */
    private void checkAndSetTranslate(float r6, float r7) {
        /*
            r5 = this;
            com.android.alibaba.ip.runtime.IpChange r0 = com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.$ipChange
        ...
        L_0x009e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.checkAndSetTranslate(float, float):void");
    }
    ...
    public static /* synthetic */ Object ipc$super(TouchImageView touchImageView, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                int hashCode = str.hashCode();
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/widget/desc/picgallery/TouchImageView");
        }
    }

    private void midPoint(PointF pointF, hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("b77e8ef0", new Object[]{this, pointF, hjxVar});
        } else {
            pointF.set((hjxVar.c(0) + hjxVar.c(1)) / 2.0f, (hjxVar.e(0) + hjxVar.e(1)) / 2.0f);
        }
    }

    private PointF midPointF(hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (PointF) ipChange.ipc$dispatch("1eee08da", new Object[]{this, hjxVar});
        }
        return new PointF((hjxVar.c(0) + hjxVar.c(1)) / 2.0f, (hjxVar.e(0) + hjxVar.e(1)) / 2.0f);
    }
    ...
    private float spacing(hjx hjxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("91023bce", new Object[]{this, hjxVar})).floatValue();
        }
        float c2 = hjxVar.c(0) - hjxVar.c(1);
        float e2 = hjxVar.e(0) - hjxVar.e(1);
