...
public class TBCircularProgressDrawable extends Drawable implements Animatable {
    ...
    private Property<TBCircularProgressDrawable, Float> mAngleProperty = new a(this, Float.class, "angle");
    private Property<TBCircularProgressDrawable, Float> mSweepProperty = new b(this, Float.class, "arc");

    /* compiled from: Taobao */
    /* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes4.dex */
    public class a extends Property<TBCircularProgressDrawable, Float> {
        public static volatile transient /* synthetic */ IpChange $ipChange;

        public a(TBCircularProgressDrawable tBCircularProgressDrawable, Class cls, String str) {
            super(cls, str);
        }
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/kit/view/widget/base/uikit/material/TBCircularProgressDrawable$1");
        }
        ...
        public Float get(TBCircularProgressDrawable tBCircularProgressDrawable) {
            ...
            if (ipChange instanceof IpChange) {
                return (Float) ipChange.ipc$dispatch("6e0cb45b", new Object[]{this, tBCircularProgressDrawable});
            }
        ...
        public void set(TBCircularProgressDrawable tBCircularProgressDrawable, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("9c8b2f7b", new Object[]{this, tBCircularProgressDrawable, f});
            } else {
    ...
    /* compiled from: Taobao */
    /* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes4.dex */
    public class b extends Property<TBCircularProgressDrawable, Float> {
        public static volatile transient /* synthetic */ IpChange $ipChange;

        public b(TBCircularProgressDrawable tBCircularProgressDrawable, Class cls, String str) {
            super(cls, str);
        }
        ...
        public static /* synthetic */ Object ipc$super(b bVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/kit/view/widget/base/uikit/material/TBCircularProgressDrawable$2");
        }
    ...
    public static /* synthetic */ Object ipc$super(TBCircularProgressDrawable tBCircularProgressDrawable, String str, Object... objArr) {
        ...
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/kit/view/widget/base/uikit/material/TBCircularProgressDrawable");
    }
