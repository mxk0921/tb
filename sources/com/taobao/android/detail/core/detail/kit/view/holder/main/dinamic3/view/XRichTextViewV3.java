...
public class XRichTextViewV3 extends DXNativeTextView {
    ...
    private int imageTextSpace = i84.e(5);
    ...
    public static /* synthetic */ Object ipc$super(XRichTextViewV3 xRichTextViewV3, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/core/detail/kit/view/holder/main/dinamic3/view/XRichTextViewV3");
        }
    }
