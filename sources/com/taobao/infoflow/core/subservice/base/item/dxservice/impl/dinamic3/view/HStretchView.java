...
public class HStretchView extends ImageView {
    ...
    public class a implements s8d<FailPhenixEvent> {
        ...
        public final /* synthetic */ BitmapDrawable f10634a;
        public final /* synthetic */ float b;
        public final /* synthetic */ float c;

        public a(BitmapDrawable bitmapDrawable, float f, float f2) {
            this.f10634a = bitmapDrawable;
            this.b = f;
            this.c = f2;
        }
        ...
        public boolean onHappen(FailPhenixEvent failPhenixEvent) {
            ...
            if (eue.b()) {
                fve.b(HStretchView.TAG, "图片下载失败");
            }
            if (HStretchView.this.getDrawable() == null && (bitmapDrawable = this.f10634a) != null) {
                HStretchView.access$000(HStretchView.this, bitmapDrawable.getBitmap(), this.b, this.c);
                if (eue.b()) {
                    fve.b(HStretchView.TAG, "设置预置图片");
                }
            }
            return false;
        }
    ...
    public class b implements s8d<SuccPhenixEvent> {
        ...
        public boolean onHappen(SuccPhenixEvent succPhenixEvent) {
            ...
            if (succPhenixEvent.getDrawable() != null) {
                HStretchView.access$000(HStretchView.this, succPhenixEvent.getDrawable().getBitmap(), this.f10635a, this.b);
            }
            return false;
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(HStretchView hStretchView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/view/HStretchView");
    }
    ...
    private Bitmap getStretchBitmap(Bitmap bitmap, float f, float f2) {
        ...
        if (eue.b()) {
            fve.b(TAG, String.format("bitmap width=%d, height=%d desRatio = %f", Integer.valueOf(width), Integer.valueOf(height), Float.valueOf(f2)));
        }
        float f3 = height / width;
        if (f3 <= f2) {
            if (eue.b()) {
                fve.b(TAG, String.format("bitmapRatio = %f, desRatio =%f, bitmapRatio <= desRationo need stretch", Float.valueOf(f3), Float.valueOf(f2)));
            }
            return bitmap;
        } else if (f2 <= 0.0f) {
            if (eue.b()) {
                fve.b("desRatio cannot be less then 0", new String[0]);
            }
            return bitmap;
        } else if (f > 1.0f || f < 0.0f) {
            if (eue.b()) {
                fve.b("stretchPercentX can only be less then 1 and more then 0", new String[0]);
            }
            return bitmap;
        } else {
            ...
            if (eue.b()) {
                fve.b(TAG, String.format("stretchWidth = %d, stretchX = %d", Integer.valueOf(height2), Integer.valueOf(width2)));
            }
