package com.taobao.infoflow.core.subservice.base.item.itemrenderservice.local;
...
public class NestedEmptyView extends FrameLayout {
    ...
    public static /* synthetic */ Object ipc$super(NestedEmptyView nestedEmptyView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/itemrenderservice/local/NestedEmptyView");
    }
