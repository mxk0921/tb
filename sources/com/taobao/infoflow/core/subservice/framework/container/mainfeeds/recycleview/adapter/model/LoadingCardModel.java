...
public class LoadingCardModel extends BaseCardModel {
    ...
    public static /* synthetic */ Object ipc$super(LoadingCardModel loadingCardModel, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/framework/container/mainfeeds/recycleview/adapter/model/LoadingCardModel");
    }
