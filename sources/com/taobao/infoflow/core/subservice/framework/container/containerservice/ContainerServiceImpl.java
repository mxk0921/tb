...
public class ContainerServiceImpl implements IContainerService<ViewGroup> {
    ...
    private final Class<? extends ISubService>[] layerServices = {IThemeService.class, IMainFeedsViewService.class, IStickyContainerService.class, IPopViewService.class, IIconBackGuideAnimeService.class};
    ...
    public ViewGroup createContainer(Context context) {
        ...
        this.mContainerLifecycleRegister.d();
