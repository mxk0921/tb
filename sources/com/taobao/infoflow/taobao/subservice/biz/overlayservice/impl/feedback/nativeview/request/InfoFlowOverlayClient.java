...
public class InfoFlowOverlayClient extends AbsMtopRequestClient<InfoFlowOverlayParams, InfoFlowOverlayResult> {
    ...
    public static /* synthetic */ Object ipc$super(InfoFlowOverlayClient infoFlowOverlayClient, String str, Object... objArr) {
        if (str.hashCode() == 1384478442) {
            super.setupMtopRequest((MtopRequest) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/taobao/subservice/biz/overlayservice/impl/feedback/nativeview/request/InfoFlowOverlayClient");
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        InfoFlowOverlayResultOutDo infoFlowOverlayResultOutDo;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        if (baseOutDo != null) {
            infoFlowOverlayResultOutDo = (InfoFlowOverlayResultOutDo) baseOutDo;
        } else {
            infoFlowOverlayResultOutDo = null;
        }
        g6j g6jVar = (g6j) this.mRequestListenerRef.get();
        if (g6jVar != null) {
            try {
                if (infoFlowOverlayResultOutDo != null) {
                    g6jVar.onSuccess(infoFlowOverlayResultOutDo.getData());
                } else {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(InfoFlowOverlayResultOutDo.class);
        }
    }
