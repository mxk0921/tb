...
public class DXTagExposedEvent extends DXEvent {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    private JSONObject tag;

    public DXTagExposedEvent(long j, JSONObject jSONObject) {
        super(j);
        this.tag = jSONObject;
    ...
    public static /* synthetic */ Object ipc$super(DXTagExposedEvent dXTagExposedEvent, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/detail/rate/vivid/dinamicX/eve/DXTagExposedEvent");
    }
