...
public class PopFatigueReportClient extends AbsMtopRequestClient<PopFatigueReportMtopParams, PopFatigueReportResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "PopFatigueReportClient";

    public static /* synthetic */ Object ipc$super(PopFatigueReportClient popFatigueReportClient, String str, Object... objArr) {
        if (str.hashCode() == 1384478442) {
            super.setupMtopRequest((MtopRequest) objArr[0]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/homepage/pop/mtop/PopFatigueReportClient");
    }
    ...
    public String getApiName() {
        ...
        return "mtop.taobao.wireless.home.pop.fatigue.record";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        PopFatigueReportResultOutDo popFatigueReportResultOutDo;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
        ...
        if (baseOutDo != null) {
            popFatigueReportResultOutDo = (PopFatigueReportResultOutDo) baseOutDo;
        } else {
            popFatigueReportResultOutDo = null;
        }
        g6j g6jVar = (g6j) this.mRequestListenerRef.get();
        if (g6jVar != null) {
            try {
                if (popFatigueReportResultOutDo != null) {
                    g6jVar.onSuccess(popFatigueReportResultOutDo.getData());
                } else {
                    g6jVar.onSuccess(null);
                }
            } catch (Exception e) {
                vfm.f(TAG, "Call onSuccess exception" + e);
            }
        }
    }
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(PopFatigueReportResultOutDo.class);
        }
    }
