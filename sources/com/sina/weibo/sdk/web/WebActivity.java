...
public class WebActivity extends Activity implements a {
    ...
    public static boolean j(String str) {
        ...
        if (str.startsWith("https://service.weibo.com/share/mobilesdk.php") || str.startsWith("https://open.weibo.cn/oauth2/authorize?")) {
            return true;
        }
        return false;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        view.setBackgroundResource(getResources().getIdentifier("weibosdk_common_shadow_top", zk4.CONTACTS_INFO_NOT_EMPTY_STATUS, getPackageName()));
        ...
        imageView.setImageResource(getResources().getIdentifier("weibosdk_empty_failed", zk4.CONTACTS_INFO_NOT_EMPTY_STATUS, getPackageName()));
        ...
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(e.a(SecExceptionCode.SEC_ERROR_INIT_PLUGIN_MERGED_MIDDLE_TIER_ERROR, this), e.a(46, this));
        layoutParams7.gravity = 17;
        this.am.addView(button, layoutParams7);
        button.setBackgroundResource(getResources().getIdentifier("retry_btn_selector", zk4.CONTACTS_INFO_NOT_EMPTY_STATUS, getPackageName()));
        button.setText("重新加载");
        ...
        this.ap.setWebChromeClient(new WebChromeClient() { // from class: com.sina.weibo.sdk.web.WebActivity.4
            ...
            public final void onProgressChanged(WebView webView, int i) {
                ...
                WebActivity.this.aq.setProgress(i);
                if (i == 100) {
