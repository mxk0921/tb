...
public class o1<T> extends jik<T> {
    ...
    public o1(Class<T> cls, String str, String str2, long j, List<FieldWriter> list) {
    ...
    public final FieldWriter E(long j) {
        ...
        FieldWriter fieldWriter12 = this.H;
        if (j == fieldWriter12.m) {
