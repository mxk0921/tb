...
public final /* synthetic */ class TmallCardShop$initTemplateComponent$3 extends FunctionReferenceImpl implements u1a<BaseTemplateComponent, ViewGroup.LayoutParams, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public TmallCardShop$initTemplateComponent$3(TmallCardShop tmallCardShop) {
    ...
    public static /* synthetic */ Object ipc$super(TmallCardShop$initTemplateComponent$3 tmallCardShop$initTemplateComponent$3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/shop2023/TmallCardShop$initTemplateComponent$3");
    }
