...
public final class OverseaShopHeaderInfoTemplate extends Shop2023BaseTemplateComponent {
    ...
    public static final class HeaderStyle extends Enum<HeaderStyle> {
        ...
        private static final /* synthetic */ HeaderStyle[] $values() {
            ...
            return ipChange instanceof IpChange ? (HeaderStyle[]) ipChange.ipc$dispatch("2f2d5e", new Object[0]) : new HeaderStyle[]{DEFAULT, INDEX_PAGE_FOLDED, OTHER_PAGE};
        }
        ...
        public static /* synthetic */ Object ipc$super(HeaderStyle headerStyle, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/shop2023/template/OverseaShopHeaderInfoTemplate$HeaderStyle");
        }
        ...
        public static HeaderStyle valueOf(String str) {
            ...
            if (ipChange instanceof IpChange) {
                valueOf = ipChange.ipc$dispatch("8e3a0b49", new Object[]{str});
            } else {
        ...
        public static HeaderStyle[] values() {
            ...
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                clone = ipChange.ipc$dispatch("85c7883a", new Object[0]);
            } else {
                clone = $VALUES.clone();
            }
    ...
    public static final class b extends l77 {
        ...
        public static /* synthetic */ Object ipc$super(b bVar, String str, Object... objArr) {
            ...
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/shop2023/template/OverseaShopHeaderInfoTemplate$createViewCallback$1");
        }
        ...
        public void b(Object obj) {
            ...
            } else if (OverseaShopHeaderInfoTemplate.this.I().invoke().booleanValue()) {
                super.b(obj);
            }
        }
    }
    ...
    public OverseaShopHeaderInfoTemplate(ShopComponentModel shopComponentModel, d1a<Boolean> d1aVar) {
    ...
    public static /* synthetic */ Object ipc$super(OverseaShopHeaderInfoTemplate overseaShopHeaderInfoTemplate, String str, Object... objArr) {
        ...
        if (hashCode == -1548635899) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/triver/triver_shop/shop2023/template/OverseaShopHeaderInfoTemplate");
        }
    }

    public final d1a<Boolean> I() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
