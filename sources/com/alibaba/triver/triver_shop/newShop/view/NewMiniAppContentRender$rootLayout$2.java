...
public final class NewMiniAppContentRender$rootLayout$2 extends Lambda implements d1a<FrameLayout> {
    ...
    public static /* synthetic */ Object ipc$super(NewMiniAppContentRender$rootLayout$2 newMiniAppContentRender$rootLayout$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/NewMiniAppContentRender$rootLayout$2");
    }
    ...
    public final FrameLayout invoke() {
        ...
        FrameLayout frameLayout = new FrameLayout(NewMiniAppContentRender.y(this.this$0));
