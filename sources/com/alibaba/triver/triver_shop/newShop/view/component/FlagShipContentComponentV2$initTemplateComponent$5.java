...
public final /* synthetic */ class FlagShipContentComponentV2$initTemplateComponent$5 extends FunctionReferenceImpl implements u1a<BaseTemplateComponent, ViewGroup.LayoutParams, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public FlagShipContentComponentV2$initTemplateComponent$5(FlagShipContentComponentV2 flagShipContentComponentV2) {
    ...
    public static /* synthetic */ Object ipc$super(FlagShipContentComponentV2$initTemplateComponent$5 flagShipContentComponentV2$initTemplateComponent$5, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/component/FlagShipContentComponentV2$initTemplateComponent$5");
    }
