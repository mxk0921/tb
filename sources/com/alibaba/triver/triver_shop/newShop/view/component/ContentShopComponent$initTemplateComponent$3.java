...
public /* synthetic */ class ContentShopComponent$initTemplateComponent$3 extends FunctionReferenceImpl implements u1a<BaseTemplateComponent, ViewGroup.LayoutParams, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public ContentShopComponent$initTemplateComponent$3(ContentShopComponent contentShopComponent) {
    ...
    public static /* synthetic */ Object ipc$super(ContentShopComponent$initTemplateComponent$3 contentShopComponent$initTemplateComponent$3, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/component/ContentShopComponent$initTemplateComponent$3");
    }
