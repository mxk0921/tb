...
public final /* synthetic */ class DefaultShopV2$initTemplateComponent$2 extends FunctionReferenceImpl implements u1a<BaseTemplateComponent, ViewGroup.LayoutParams, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public DefaultShopV2$initTemplateComponent$2(DefaultShopV2 defaultShopV2) {
    ...
    public static /* synthetic */ Object ipc$super(DefaultShopV2$initTemplateComponent$2 defaultShopV2$initTemplateComponent$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/component/DefaultShopV2$initTemplateComponent$2");
    }
