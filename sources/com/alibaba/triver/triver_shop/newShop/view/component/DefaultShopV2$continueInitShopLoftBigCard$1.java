...
public final class DefaultShopV2$continueInitShopLoftBigCard$1 extends Lambda implements u1a<BaseTemplateComponent, ViewGroup.LayoutParams, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ DefaultShopV2 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DefaultShopV2$continueInitShopLoftBigCard$1(DefaultShopV2 defaultShopV2) {
        super(2);
    ...
    public static /* synthetic */ Object ipc$super(DefaultShopV2$continueInitShopLoftBigCard$1 defaultShopV2$continueInitShopLoftBigCard$1, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/component/DefaultShopV2$continueInitShopLoftBigCard$1");
    }
    ...
    public final void invoke2(BaseTemplateComponent baseTemplateComponent, ViewGroup.LayoutParams layoutParams) {
        ...
        if (c1 != null) {
            c1.H(i + DefaultShopV2.e1(this.this$0));
        }
        EmbedShopLoftComponent c12 = DefaultShopV2.c1(this.this$0);
        if (c12 != null) {
            c12.z();
        }
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(-1, -2);
        layoutParams2.gravity = 80;
        layoutParams2.bottomMargin = DefaultShopV2.e1(this.this$0);
