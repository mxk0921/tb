...
public final class Tab3ContentRender$requestWidgetRenderInfo$2 extends Lambda implements u1a<Integer, String, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ u1a<Integer, String, xhv> $failure;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public Tab3ContentRender$requestWidgetRenderInfo$2(u1a<? super Integer, ? super String, xhv> u1aVar) {
        super(2);
        this.$failure = u1aVar;
    }
    ...
    public static /* synthetic */ Object ipc$super(Tab3ContentRender$requestWidgetRenderInfo$2 tab3ContentRender$requestWidgetRenderInfo$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/Tab3ContentRender$requestWidgetRenderInfo$2");
    }
