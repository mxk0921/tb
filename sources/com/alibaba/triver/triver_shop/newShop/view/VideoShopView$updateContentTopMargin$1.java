...
public final class VideoShopView$updateContentTopMargin$1 extends Lambda implements d1a<xhv> {
    ...
    public static /* synthetic */ Object ipc$super(VideoShopView$updateContentTopMargin$1 videoShopView$updateContentTopMargin$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/VideoShopView$updateContentTopMargin$1");
    }
