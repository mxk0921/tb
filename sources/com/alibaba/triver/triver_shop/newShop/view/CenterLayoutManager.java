...
public final class CenterLayoutManager extends LinearLayoutManager {
    ...
    public static /* synthetic */ Object ipc$super(CenterLayoutManager centerLayoutManager, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/CenterLayoutManager");
    }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
        ...
        final Context context = this.f3115a;
        CenterSmoothScroller centerLayoutManager$smoothScrollToPosition$smoothScroller$1 = new CenterSmoothScroller(context) { // from class: com.alibaba.triver.triver_shop.newShop.view.CenterLayoutManager$smoothScrollToPosition$smoothScroller$1
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public static /* synthetic */ Object ipc$super(CenterLayoutManager$smoothScrollToPosition$smoothScroller$1 centerLayoutManager$smoothScrollToPosition$smoothScroller$12, String str, Object... objArr) {
                ...
                int hashCode = str.hashCode();
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/CenterLayoutManager$smoothScrollToPosition$smoothScroller$1");
            }
