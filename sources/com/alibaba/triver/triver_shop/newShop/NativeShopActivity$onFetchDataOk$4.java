...
public final class NativeShopActivity$onFetchDataOk$4 extends Lambda implements g1a<View, xhv> {
    ...
    public static final class AnonymousClass1 extends Lambda implements d1a<xhv> {
        ...
        public static /* synthetic */ Object ipc$super(AnonymousClass1 r2, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/NativeShopActivity$onFetchDataOk$4$1");
        }
        ...
        public final void invoke2() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                NativeShopActivity.u4(this.this$0, true);
            }
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(NativeShopActivity$onFetchDataOk$4 nativeShopActivity$onFetchDataOk$4, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/NativeShopActivity$onFetchDataOk$4");
    }
    ...
    public final void invoke2(View view) {
        ...
        NativeShopActivity.j4(this.this$0, view);
        NativeShopActivity.H3(this.this$0).addView(view);
