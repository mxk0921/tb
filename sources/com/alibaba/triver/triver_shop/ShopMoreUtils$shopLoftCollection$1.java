...
public final class ShopMoreUtils$shopLoftCollection$1 extends Lambda implements g1a<JSONObject, xhv> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ g1a<String, xhv> $collectionCountCallback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ShopMoreUtils$shopLoftCollection$1(g1a<? super String, xhv> g1aVar) {
        super(1);
        this.$collectionCountCallback = g1aVar;
    }

    public static /* synthetic */ Object ipc$super(ShopMoreUtils$shopLoftCollection$1 shopMoreUtils$shopLoftCollection$1, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/ShopMoreUtils$shopLoftCollection$1");
    }
