...
public class AURADismissFloatEvent_InputField_floatView implements IAURAInputField<fyc> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    private fyc floatView;
    private String fieldName = "floatView";
    private Class<zh> targetClass = zh.class;
    ...
    public AURADismissFloatEvent_InputField_floatView(fyc fycVar) {
    ...
    @Override // com.alibaba.android.aura.IAURAInputField
    public Class<zh> getTargetClass() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
