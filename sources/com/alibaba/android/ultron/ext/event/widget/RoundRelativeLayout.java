...
public class RoundRelativeLayout extends RelativeLayout {
    ...
    public class a extends ViewOutlineProvider {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout$1");
        }
        ...
        public void getOutline(View view, Outline outline) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), this.f2279a);
            }
        }
    }
    ...
    public class b extends ViewOutlineProvider {
        ...
        public static /* synthetic */ Object ipc$super(b bVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout$2");
        }
        ...
        public void getOutline(View view, Outline outline) {
            ...
            outline.setRoundRect(0, -this.f2280a, view.getWidth(), view.getHeight(), this.f2280a);
            outline.offset(0, this.f2280a);
        }
    }
    ...
    public class c extends ViewOutlineProvider {
        ...
        public static /* synthetic */ Object ipc$super(c cVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout$3");
        }
    ...
    public class d extends ViewOutlineProvider {
        ...
        public static /* synthetic */ Object ipc$super(d dVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout$4");
        }
        ...
        public void getOutline(View view, Outline outline) {
            ...
            outline.setRoundRect(-this.f2282a, 0, view.getWidth(), view.getHeight(), this.f2282a);
            outline.offset(this.f2282a, 0);
        }
    }
    ...
    public class e extends ViewOutlineProvider {
        ...
        public static /* synthetic */ Object ipc$super(e eVar, String str, Object... objArr) {
            str.hashCode();
            int hashCode = str.hashCode();
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout$5");
        }
        ...
        public void getOutline(View view, Outline outline) {
            ...
            outline.setRoundRect(0, 0, view.getWidth() + this.f2283a, view.getHeight(), this.f2283a);
            outline.offset(-this.f2283a, 0);
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(RoundRelativeLayout roundRelativeLayout, String str, Object... objArr) {
        ...
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/ext/event/widget/RoundRelativeLayout");
    }
