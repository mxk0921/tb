...
public final class HybridPreRenderHelper$Companion$enableNativeJSX$2 extends Lambda implements d1a<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final HybridPreRenderHelper$Companion$enableNativeJSX$2 INSTANCE = new HybridPreRenderHelper$Companion$enableNativeJSX$2();

    public HybridPreRenderHelper$Companion$enableNativeJSX$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(HybridPreRenderHelper$Companion$enableNativeJSX$2 hybridPreRenderHelper$Companion$enableNativeJSX$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/vfw/weex2/highPerformance/utils/HybridPreRenderHelper$Companion$enableNativeJSX$2");
    }
