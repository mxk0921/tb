...
public final class UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2 extends Lambda implements d1a<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2 INSTANCE = new UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2();

    public UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2() {
        super(0);
    }
    ...
    public static /* synthetic */ Object ipc$super(UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2 ultronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/vfw/weex2/highPerformance/utils/UltronTradeHybridSwitcherHelper$enableFragmentPrerenderInsToPool$2");
    }
