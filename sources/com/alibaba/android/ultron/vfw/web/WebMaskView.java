...
public class WebMaskView extends RelativeLayout {
    ...
    public static /* synthetic */ VesselView access$000(WebMaskView webMaskView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (VesselView) ipChange.ipc$dispatch("211d2666", new Object[]{webMaskView});
        }
    ...
    public static /* synthetic */ String access$100(WebMaskView webMaskView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("59bfac81", new Object[]{webMaskView});
        }
    ...
    public static /* synthetic */ Object ipc$super(WebMaskView webMaskView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/vfw/web/WebMaskView");
    }
