...
public final class ApkLoaderV28 implements ApkLoader {
    ...
    public final boolean loadDex(ClassLoader classLoader, File file, ocq ocqVar, boolean z, boolean z2) {
        ...
        return ApkLoaderV21.injectDexElements(classLoader, file, ocqVar, z, new V24DexElementsMaker(), "path", new SkipDexOpter(), z2);
    }
