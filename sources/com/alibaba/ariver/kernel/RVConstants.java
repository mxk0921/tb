...
public class RVConstants {
    ...
    public static final String ACTION_PRESET_APPX_PARSED = "ACTION_TINY_PRESET_WEB_RESOURCE_PARSED";
    public static final String APPXNG_SOLO_PACKAGE_TYPE = "appxNgSoloPackageType";
    public static final String APP_TAG = "AriverApp";
    public static final String ARIVER_BUNDLE_NAME = "com-alibaba-ariver-ariver";
    public static final String BYBRID_PAGE_ENGINETYPE = "hybridPageEngineType";
    ...
    public static final String EXTRA_APP_INFO_SCENE = "ariverAppInfoScene";
    ...
    public static final String EXTRA_PREPARE_EXCEPTION_STAGE = "prepareExceptionStage";
    ...
    public static final String PLUGIN_SCENE = "pluginScene";
    ...
    public static final String USE_PRESET_POPMENU = "usePresetPopmenu";
