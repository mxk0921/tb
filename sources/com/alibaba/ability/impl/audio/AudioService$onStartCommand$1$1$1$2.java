...
public final class AudioService$onStartCommand$1$1$1$2 extends Lambda implements u1a<lfi, kei, xhv> {
    ...
    public static /* synthetic */ Object ipc$super(AudioService$onStartCommand$1$1$1$2 audioService$onStartCommand$1$1$1$2, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/ability/impl/audio/AudioService$onStartCommand$1$1$1$2");
    }
