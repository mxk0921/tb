...
public class FBBorderInput extends EditText implements IBorderable {
    ...
    public BorderHelper f4899a;

    public FBBorderInput(Context context) {
        super(context);
        this.f4899a = null;
        this.f4899a = new BorderHelper();
    }
    ...
    public static /* synthetic */ Object ipc$super(FBBorderInput fBBorderInput, String str, Object... objArr) {
        ...
        if (hashCode == -1665133574) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/flybird/FBBorderInput");
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        super.draw(canvas);
        BorderHelper borderHelper = this.f4899a;
