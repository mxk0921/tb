...
public class WebErrorView extends RelativeLayout {
    ...
    public static /* synthetic */ Object ipc$super(WebErrorView webErrorView, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in android/taobao/windvane/view/WebErrorView");
    }
