...
public final class f implements qp9<Object> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ qp9 f15360a;
    final /* synthetic */ w1a b;

    public f(qp9 qp9Var, w1a w1aVar) {
        this.f15360a = qp9Var;
        this.b = w1aVar;
    }
    ...
    public Object a(sp9<? super Object> sp9Var, ar4<? super xhv> ar4Var) {
        ...
        ref$ObjectRef.element = iak.NULL;
        Object a2 = this.f15360a.a(new FlowKt__TransformKt$runningReduce$1$1(ref$ObjectRef, this.b, sp9Var), ar4Var);
        if (a2 == dkf.d()) {
            return a2;
        }
        return xhv.INSTANCE;
