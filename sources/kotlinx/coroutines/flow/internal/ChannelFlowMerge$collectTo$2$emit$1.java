...
public final class ChannelFlowMerge$collectTo$2$emit$1 extends ContinuationImpl {
    ...
    public ChannelFlowMerge$collectTo$2$emit$1(ChannelFlowMerge$collectTo$2<? super T> channelFlowMerge$collectTo$2, ar4<? super ChannelFlowMerge$collectTo$2$emit$1> ar4Var) {
        super(ar4Var);
