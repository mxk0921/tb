...
public abstract class Random {
    ...
    private static final Random defaultRandom = d5m.IMPLEMENTATIONS.b();
    ...
    public static final class Default extends Random implements Serializable {
        ...
        public /* synthetic */ Default(a07 a07Var) {
            this();
        }
    ...
    public double nextDouble() {
        return f5m.a(nextBits(26), nextBits(27));
    }
    ...
    public double nextDouble(double d) {
        return nextDouble(vu3.b.GEO_NOT_SUPPORT, d);
    }
    ...
    public long nextLong(long j, long j2) {
        ...
        if (j5 > 0) {
            if (((-j5) & j5) == j5) {
                ...
                int i2 = (int) (j5 >>> 32);
                if (i != 0) {
                    nextInt = nextBits(uen.f(i));
                } else if (i2 == 1) {
                    nextInt = nextInt();
                } else {
                    j3 = (nextBits(uen.f(i2)) << 32) + (nextInt() & tiv.INT_MASK);
                }
                j3 = nextInt & tiv.INT_MASK;
            } else {
                do {
                    nextLong = nextLong() >>> 1;
                    j4 = nextLong % j5;
