...
public class x2o {
    ...
    public static String b() {
        ...
        return v2s.o().p().b("tblive", "tbLiveRoomReportUrl", "https://market.m.taobao.com/app/msd/buyer-aqcenter/report.html?bizSource=taobao&from=livePage#/poplayer");
    }
    ...
    public static void d() {
        ...
        } else if (rgd.b().a() != null) {
            rgd.b().a().updateNextPageProperties();
        }
    }

    public static void c(Context context, TBLiveDataModel tBLiveDataModel, long j, boolean z) {
        String str;
        String str2;
        boolean z2 = false;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("354e68f9", new Object[]{context, tBLiveDataModel, new Long(j), new Boolean(z)});
            return;
        }
            ...
            if (!z && !z2 && videoInfo != null && (str2 = videoInfo.reportUrlPopLayer) != null) {
                if (a()) {
                    ...
                    if (!TextUtils.isEmpty(b)) {
                        ...
                        String a2 = qnv.a(b, hashMap);
                        q0h.b("ReportUtils", "appQueryOriginUrl = " + a2);
