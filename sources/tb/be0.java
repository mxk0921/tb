...
public class be0 extends i24 {
    ...
    public static /* synthetic */ Object ipc$super(be0 be0Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/order/core/subscriber/AddBagAgainSubscriberV2");
    }
    ...
    public JSONObject K(JSONObject jSONObject) {
        ...
        if (jSONObject.get("successUrl") instanceof String) {
            ...
            jSONObject3.put("queryParams", "@dxData{fields.queryParams}");
            J(jSONObject2, "success", "weexPopV2", jSONObject3);
        }
