...
public class gu5 extends k {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    public static final long DETAIL_WIDGET_ID;
    public static final long DXDETAILTAGLAYOUT_HIDETAG = 4915577423856457533L;
    public static final long DX_EVENT_ID;

    /* renamed from: a  reason: collision with root package name */
    public String f20239a = "false";
    ...
    static {
        t2o.a(912262693);
        long a2 = k06.a("DetailTagLayout");
        DX_EVENT_ID = a2;
        DETAIL_WIDGET_ID = a2;
    }

    public static /* synthetic */ Object ipc$super(gu5 gu5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1814733277:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/ttdetail/transfer/widget/DXDetailTagLayoutWidgetNode");
        }
    }
    ...
    public String getDefaultValueForStringAttr(long j) {
        ...
        if (j == DXDETAILTAGLAYOUT_HIDETAG) {
            return "false";
        }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode != null && (dXWidgetNode instanceof gu5)) {
            super.onClone(dXWidgetNode, z);
            this.f20239a = ((gu5) dXWidgetNode).f20239a;
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (children != null && children.size() >= 2) {
            DXWidgetNode childAt = children.get(0).getChildAt(0);
            DXWidgetNode dXWidgetNode = children.get(1);
            if (vbl.L() && Boolean.parseBoolean(this.f20239a)) {
                dXWidgetNode.setVisibility(2);
                super.onMeasure(i, i2);
            } else if (childAt instanceof eb6) {
                if (((eb6) childAt).C() == 2) {
    ...
    public void onSetStringAttribute(long j, String str) {
        ...
        } else if (j == DXDETAILTAGLAYOUT_HIDETAG) {
            this.f20239a = str;
        } else {
