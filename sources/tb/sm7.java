...
public class sm7 extends av {
    ...
    public static /* synthetic */ Object ipc$super(sm7 sm7Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamic/expression/parser/DinamicExpressionParser");
    }
