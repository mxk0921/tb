...
public class n16 extends uu {
    ...
    public static /* synthetic */ Object ipc$super(n16 n16Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx_v4/expr/fuction/DXIsNotEmptyFunction");
    }
    ...
    public uw5 execute(DXRuntimeContext dXRuntimeContext, uw5 uw5Var, int i, uw5[] uw5VarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            ...
            throw new DXExprFunctionError("isNotEmpty type has not empty func type:" + x);
        } catch (Exception e) {
