...
final class u89<T> extends fa9<T> {
    public u89(String str, Type type, Class cls, int i, long j, String str2, Locale locale, Float f, Method method) {
    ...
    public void L(JSONReader jSONReader, T t) {
        try {
            this.g.invoke(t, Float.valueOf(jSONReader.l2()));
        } catch (Exception e) {
