...
public class cma extends env {
    ...
    public static /* synthetic */ Object ipc$super(cma cmaVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/allspark/GuangGuangNavProcessorNodeUriFilterItem0");
    }
