...
public class feq implements Interpolator, Cloneable {
    ...
    public feq(float f, float f2, boolean z) {
        this.f19241a = f;
        this.b = f2;
        this.c = z;
        b();
    ...
    public feq clone() {
        ...
        if (ipChange instanceof IpChange) {
            return (feq) ipChange.ipc$dispatch("d1e77c3d", new Object[]{this});
        }
        try {
    ...
    public final void b() {
        ...
        for (int i = 0; i < 10000; i++) {
            PointF d = d(this.f19241a, this.b, i / 9999.0f);
            float f = d.x;
            if (f > 0.0f && f < 1.0f) {
                int i2 = (int) (f * 999.0f);
                float[] fArr3 = this.d;
