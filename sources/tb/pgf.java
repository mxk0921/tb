...
public class pgf implements aeb {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public final ux9 f26078a;
    ...
    public pgf(ux9 ux9Var, BaseFrame baseFrame) {
        this.c = null;
        this.f26078a = ux9Var;
        this.b = baseFrame;
        if (ux9Var != null) {
    ...
    public ViewGroup A(Context context) {
        ...
        ux9 ux9Var = this.f26078a;
        if (!(ux9Var == null || ((air) ux9Var).A() == null || (A = ((air) this.f26078a).A()) == null || (czdVar = A.uiCompontent) == null || ((rbt) czdVar).b() == null)) {
            View m = ((rbt) A.uiCompontent).b().m();
            if (m instanceof ViewGroup) {
                return (ViewGroup) m;
            }
        }
        return iba.c(context, vx9.f(this.f26078a));
    }
    ...
    public IntimacyParams r() {
        ...
        VideoInfo c0 = up6.c0(this.f26078a);
        FandomInfo B = up6.B(this.f26078a);
        if (c0 != null) {
        ...
        intimacyParams.liveSource = iba.B(vx9.f(this.f26078a));
        ux9 ux9Var = this.f26078a;
    ...
    public String p() {
        ...
        if (this.f26078a.x() != null) {
            return this.f26078a.x().b();
        }
        return null;
    }
    ...
    public void v(b3d b3dVar) {
        ...
        } else if (this.f26078a.x() != null) {
            this.f26078a.x().h(this.f26078a, b3dVar);
        }
    }
    ...
    public void x(b3d b3dVar) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.f26078a.x().E(this.f26078a, b3dVar);
        }
    }
