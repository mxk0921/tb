...
public class ags extends ofs {
    ...
    public static /* synthetic */ Object ipc$super(ags agsVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/flexbox/layoutmanager/animation/TNodeAnimator/TNodeRotateAnimator");
    }

    public static ags o(n nVar, float f, float f2, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ags) ipChange.ipc$dispatch("93bf79bc", new Object[]{nVar, new Float(f), new Float(f2), new Boolean(z)});
        }
        ags agsVar = new ags();
        agsVar.f(z);
        agsVar.j(nVar, f, f2);
    ...
    public void l(n nVar, View view, float f) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            nVar.j1("rotate", Float.valueOf(f), false);
        }
    }
}
