...
public class hnx extends gi6 {
    ...
    public static final long d = 7995080176899284476L;
    ...
    public class a implements kjx.b {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ XSimpleRichTextViewV3 f20774a;
        public final /* synthetic */ String b;

        public a(hnx hnxVar, XSimpleRichTextViewV3 xSimpleRichTextViewV3, String str) {
            this.f20774a = xSimpleRichTextViewV3;
            this.b = str;
        }
        ...
        public void a(Drawable drawable) {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.f20774a.addIcon(drawable, this.b);
            }
        }
    }
    ...
    public static /* synthetic */ Object ipc$super(hnx hnxVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -879570230:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/core/detail/kit/view/holder/main/dinamic3/widget/XSimpleRichTextWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof hnx) {
            hnx hnxVar = (hnx) dXWidgetNode;
            this.b = hnxVar.b;
            this.c = hnxVar.c;
            JSONArray jSONArray = hnxVar.f20773a;
            if (!z || jSONArray == null) {
                this.f20773a = jSONArray;
            } else {
                this.f20773a = (JSONArray) jSONArray.clone();
            }
        }
    }
    ...
    public void onSetStringAttribute(long j, String str) {
        ...
        if (2897545864002613241L == j) {
            try {
                this.b = i84.e(Integer.parseInt(str));
            } catch (Exception e) {
                e.printStackTrace();
                return;
            }
        ...
        if (-6439738081440321374L == j) {
            this.c = i84.e(Integer.parseInt(str));
        }
    }
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (arrayList.size() > 0) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    kjx.b(str2, xSimpleRichTextViewV3.getContext(), new a(this, xSimpleRichTextViewV3, str2));
                }
            }
        }
    }
