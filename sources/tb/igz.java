...
import com.taobao.android.nanocompose.foundation.components.image_span.NCComponentImageSpan;
import com.taobao.android.nanocompose.viewhandler.NCComponentViewHandler;

/* compiled from: Taobao */
/* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes6.dex */
public final class igz extends NCComponentViewHandler {
    ...
    public static /* synthetic */ Object ipc$super(igz igzVar, String str, Object... objArr) {
        if (str.hashCode() == -76004444) {
            super.onUpdateViewWithContext((biz) objArr[0], (jkz) objArr[1], (jkz) objArr[2]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/nanocompose/foundation/components/image_span/NCComponentImageSpanViewHandler");
    }
    ...
    public View onCreateView(Context context) {
        ...
        return new NCComponentImageSpan(context);
    }
