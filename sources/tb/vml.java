...
public final class vml extends LCNavInterceptor {
    ...
    public static /* synthetic */ Object ipc$super(vml vmlVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/litecreator/sdk/nav/interceptor/PageFilmAlbumInterceptor");
    }
