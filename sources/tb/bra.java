...
public class bra implements Application.ActivityLifecycleCallbacks {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public final WeakReference<Context> f16567a;
    ...
    public bra(Context context, TaoLiveVideoView taoLiveVideoView) {
        this.f16567a = new WeakReference<>(context);
    ...
    public final boolean a(Context context, Activity activity, TaoLiveVideoView taoLiveVideoView) {
        ...
        if (taoLiveVideoView != null && context == activity) {
            return true;
        }
        return false;
    }
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        Context context = this.f16567a.get();
