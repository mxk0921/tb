...
public class dl4 extends Dialog {
    ...
    public static /* synthetic */ Object ipc$super(dl4 dl4Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/common/page/Container");
    }
    ...
    public dl4(Context context, int i) {
        super(context, i);
    }
