...
public class bng extends own {
    ...
    public static /* synthetic */ Object ipc$super(bng bngVar, String str, Object... objArr) {
        if (str.hashCode() == -1862718671) {
            return new Boolean(super.a(objArr[0], objArr[1]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/ut/abtest/bucketing/expression/LessThanOrEqualsOperator");
    }
    ...
    public boolean f(BigDecimal bigDecimal, BigDecimal bigDecimal2) {
        ...
        if (j(bigDecimal.compareTo(bigDecimal2)) || h(bigDecimal.compareTo(bigDecimal2))) {
            return true;
        }
        return false;
    }
    ...
    public boolean g(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        if (j(bigInteger.compareTo(bigInteger2)) || h(bigInteger.compareTo(bigInteger2))) {
            return true;
        }
        return false;
    }
