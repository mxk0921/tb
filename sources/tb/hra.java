...
public class hra extends DXImageWidgetNode {
    ...
    public String f20836a = "noDefined";
    public int b = -1;
    ...
    public static /* synthetic */ Object ipc$super(hra hraVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1133248269:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/taobao/render/dinamicx/dx3/widget/HVideoViewWidgetNodeClone");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof hra) {
            hra hraVar = (hra) dXWidgetNode;
            this.b = hraVar.b;
            this.f20836a = hraVar.f20836a;
            this.c = hraVar.c;
        }
    }
    ...
    public View onCreateView(Context context) {
        ...
        fve.e(h36.TAG, "videoview=" + getDXRuntimeContext().p());
        return hImageView;
    }
    ...
    public void onRenderView(Context context, View view) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (!TextUtils.isEmpty(this.f20836a)) {
                p2b.q(hImageView, this.f20836a, null, dje.GUESS_IMAGE_STRATEGY_CONFIG);
                hImageView.setImageUrl(this.f20836a);
            }
