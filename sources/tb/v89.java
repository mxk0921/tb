...
final class v89<T> extends g79<T> {
    public v89(String str, Class cls, int i, long j, String str2, Short sh, Field field) {
    ...
    public void L(JSONReader jSONReader, T t) {
        try {
            this.h.set(t, jSONReader.o3() ? null : Short.valueOf((short) jSONReader.p2()));
        } catch (Exception e) {
    ...
    public void f(T t, int i) {
        h(t, Short.valueOf((short) i));
    }

    @Override // tb.g79
    public void g(T t, long j) {
        h(t, Short.valueOf((short) j));
    }

    @Override // tb.g79
    public void h(T t, Object obj) {
        try {
            this.h.set(t, TypeUtils.U(obj));
        } catch (Exception e) {
