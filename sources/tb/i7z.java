...
public final class i7z {
    ...
    public static String c(int i) {
        ...
        return "FontStyle(value=" + i + ')';
    }

    public static final int d(int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("1c4da9e8", new Object[]{new Integer(i)})).intValue();
        }
        if (b(i, a(0))) {
            return 0;
        }
        ...
        throw new IllegalArgumentException(ckf.p("Unknown FontStyle ", c(i)));
    }
}
