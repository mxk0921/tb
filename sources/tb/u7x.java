...
public class u7x extends z8s {
    ...
    public u7x(String str) {
        super(str);
    }

    public static /* synthetic */ Object ipc$super(u7x u7xVar, String str, Object... objArr) {
        if (str.hashCode() == -1265548210) {
            super.f((Application) objArr[0], (HashMap) objArr[1]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/taobao/initializer/task/early/WeexPreloadSoTask");
    }
    ...
    public void f(Application application, HashMap<String, Object> hashMap) {
        ...
        try {
            WeexPlugin.preloadSo();
        } catch (Exception e) {
            TMSLogger.b(z8s.TAG, "preloadSo error" + e.getMessage());
        }
    }
}
