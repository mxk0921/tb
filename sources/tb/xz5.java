...
public class xz5 extends DXWidgetNode {
    ...
    public static /* synthetic */ Object ipc$super(xz5 xz5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1806543962:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/widgetnode/DXHStretchViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode instanceof xz5) {
            super.onClone(dXWidgetNode, z);
            xz5 xz5Var = (xz5) dXWidgetNode;
            this.f31735a = xz5Var.f31735a;
            this.c = xz5Var.c;
            this.b = xz5Var.b;
        }
    }
