...
public final class fnp extends Shop2023BaseTemplateComponent {
    ...
    public fnp(ShopComponentModel shopComponentModel) {
        super(shopComponentModel);
        ckf.g(shopComponentModel, "shopComponentModel");
    }

    public static /* synthetic */ Object ipc$super(fnp fnpVar, String str, Object... objArr) {
        ...
        if (hashCode == -1548635899) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/triver/triver_shop/shop2023/template/Shop2023HeaderFeatureTemplate");
        }
    }
