...
public class hq1 {
    ...
    public static final byte[] f20810a = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 48, 49, 50, 51, 52, 53, 54, 55, c0z.MAP32, 57, 43, 47};
    ...
    public static int f(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        if (bArr == null) {
            ...
            byte b3 = bArr[i4];
            if (b3 == 61) {
                int i6 = ((n[bArr[i + 1]] & 255) << 12) | ((n[bArr[i]] & 255) << 18) | ((n[b2] & 255) << 6);
                bArr2[i2] = (byte) (i6 >>> 16);
                bArr2[i2 + 1] = (byte) (i6 >>> 8);
                return 2;
            }
            int i7 = ((n[bArr[i + 1]] & 255) << 12) | ((n[bArr[i]] & 255) << 18) | ((n[b2] & 255) << 6) | (n[b3] & 255);
            bArr2[i2] = (byte) (i7 >> 16);
    ...
    public static byte[] g(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        int i5;
        int i6;
        int i7 = 0;
        IpChange ipChange = $ipChange;
    ...
    public static String k(byte[] bArr, int i, int i2, int i3) throws IOException {
        ...
        try {
            return new String(l, EncodingUtils.US_ASCII);
    ...
    public static byte[] l(byte[] bArr, int i, int i2, int i3) throws IOException {
        ...
        if (bArr == null) {
            ...
            if (i9 < i2) {
                g(bArr, i9 + i, i2 - i9, bArr2, i10, i3);
                i10 += 4;
            }
            if (i10 > i7 - 1) {
                return bArr2;
    ...
    public static class a extends FilterOutputStream {
        ...
        public static /* synthetic */ Object ipc$super(a aVar, String str, Object... objArr) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/analytics/utils/Base64_2$OutputStream");
        }
        ...
        public void e() throws IOException {
            ...
            if (this.f20811a) {
                ((FilterOutputStream) this).out.write(hq1.c(this.g, this.c, i, this.h));
                this.b = 0;
                return;
            }
        ...
        public void write(int i) throws IOException {
            ...
            if (ipChange instanceof IpChange) {
                ...
                int i4 = this.d;
                if (i3 >= i4) {
                    ((FilterOutputStream) this).out.write(hq1.c(this.g, bArr, i4, this.h));
                    int i5 = this.e + 4;
                    this.e = i5;
                    if (this.f && i5 >= 76) {
                ...
                if (b > -5) {
                    ...
                    bArr2[i6] = (byte) i;
                    if (i7 >= this.d) {
                        ((FilterOutputStream) this).out.write(this.g, 0, hq1.b(bArr2, 0, this.g, 0, this.h));
                        this.b = 0;
                    }
                } else if (b != -5) {
