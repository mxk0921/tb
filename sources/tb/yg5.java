...
public class yg5 extends h {
    ...
    public static /* synthetic */ Object ipc$super(yg5 yg5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1814733277:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dxv4common/widget/DXConditionalNodeWidgetNodeV4");
        }
    }
    ...
    public void a(DXWidgetNode dXWidgetNode) {
        ...
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("301dae88", new Object[]{this, dXWidgetNode});
        }
    }
    ...
    public void b(DXWidgetNode dXWidgetNode) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("755e41b9", new Object[]{this, dXWidgetNode});
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode != null && (dXWidgetNode instanceof yg5)) {
            super.onClone(dXWidgetNode, z);
            this.f32071a = ((yg5) dXWidgetNode).f32071a;
        }
    }
    ...
    public boolean t() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("24b39927", new Object[]{this})).booleanValue();
        }
        return this.f32071a;
    }
}
