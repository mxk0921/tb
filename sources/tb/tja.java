...
public class tja extends own {
    ...
    public static /* synthetic */ Object ipc$super(tja tjaVar, String str, Object... objArr) {
        if (str.hashCode() == -1862718671) {
            return new Boolean(super.a(objArr[0], objArr[1]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/ut/abtest/bucketing/expression/GreaterThanOperator");
    }
    ...
    public boolean f(BigDecimal bigDecimal, BigDecimal bigDecimal2) {
        ...
        return i(bigDecimal.compareTo(bigDecimal2));
    }
    ...
    public boolean g(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return i(bigInteger.compareTo(bigInteger2));
    }
}
