...
public class ycl extends env {
    ...
    public static /* synthetic */ Object ipc$super(ycl yclVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/order/downgrade/detail/OrderDetailNavProcessorNodeUriFilterItem3");
    }
    ...
    public boolean pathFilter(String str) {
        ...
        return str.equals("/trade/detail/trade_item_detail.htm");
    }
