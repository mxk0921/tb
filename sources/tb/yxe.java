...
public class yxe extends mss {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public yxe(String str) {
        super(str);
    }

    public static /* synthetic */ Object ipc$super(yxe yxeVar, String str, Object... objArr) {
        if (str.hashCode() == -1890718817) {
            return new Boolean(super.d((en8) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/biz/launcher/InitBrowserProcess");
    }
