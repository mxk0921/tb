...
public class p0f extends mss {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public p0f(String str) {
        super(str);
    }

    public static /* synthetic */ Object ipc$super(p0f p0fVar, String str, Object... objArr) {
        if (str.hashCode() == -1890718817) {
            return new Boolean(super.d((en8) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/biz/launcher/InitHomeSwitchLauncher");
    }
