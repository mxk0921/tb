...
public class n3f extends mss {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static boolean e;

    public n3f(String str) {
        super(str);
        e(true);
    }

    public static /* synthetic */ Object ipc$super(n3f n3fVar, String str, Object... objArr) {
        if (str.hashCode() == -1890718817) {
            return new Boolean(super.d((en8) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/biz/launcher/InitPhenixApng");
    }
    ...
    public boolean d(en8<String, Void> en8Var) {
        ...
        if (!d || !t.a(LauncherRuntime.g, "phenix_decoder_merge")) {
            return d;
        }
        return false;
    }
