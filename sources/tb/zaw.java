...
public final class zaw extends BaseTemplateComponent {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final String i = "tb_video_shop_content_info_2022";

    static {
        t2o.a(766510056);
    }

    public static /* synthetic */ Object ipc$super(zaw zawVar, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/newShop/view/component/templateComponent/VideoShopContentInfoTemplate");
    }
    ...
    public void k(Context context, ShopDataParser shopDataParser, ShopDXEngine shopDXEngine, JSONObject jSONObject) {
        ...
        if (r == null) {
            r = brf.a(jpu.a("url", "https://dinamicx.alibabausercontent.com/pub/tb_video_shop_content_info_2022/1661764815100/tb_video_shop_content_info_2022.zip"), jpu.a("version", "4"), jpu.a("name", this.i));
        }
        BaseTemplateComponent.r(this, r, brf.a(jpu.a("headerData", shopDataParser.o0())), false, 4, null);
        shopDXEngine.k().a(kht.videoShopInfoArea, new l77(context, this));
    }
}
