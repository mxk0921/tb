...
public class spo extends sgg implements jqk {
    ...
    public spo(vh4 vh4Var) {
        super(vh4Var);
    }

    public static /* synthetic */ Object ipc$super(spo spoVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/schedulers/SafeModeScheduler");
    }
