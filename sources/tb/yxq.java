...
public class yxq extends sgg implements jqk {
    ...
    public yxq(vh4 vh4Var) {
        super(vh4Var);
    }

    public static /* synthetic */ Object ipc$super(yxq yxqVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/schedulers/SupportToolScheduler");
    }
    ...
    public n35<String, Void> B() {
        ...
        int i = l;
        return new n35<>(k35.a(wzi.LAUNCHER, i, i, 5));
    }
