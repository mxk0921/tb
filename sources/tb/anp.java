...
public final class anp extends Shop2023BaseTemplateComponent {
    ...
    public static /* synthetic */ Object ipc$super(anp anpVar, String str, Object... objArr) {
        ...
        if (hashCode == -1548635899) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/triver/triver_shop/shop2023/template/Shop2023BottomBarTemplate");
        } else {
