...
public class kw4 {
    ...
    */
    public static int b(android.content.Context r4) {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = tb.kw4.$ipChange
        ...
        L_0x0060:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.kw4.b(android.content.Context):int");
    }
    ...
    public static int d() {
        ...
        return (str.toLowerCase().startsWith("armeabi") || str.toLowerCase().startsWith(kgd.ABI_ARM) || str.toLowerCase().startsWith("x86")) ? 32 : -1;
    }
