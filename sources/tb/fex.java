...
public class fex extends z8s {
    ...
    public static /* synthetic */ Object ipc$super(fex fexVar, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/taobao/initializer/task/necessary/WindVaneInitAtHomeVisibleTask");
    }
    ...
    public String e() {
        ...
        return "WindVane.initAtHomeVisible";
    }
    ...
    public void f(Application application, HashMap<String, Object> hashMap) {
        ...
        WindVaneLaunchTask.initAtHomeVisible(application, hashMap);
    }
}
