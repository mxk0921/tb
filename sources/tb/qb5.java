...
public class qb5 extends uu {
    ...
    public static /* synthetic */ Object ipc$super(qb5 qb5Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx_v4/expr/fuction/math/DXAbsFunction");
    }
    ...
    public uw5 execute(DXRuntimeContext dXRuntimeContext, uw5 uw5Var, int i, uw5[] uw5VarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            ...
            if (uw5Var2.D()) {
                return uw5.P(Math.abs(uw5Var2.q()));
            }
            return uw5.S(Math.abs(uw5Var2.s()));
        } catch (Exception e) {
