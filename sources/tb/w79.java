...
final class w79<T> extends fa9<T> {
    public w79(String str, Type type, Class cls, int i, long j, String str2, Locale locale, BigInteger bigInteger, Method method) {
    ...
    public void h(T t, Object obj) {
        try {
            this.g.invoke(t, TypeUtils.F(obj));
        } catch (Exception e) {
            throw new JSONException("set " + this.b + " error", e);
        }
    }
