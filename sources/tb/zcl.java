...
public class zcl extends env {
    ...
    public static /* synthetic */ Object ipc$super(zcl zclVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/order/downgrade/detail/OrderDetailNavProcessorNodeUriFilterItem4");
    }
