...
public class udl extends env {
    ...
    public static /* synthetic */ Object ipc$super(udl udlVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/order/downgrade/list/OrderListNavProcessorNodeUriFilterItem4");
    }
    ...
    public boolean pathFilter(String str) {
        ...
        return str.equals("/awp/mtb/olist.htm");
    }
