...
public class uj8 {
    ...
    public static void a(String str, String str2, String str3) {
        ...
        g(str, str + "-onHandleEventChain", str2, str4, str3);
    }
    ...
    public static void b(String str, String str2, String str3, String str4) {
        ...
        g(str, str + "-" + str2, str3, str5, str4);
    }

    public static void c(String str, String str2, String str3, Map<String, String> map) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("f5d939ea", new Object[]{str, str2, str3, map});
            return;
        }
        ...
        g(str, str + "-" + str2, str3, str4, map.toString());
    }
    ...
    public static java.lang.String d(java.lang.Throwable r4) {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = tb.uj8.$ipChange
        ...
        L_0x0061:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.uj8.d(java.lang.Throwable):java.lang.String");
    }
