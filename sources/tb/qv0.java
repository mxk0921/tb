...
public class qv0 extends j68 {
    ...
    public static /* synthetic */ Object ipc$super(qv0 qv0Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/engine/expr/op/AndOperator");
    }
