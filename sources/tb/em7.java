...
public class em7 {
    ...
    public static final String f18674a = "1.0";
    public static final String b = "__compiler_version__";
    public static final String c = "__interpreter_version__";
    ...
    public static final gak NL = new gak();
