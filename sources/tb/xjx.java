...
public class xjx extends gi6 {
    ...
    public static final long h = 473454053904714455L;

    /* renamed from: a  reason: collision with root package name */
    public XAdaptiveTextViewV3 f31433a;
    public JSONArray b;
    public String c;
    public int d;
    public int e;
    ...
    public static /* synthetic */ Object ipc$super(xjx xjxVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -879570230:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/core/detail/kit/view/holder/main/dinamic3/widget/XAdaptiveTextViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof xjx) {
            xjx xjxVar = (xjx) dXWidgetNode;
            this.d = xjxVar.d;
            this.e = xjxVar.e;
            this.f = xjxVar.f;
            this.g = xjxVar.g;
            this.c = xjxVar.c;
            JSONArray jSONArray = xjxVar.b;
            if (!z || jSONArray == null) {
                this.b = jSONArray;
            } else {
    ...
    public View onCreateView(Context context) {
        ...
        this.f31433a = xAdaptiveTextViewV3;
    ...
    public void onMeasure(int i, int i2) {
        ...
        XAdaptiveTextViewV3 xAdaptiveTextViewV3 = this.f31433a;
        if (xAdaptiveTextViewV3 != null) {
            setMeasuredDimension(xAdaptiveTextViewV3.getMeasuredWidthAndState(), this.f31433a.getMeasuredHeightAndState());
        }
    }
    ...
    public final void t(XAdaptiveTextViewV3 xAdaptiveTextViewV3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("309c827c", new Object[]{this, xAdaptiveTextViewV3});
