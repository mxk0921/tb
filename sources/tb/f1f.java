...
public class f1f extends bxk {
    ...
    public static /* synthetic */ Object ipc$super(f1f f1fVar, String str, Object... objArr) {
        if (str.hashCode() == -1890718817) {
            return new Boolean(super.d((en8) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/biz/launcher/InitLinkManagerB");
    }
    ...
    public boolean d(en8<String, Void> en8Var) {
        ...
        return t.a(LauncherRuntime.g, "linkAhead");
    }
