...
public class dgs extends ofs {
    ...
    public static /* synthetic */ Object ipc$super(dgs dgsVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/flexbox/layoutmanager/animation/TNodeAnimator/TNodeScaleXAnimator");
    }

    public static dgs o(n nVar, float f, float f2, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (dgs) ipChange.ipc$dispatch("d6fcd829", new Object[]{nVar, new Float(f), new Float(f2), new Boolean(z)});
        }
        dgs dgsVar = new dgs();
        dgsVar.f(z);
        dgsVar.j(nVar, f, f2);
    ...
    public void l(n nVar, View view, float f) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            nVar.j1("scaleX", Float.valueOf(f), false);
        }
    }
}
