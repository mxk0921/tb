...
public interface csw {
    ...
    void didGetPageStatusCode(String str, int i, int i2, String str2, String str3, String str4, Map<String, String> map, a aVar);

    void didGetResourceStatusCode(String str, int i, int i2, Map<String, String> map, a aVar);
