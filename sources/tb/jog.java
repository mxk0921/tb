...
public class jog {
    ...
    public static final ConcurrentHashMap<String, String> f22118a = new ConcurrentHashMap<>();
    ...
    public static String a(String str, String str2, String str3, boolean z) {
        ...
        if (config == null) {
            f22118a.put(str2, str3);
            return str3;
        }
        f22118a.put(str2, config);
        return config;
    }
    ...
    public static boolean c(String str, String str2, boolean z, boolean z2) {
        ...
        String config = OrangeConfig.getInstance().getConfig(str, str2, null);
        if (config == null) {
            f22118a.put(str2, String.valueOf(z));
            return z;
        }
        f22118a.put(str2, config);
