...
public class f36 extends uu {
    ...
    public static /* synthetic */ Object ipc$super(f36 f36Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx_v4/expr/fuction/math/DXLog10Function");
    }
    ...
    public uw5 execute(DXRuntimeContext dXRuntimeContext, uw5 uw5Var, int i, uw5[] uw5VarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            return uw5.P(Math.log10(uw5VarArr[0].q()));
        } catch (Exception e) {
