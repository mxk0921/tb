...
public class gex extends z8s {
    ...
    public static /* synthetic */ Object ipc$super(gex gexVar, String str, Object... objArr) {
        if (str.hashCode() == -1265548210) {
            super.f((Application) objArr[0], (HashMap) objArr[1]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/taobao/initializer/task/idle/WindVaneInitAtIdleTask");
    }
    ...
    public void f(Application application, HashMap<String, Object> hashMap) {
        ...
        WindVaneLaunchTask.initAtIdle(application, hashMap);
    }
}
