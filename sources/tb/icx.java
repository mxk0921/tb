...
public class icx extends sgg implements jqk {
    ...
    public static /* synthetic */ Object ipc$super(icx icxVar, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/schedulers/WidgetScheduler");
    }
    ...
    public void h(Context context) {
        ...
        q35<String, Void> H = H("wdg-create");
        this.b.u(v35.f(H));
        P(H, new b(this));
    }
