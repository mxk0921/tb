...
public interface y0x {
    ...
    void onWebsocketHandshakeReceivedAsClient(WebSocket webSocket, mu3 mu3Var, rcp rcpVar) throws InvalidDataException;

    scp onWebsocketHandshakeReceivedAsServer(WebSocket webSocket, Draft draft, mu3 mu3Var) throws InvalidDataException;

    void onWebsocketHandshakeSentAsClient(WebSocket webSocket, mu3 mu3Var) throws InvalidDataException;

    void onWebsocketMessage(WebSocket webSocket, String str);

    void onWebsocketMessage(WebSocket webSocket, ByteBuffer byteBuffer);

    void onWebsocketOpen(WebSocket webSocket, gta gtaVar);
