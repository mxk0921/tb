...
public class han extends gi6 {
    ...
    public static /* synthetic */ Object ipc$super(han hanVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/widgetnode/RPriceViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof han) {
            han hanVar = (han) dXWidgetNode;
            this.f20503a = hanVar.f20503a;
            this.b = hanVar.b;
            this.c = hanVar.c;
        }
    }
    ...
    public final SpannableString t() {
        ...
        if ("alistyle".equals(this.f20503a)) {
            float f = this.c;
            i2 = (int) (0.681f * f);
            i = (int) (f * 0.762f);
        } else {
        ...
        if ("normal".equals(this.f20503a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f20503a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f20503a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f20503a)) {
