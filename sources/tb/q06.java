...
public class q06 extends DXWidgetNode {
    ...
    public static /* synthetic */ Object ipc$super(q06 q06Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1775895211:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/taolive/movehighlight/dx/widget/structLayout/DXHighlightStructListViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode != null && (dXWidgetNode instanceof q06)) {
            super.onClone(dXWidgetNode, z);
            this.f26419a = ((q06) dXWidgetNode).f26419a;
        }
    }
    ...
    public View onCreateView(Context context) {
        ...
        return new kd6(context, this, this.f26419a, ux9Var).d;
    }
