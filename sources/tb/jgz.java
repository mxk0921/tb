...
import com.taobao.android.nanocompose.foundation.components.rich_text.NCComponentRichText;
import com.taobao.android.nanocompose.viewhandler.NCComponentViewHandler;

/* compiled from: Taobao */
/* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes6.dex */
public final class jgz extends NCComponentViewHandler {
    ...
    public static /* synthetic */ Object ipc$super(jgz jgzVar, String str, Object... objArr) {
        if (str.hashCode() == -76004444) {
            super.onUpdateViewWithContext((biz) objArr[0], (jkz) objArr[1], (jkz) objArr[2]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/nanocompose/foundation/components/rich_text/NCComponentRichTextViewHandler");
    }
    ...
    public View onCreateView(Context context) {
        ...
        return new NCComponentRichText(context);
    }
