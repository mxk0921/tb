...
public class kq0 {
    ...
    public static AliLoginInterface f22844a;
    ...
    public static AliLoginInterface c() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (AliLoginInterface) ipChange.ipc$dispatch("7fb4ff81", new Object[0]);
        }
