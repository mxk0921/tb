...
public class p05 {
    ...
    public class a implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            if (scaleFactor >= 0.0f) {
                p05.a(p05.this).c(scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
            }
            return true;
        }
    ...
    public p05(Context context, ark arkVar) {
    ...
    public static /* synthetic */ ark a(p05 p05Var) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ark) ipChange.ipc$dispatch("82b8483f", new Object[]{p05Var});
        }
        return p05Var.l;
    }
    ...
    public final boolean g(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f25778a = motionEvent.getPointerId(0);
            ...
            int b3 = kwv.b(motionEvent.getAction());
            if (motionEvent.getPointerId(b3) == this.f25778a) {
                if (b3 == 0) {
                    i = 1;
                } else {
                    i = 0;
                }
                this.f25778a = motionEvent.getPointerId(i);
