...
public class zf5 extends h {
    ...
    public static /* synthetic */ Object ipc$super(zf5 zf5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1814733277:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/icart/widget/DXCartTranslatableFrameLayoutWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode != null && (dXWidgetNode instanceof zf5)) {
            super.onClone(dXWidgetNode, z);
            zf5 zf5Var = (zf5) dXWidgetNode;
            this.f32723a = zf5Var.f32723a;
            this.b = zf5Var.b;
        }
    }
    ...
    public void onRenderView(Context context, View view) {
        ...
        if (view != null) {
            view.setTranslationX(this.f32723a);
