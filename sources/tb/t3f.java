...
public class t3f extends bxk {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public t3f(String str) {
        super(str);
        e(true);
    }

    public static /* synthetic */ Object ipc$super(t3f t3fVar, String str, Object... objArr) {
        if (str.hashCode() == -1890718817) {
            return new Boolean(super.d((en8) objArr[0]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/launcher/biz/launcher/InitPhenixDelay");
    }
