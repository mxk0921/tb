...
public class ngi extends LruCache<String, rgi> {
    ...
    public static /* synthetic */ Object ipc$super(ngi ngiVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/taobaoavsdk/recycle/MediaPlayerLruCache");
    }
