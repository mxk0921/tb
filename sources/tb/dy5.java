...
public class dy5 extends uu {
    ...
    public static /* synthetic */ Object ipc$super(dy5 dy5Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx_v4/expr/fuction/DXGetFunction");
    }
    ...
    public uw5 execute(DXRuntimeContext dXRuntimeContext, uw5 uw5Var, int i, uw5[] uw5VarArr, Map map) throws DXExprFunctionError {
        ...
        StringTokenizer stringTokenizer = new StringTokenizer(uw5VarArr[0].toString(), " .[]", false);
        Object z = uw5Var.z();
