...
public class s8r {
    ...
    public static TBLocationDTO f27873a = null;
    ...
    public static String b() {
        ...
        d();
        if (f27873a == null && (d = TBLocationClient.d()) != null) {
            f27873a = d;
        }
        JSONObject jSONObject = new JSONObject();
        TBLocationDTO tBLocationDTO = f27873a;
        if (tBLocationDTO != null) {
            jSONObject.put(DispatchConstants.LONGTITUDE, (Object) tBLocationDTO.longitude);
            jSONObject.put(DispatchConstants.LATITUDE, (Object) f27873a.latitude);
            jSONObject.put("provinceDivisionCode", (Object) f27873a.provinceCode);
            jSONObject.put("cityDivisionCode", (Object) f27873a.cityCode);
            jSONObject.put("areaDivisionCode", (Object) f27873a.areaCode);
        }
