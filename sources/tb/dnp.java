...
public final class dnp extends Shop2023BaseTemplateComponent {
    ...
    public dnp(ShopComponentModel shopComponentModel, boolean z) {
    ...
    public static /* synthetic */ Object ipc$super(dnp dnpVar, String str, Object... objArr) {
        ...
        if (hashCode == -1548635899) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/triver/triver_shop/shop2023/template/Shop2023HeaderActivityTemplate");
        }
    }
    ...
    public void k(Context context, ShopDataParser shopDataParser, ShopDXEngine shopDXEngine, JSONObject jSONObject) {
        ...
        if (jSONObject2 != null) {
            jSONObject2.put("showHeaderRelation", (Object) Boolean.valueOf(this.l));
        }
    ...
    public final void I() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("9159e505", new Object[]{this});
        } else {
            z(brf.a(jpu.a("headerRelationFail", Boolean.TRUE)));
        }
    }
}
