...
public class ee5 extends gi6 {
    ...
    public static /* synthetic */ Object ipc$super(ee5 ee5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/widgetnode/DXButterRPriceViewWidgetNode");
        }
    }
    ...
    public static void u() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("ff39a9e4", new Object[0]);
        } else if (e == null) {
            e = Typeface.createFromAsset(DinamicXEngine.x().getAssets(), "iconfonts/AlibabaSans102_v1_TaoBao-Bd.ttf");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof ee5) {
            ee5 ee5Var = (ee5) dXWidgetNode;
            this.f18510a = ee5Var.f18510a;
            this.b = ee5Var.b;
            this.c = ee5Var.c;
        }
    }
    ...
    public final SpannableString t() {
        ...
        if ("alistyle".equals(this.f18510a)) {
            float f = this.c;
            i2 = (int) (0.681f * f);
            i = (int) (f * 0.762f);
        } else {
        ...
        if (length != 0) {
            ...
            if (mve.a("enableBoldInfoFlowPriceView", true)) {
        ...
        if ("normal".equals(this.f18510a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f18510a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f18510a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f18510a)) {
        ...
        if ("alistyle".equals(this.f18510a)) {
            ...
            if (length != 0) {
                spannableString.setSpan(new a15(0.3f), 0, length, 33);
            }
        }
