...
public class my5 extends h {
    ...
    public static /* synthetic */ Object ipc$super(my5 my5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1814733277:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx/widget/DXGridItemWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode != null && (dXWidgetNode instanceof my5)) {
            super.onClone(dXWidgetNode, z);
            my5 my5Var = (my5) dXWidgetNode;
            this.f24384a = my5Var.f24384a;
            this.b = my5Var.b;
        }
    }
    ...
    public int t() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("61890f0e", new Object[]{this})).intValue();
        }
        return this.f24384a;
    }
    ...
    public int u() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("79e04d68", new Object[]{this})).intValue();
        }
        return this.b;
    }
}
