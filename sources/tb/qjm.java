...
public class qjm extends jnq {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public qjm(Handler handler) {
        super(handler);
    }

    public static /* synthetic */ Object ipc$super(qjm qjmVar, String str, Object... objArr) {
        ...
        if (hashCode == -830706570) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/metrickit/event/instrument/PowerManagerProxy");
        }
    }
