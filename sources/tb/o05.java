...
public class o05 {
    ...
    public class a implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            o05.a(o05.this).c(scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
            return true;
        }
    ...
    public o05(Context context, zqk zqkVar) {
    ...
    public static /* synthetic */ zqk a(o05 o05Var) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (zqk) ipChange.ipc$dispatch("d760ebdf", new Object[]{o05Var});
        }
        return o05Var.j;
    }
    ...
    public final boolean g(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f25060a = motionEvent.getPointerId(0);
            ...
            int b2 = jwv.b(motionEvent.getAction());
            if (motionEvent.getPointerId(b2) == this.f25060a) {
                if (b2 == 0) {
                    i = 1;
                } else {
                    i = 0;
                }
                this.f25060a = motionEvent.getPointerId(i);
