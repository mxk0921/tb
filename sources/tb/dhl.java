...
public final class dhl extends Shop2023BaseTemplateComponent {
    ...
    public dhl(ShopComponentModel shopComponentModel) {
        super(shopComponentModel);
        ckf.g(shopComponentModel, "shopComponentModel");
    }

    public static /* synthetic */ Object ipc$super(dhl dhlVar, String str, Object... objArr) {
        ...
        if (hashCode == -1548635899) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/triver/triver_shop/shop2023/template/OverseaShopFourTabTemplate");
        }
    }
