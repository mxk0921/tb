...
public class nax extends uy<Intent> {
    ...
    public static /* synthetic */ Object ipc$super(nax naxVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/order/bundle/nav/detail/WhetherToNativeODTask");
    }
