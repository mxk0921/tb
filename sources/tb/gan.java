...
public class gan extends gi6 {
    ...
    public static /* synthetic */ Object ipc$super(gan ganVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/homepage/dinamic3/widgetnode/RPriceViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof gan) {
            gan ganVar = (gan) dXWidgetNode;
            this.f19835a = ganVar.f19835a;
            this.b = ganVar.b;
            this.c = ganVar.c;
        }
    }
    ...
    public final SpannableString t() {
        ...
        if ("alistyle".equals(this.f19835a)) {
            float f = this.c;
            i2 = (int) (0.571f * f);
            i = (int) (f * 0.762f);
        } else {
        ...
        if ("normal".equals(this.f19835a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f19835a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f19835a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f19835a)) {
