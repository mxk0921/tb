...
public class xq0 {
    ...
    public static AliNavServiceInterface f31541a;
    ...
    public static <T> T a(Class<T> cls) {
        ...
        T t2 = (T) b(cls);
        if (t2 != null) {
            f31541a = (AliNavServiceInterface) t2;
        }
        return t2;
    }
    ...
    public static AliNavServiceInterface c() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (AliNavServiceInterface) ipChange.ipc$dispatch("ca92a084", new Object[0]);
        }
