...
public class aew extends ContextWrapper {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    public static final String TAG = "ViewContext";

    /* renamed from: a  reason: collision with root package name */
    public WeakReference<Context> f15699a;
    ...
    public static /* synthetic */ Object ipc$super(aew aewVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2116008609:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail2/core/optimize/prerender/ViewContext");
        }
    }
    ...
    public Context a() {
        ...
        WeakReference<Context> weakReference = this.f15699a;
