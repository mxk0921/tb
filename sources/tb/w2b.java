...
public class w2b extends env {
    ...
    public static /* synthetic */ Object ipc$super(w2b w2bVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/performance/HomePageNavProcessorNodeUriFilterItem0");
    }
