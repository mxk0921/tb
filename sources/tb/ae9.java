...
public class ae9 {
    ...
    public static byte[] a(String str, Context context) {
        ...
        if (ipChange instanceof IpChange) {
            return (byte[]) ipChange.ipc$dispatch("e0859aa0", new Object[]{str, context});
        }
        try {
        ...
        try {
            ...
            th = th4;
            try {
                s3a.b("Read bytes from asset file exception", th);
            } finally {
                if (inputStream != null) {
                    try {
                        inputStream.close();
    ...
    public static byte[] c(File file) {
        ...
        try {
            ...
            s3a.b("Read all bytes exception", e);
            return null;
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    s3a.b("Close file output stream exception", th2);
                }
                return true;
            } catch (Throwable th3) {
                th = th3;
                ...
                try {
                    ...
                    if (bufferedOutputStream != null) {
                        try {
                            ...
                            s3a.b("Close file output stream exception", th4);
                        }
                    }
                }
            }
