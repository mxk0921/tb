...
public class lb5 extends uu {
    ...
    public static /* synthetic */ Object ipc$super(lb5 lb5Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/dinamicx_v4/expr/fuction/string/DXAbsCompareToFunction");
    }
