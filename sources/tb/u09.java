...
public final class u09 extends DefaultFragmentViewProvider {
    ...
    public static /* synthetic */ Object ipc$super(u09 u09Var, String str, Object... objArr) {
        if (str.hashCode() == -625877200) {
            return super.b((Context) objArr[0], (Fragment) objArr[1]);
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/triver/triver_shop/shop2023/provider/FarmShopFragmentViewProvider");
    }
