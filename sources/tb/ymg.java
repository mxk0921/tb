...
public class ymg extends pak {
    ...
    public static /* synthetic */ Object ipc$super(ymg ymgVar, String str, Object... objArr) {
        if (str.hashCode() == -1862718671) {
            return new Boolean(super.apply(objArr[0], objArr[1]));
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/ut/mini/behavior/expression/LessThanOperator");
    }
    ...
    public boolean apply(BigDecimal bigDecimal, BigDecimal bigDecimal2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("b1b6c601", new Object[]{this, bigDecimal, bigDecimal2})).booleanValue() : isLess(bigDecimal.compareTo(bigDecimal2));
    }

    @Override // tb.pak
    public boolean apply(BigInteger bigInteger, BigInteger bigInteger2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("ccb51ba7", new Object[]{this, bigInteger, bigInteger2})).booleanValue() : isLess(bigInteger.compareTo(bigInteger2));
    }
}
