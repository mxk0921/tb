...
import com.taobao.tao.linklog.ILinkLogAdapter;
...
public class hrg {
    ...
    public static ILinkLogAdapter f20840a;
    ...
    public static void a(String str, String str2, String str3, String str4, String str5, Map<String, String> map, String str6, String str7) {
        ...
        ILinkLogAdapter iLinkLogAdapter = f20840a;
    ...
    public static void d(String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        ...
        } else if (f20840a != null && !TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3) && !TextUtils.isEmpty(str4) && !TextUtils.isEmpty(str5)) {
    ...
    public static void h(ILinkLogAdapter iLinkLogAdapter) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("66b93e79", new Object[]{iLinkLogAdapter});
        } else {
            f20840a = iLinkLogAdapter;
        }
    }
}
