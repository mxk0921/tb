...
public class fgn extends m8 {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    public static final long RATEFIRSTFRAMEPICTURERENDER = -1225037140529928202L;
    ...
    public static class a implements w8 {
        ...
        /* renamed from: a */
        public fgn build(Object obj) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return (fgn) ipChange.ipc$dispatch("50d660b5", new Object[]{this, obj});
            }
            return new fgn();
        }
    }

    public static /* synthetic */ Object ipc$super(fgn fgnVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/detail/rate/vivid/ability/RateFirstFramePictureRenderAbility");
    }
