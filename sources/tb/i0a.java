...
public class i0a extends env {
    ...
    public static /* synthetic */ Object ipc$super(i0a i0aVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/fscrmid/nav/FullPageNavProcessorNodeUriFilterItem0");
    }
