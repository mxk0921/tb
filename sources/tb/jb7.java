...
public class jb7 extends j68 {
    ...
    public static /* synthetic */ Object ipc$super(jb7 jb7Var, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/alibaba/android/ultron/engine/expr/op/DeleteIfNullOperator");
    }
