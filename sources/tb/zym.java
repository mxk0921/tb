...
public final class zym {
    ...
    public static String a() {
        ...
        Application application = z9a.f32627a;
        if (TextUtils.isEmpty(f33109a)) {
            String c = c();
    ...
    */
    public static java.lang.String c() {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = tb.zym.$ipChange
        ...
        L_0x0060:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.zym.c():java.lang.String");
    }

    public static boolean d() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("c30ce012", new Object[0])).booleanValue();
        }
        if (z9a.f32627a == null) {
            return false;
        }
        String a2 = a();
        String packageName = z9a.f32627a.getPackageName();
