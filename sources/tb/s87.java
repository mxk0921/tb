...
public class s87 implements a2w {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public static final LruCache<String, Method> f27867a = new LruCache<>(64);
    ...
    public Object b(Object obj, Class<?> cls, String str) {
        ...
        LruCache<String, Method> lruCache = f27867a;
        Method method = lruCache.get(str2);
        if (method != null) {
            try {
                return method.invoke(obj, new Object[0]);
            } catch (Exception e) {
                ym7.l("DinamicLog", e, new String[0]);
                return null;
            }
        } else {
            ...
            if (field != null) {
                try {
                    ...
                    ym7.m("DinamicLog", e2.getMessage());
                    return null;
                }
            } else {
                ...
                if (lruCache3.get(str2) != "") {
                    try {
                        try {
                            ...
                            ym7.m("DinamicLog", e3.getMessage());
                            return null;
                        }
                    } catch (NoSuchMethodException unused2) {
                        lruCache3.put(str2, "");
                    } catch (Exception e4) {
                        ym7.m(e4.getMessage(), new String[0]);
                        return null;
                    }
                }
                ...
                if (lruCache4.get(str2) != "") {
                    try {
                        ...
                        ym7.m("DinamicLog", e5.getMessage());
                        return null;
                    }
                }
                return null;
