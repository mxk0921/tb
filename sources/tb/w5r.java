...
public final class w5r extends vy1 {
    ...
    /* compiled from: Taobao */
    /* loaded from: /Users/corson/Downloads/taobao_decompiled/build/apk/classes6.dex */
    public static final class a implements ProcedureImpl.b {
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public void d(r1w r1wVar, ugq ugqVar) {
            ...
            ckf.g(r1wVar, "value");
            ckf.g(ugqVar, v4s.PARAM_UPLOAD_STAGE);
        }
    }
    ...
    public w5r(qpu qpuVar, cll cllVar) {
        super(cllVar);
        ...
        if (mddVar instanceof ProcedureImpl) {
            ((ProcedureImpl) mddVar).x(new a());
        }
        W();
        Q(cllVar.v());
        String pageName = cllVar.getPageName();
        ckf.d(pageName);
        String x = cllVar.x();
        ckf.d(x);
        b0(pageName, x, new HashMap(), cllVar.v());
    }

    public static /* synthetic */ Object ipc$super(w5r w5rVar, String str, Object... objArr) {
        ...
        if (hashCode == -410389705) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/android/turbo/service/apm/TBAPMPageProcessor");
        }
    }

    public static final /* synthetic */ void o0(w5r w5rVar, r1w r1wVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("25bb6da1", new Object[]{w5rVar, r1wVar});
        } else {
            w5rVar.r0(r1wVar);
        }
    }
        ...
        if (ipChange instanceof IpChange) {
            ...
            try {
                for (Map.Entry<String, ? extends Object> entry : map.entrySet()) {
                    ...
                    if (!TextUtils.isEmpty(key) && R.contains(key)) {
                        this.d.a(key, value);
                    }
                }
            } catch (Throwable th) {
    ...
    public final void p0(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dd49a9d1", new Object[]{this, str, str2});
            return;
        }
    ...
    public final void r0(r1w r1wVar) {
        String str;
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("375dec42", new Object[]{this, r1wVar});
        } else if (r1wVar != null) {
            try {
                Map<String, Object> s = r1wVar.s();
                ckf.f(s, "value.statistics()");
                Map<String, Object> n = r1wVar.n();
                ckf.f(n, "value.properties()");
                Object obj = n.get("pageName");
                Object obj2 = n.get(pl4.KEY_LOAD_TYPE);
                Object obj3 = n.get("leaveType");
                JSONObject jSONObject = new JSONObject();
                jSONObject.put((JSONObject) "pageName", String.valueOf(obj));
                jSONObject.put((JSONObject) pl4.KEY_LOAD_TYPE, String.valueOf(obj2));
                jSONObject.put((JSONObject) "leaveType", String.valueOf(obj3));
                if (!s.isEmpty()) {
                ...
                f2e.a.b((f2e) this.Q.getService(f2e.class), "ShortVideoMonitor", "APM_DATA", String.valueOf(obj), String.valueOf(obj3), jSONObject, 19997, false, 64, null);
            } catch (Exception e) {
                tpu.a aVar = tpu.Companion;
                tpu.a.b(aVar, "PageProcessor", "APM_END error, " + e.getMessage(), null, 4, null);
            }
        }
    }
    ...
    public void a0(long j) {
        ...
        cll cllVar = this.c;
        ckf.f(cllVar, "page");
        zq6.a("PageProcessor", "onPageAppear", cllVar.getPageName());
        long a2 = out.a();
        this.d.d("onPageAppear", new HashMap(1));
        cll cllVar2 = this.c;
        ckf.f(cllVar2, "page");
        nca.r = cllVar2.getPageName();
        nca.p = a2;
    }
    ...
    @Override // tb.vy1
    public void b0(String str, String str2, Map<String, ? extends Object> map, long j) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
