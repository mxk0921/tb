...
public final class grz implements m6z {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final grz INSTANCE = new grz();
    ...
    public l6z a(String str, TemplateItem templateItem) {
        ...
        TemplateItem h = jrz.h(jrz.INSTANCE, str, templateItem.c(), templateItem.e(), false, 8, null);
        if (h == null) {
            return new l6z(false, null);
        }
        return new l6z(true, h);
    }
}
