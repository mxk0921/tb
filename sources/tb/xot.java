...
public final class xot {
    ...
    public static final int[] f31501a = {R.attr.colorPrimary};
    public static final int[] b = {R.attr.colorPrimaryVariant};

    public static void a(Context context) {
        e(context, f31501a, "Theme.AppCompat");
    }
    ...
    public static TintTypedArray i(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        b(context, attributeSet, i, i2);
        d(context, attributeSet, iArr, i, i2, iArr2);
