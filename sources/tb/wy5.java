...
public class wy5 extends DXWidgetNode {
    ...
    public static /* synthetic */ Object ipc$super(wy5 wy5Var, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
            ...
            default:
                ...
                throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/widgetnode/DXHGifViewWidgetNode");
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode instanceof wy5) {
            super.onClone(dXWidgetNode, z);
            wy5 wy5Var = (wy5) dXWidgetNode;
            this.f31008a = wy5Var.f31008a;
            this.b = wy5Var.b;
            this.c = wy5Var.c;
            this.d = wy5Var.d;
            this.e = wy5Var.e;
    ...
    public final void t(boolean z) {
        ...
        } else if (f4b.b("enableHomePageJumpToNextPageCostOpt2", true) && !TextUtils.isEmpty(this.b) && p2b.k()) {
            ...
            if (nativeView instanceof HGifView) {
                ...
                if (hGifView.getGifImageView() != null) {
                    ...
                    if (z) {
                        ...
                        if (gifImageView.getTag(i) == null) {
                            hne hneVar = new hne(gifImageView);
                            gifImageView.getViewTreeObserver().addOnPreDrawListener(hneVar);
                            gifImageView.setTag(i, hneVar);
                        }
                    }
                    if (!z) {
                        int i2 = R.id.tag_image_view_predraw_listener;
                        if (gifImageView.getTag(i2) != null) {
                            gifImageView.getViewTreeObserver().removeOnPreDrawListener((ViewTreeObserver.OnPreDrawListener) gifImageView.getTag(i2));
    ...
    public void onRenderView(Context context, View view) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (hGifView.getBottomImageView() != null && hGifView.getGifImageView() != null) {
                ...
                String str = this.c;
                ImageStrategyConfig imageStrategyConfig = dje.GUESS_IMAGE_STRATEGY_CONFIG;
                p2b.r(bottomImageView, str, null, imageStrategyConfig, getDXRuntimeContext().p());
                p2b.r(hGifView.getGifImageView(), this.b, null, imageStrategyConfig, getDXRuntimeContext().p());
                u(hGifView.getBottomImageView(), this.e);
                u(hGifView.getGifImageView(), this.e);
                try {
                    hGifView.getBottomImageView().setPlaceHoldForeground((Drawable) this.d);
                } catch (Throwable th) {
                    fve.e("DXHGifViewWidgetNode", "图片预置图加载异常 msg = " + th.getMessage());
                }
