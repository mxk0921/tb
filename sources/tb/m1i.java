...
public class m1i extends env {
    ...
    public static /* synthetic */ Object ipc$super(m1i m1iVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/processors/MainTabRedirectProcessorNodeUriFilterItem0");
    }
    ...
    public boolean pathFilter(String str) {
        ...
        return str.equals("/main/tab/unknown");
    }
