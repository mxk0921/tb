...
final class d99<T, V> extends g79<T> {
    final z92<T, V> v;

    public d99(String str, Class<V> cls, int i, long j, String str2, Locale locale, Object obj, Method method, z92<T, V> z92Var) {
    ...
    public void h(T t, Object obj) {
        ((pdk) this.v).a(t, TypeUtils.R(obj));
    }
}
