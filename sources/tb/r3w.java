...
public class r3w extends ImageSpan {
    ...
    public r3w(Drawable drawable, int i) {
        super(drawable, i);
    }

    public static /* synthetic */ Object ipc$super(r3w r3wVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/homepage/dinamic3/VerticalCenterImageSpan");
    }
