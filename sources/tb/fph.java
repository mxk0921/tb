...
public class fph extends g22 {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public long f19453a = 0;

    static {
        t2o.a(737149068);
    }

    public static /* synthetic */ Object ipc$super(fph fphVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/cachecleaner/monitor/tracker/MNNFileTracker");
    }
    ...
    public void j(CacheOverviewInfo cacheOverviewInfo) {
        ...
        uTHitBuilders$UTCustomHitBuilder.setEventPage("cache_monitor_mnn_file");
        HashMap hashMap = new HashMap();
        hashMap.put("total_used_size", cacheOverviewInfo.getTotalUsedSize() + "");
        hashMap.put("dir_DAI_size", this.f19453a + "");
        ...
        new StringBuilder("Tracker.Page=cache_monitor_mnn_file.params=").append(hashMap);
    }
}
