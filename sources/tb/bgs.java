...
public class bgs extends ofs {
    ...
    public static /* synthetic */ Object ipc$super(bgs bgsVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/tao/flexbox/layoutmanager/animation/TNodeAnimator/TNodeRotateXAnimator");
    }

    public static bgs o(n nVar, float f, float f2, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (bgs) ipChange.ipc$dispatch("dff0214", new Object[]{nVar, new Float(f), new Float(f2), new Boolean(z)});
        }
        bgs bgsVar = new bgs();
        bgsVar.f(z);
        bgsVar.j(nVar, f, f2);
    ...
    public void l(n nVar, View view, float f) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            nVar.j1("rotateX", Float.valueOf(f), false);
        }
    }
}
