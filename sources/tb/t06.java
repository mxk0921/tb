...
public class t06 extends DXImageWidgetNode {
    ...
    public static /* synthetic */ Object ipc$super(t06 t06Var, String str, Object... objArr) {
        ...
        if (hashCode == -303753557) {
            ...
            throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/taobao/infoflow/core/subservice/base/item/dxservice/impl/dinamic3/widgetnode/DXHomeImageWidgetNode");
        }
    }
    ...
    public final void u(boolean z) {
        ...
        } else if (f4b.b("enableHomePageJumpToNextPageCostOpt2", true) && t(getImageUrl()) && p2b.k()) {
