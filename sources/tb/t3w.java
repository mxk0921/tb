...
public class t3w extends ImageSpan {
    ...
    public t3w(Drawable drawable, int i) {
        super(drawable, i);
    }

    public static /* synthetic */ Object ipc$super(t3w t3wVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/android/detail/core/detail/kit/view/dinamic_ext/view/VerticalCenterImageSpan");
    }
