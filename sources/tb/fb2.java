...
public class fb2 extends eb2 {
    ...
    public WXGesture r = null;

    public fb2(Context context, a aVar, Object... objArr) {
        super(context, aVar, objArr);
    }

    public static /* synthetic */ Object ipc$super(fb2 fb2Var, String str, Object... objArr) {
        ...
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode2 + " in com/alibaba/android/bindingx/plugin/weex/BindingXPinchHandlerCompat");
    }

    @Override // tb.eb2, tb.i3c
    ...
    public boolean j(String str, String str2) {
        ...
        try {
            ...
            gfh.a("[BindingXPinchHandlerCompat] onCreate success. {source:" + str + ",type:" + str2 + "}");
            return true;
        } catch (Throwable th) {
