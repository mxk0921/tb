...
public class dm7 {
    ...
    public static final String CALLBACK_PARAM_PREFIX = "callbackParam";
    ...
    public static final String EVENT_PARAM_PREFIX = "eventParam";
    ...
    public static final fak NL = new fak();
