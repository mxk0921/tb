...
class da9<T> extends fa9<T> {
    public da9(String str, Type type, Class cls, int i, long j, String str2, Method method, Field field) {
    ...
    public void J(JSONReader jSONReader, Object obj) {
        try {
            ((Map) this.g.invoke(obj, new Object[0])).put(jSONReader.L0(), w(jSONReader).o(jSONReader, x(), this.b, 0L));
        } catch (Exception e) {
    ...
    public void L(JSONReader jSONReader, T t) {
        ...
        if (jSONReader.w) {
            obj = this.v.q(jSONReader, x(), this.b, this.e);
        } else {
            obj = this.v.o(jSONReader, x(), this.b, this.e);
        }
        h(t, obj);
    }
