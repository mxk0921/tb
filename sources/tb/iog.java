...
public class iog implements npc {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public final WeakReference<FragmentActivity> f21480a;
    ...
    public iog(FragmentActivity fragmentActivity) {
        this.f21480a = new WeakReference<>(fragmentActivity);
    }
    ...
    public void onRefreshFailed(a aVar, int i, String str, boolean z) {
        ...
        } else if (this.f21480a.get() != null) {
            String valueOf = String.valueOf(i);
            dog.a(this.f21480a.get(), valueOf, "onRefreshFailed" + str);
        }
    }
    ...
    public void onRenderFailed(a aVar, int i, String str, boolean z) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            String valueOf = String.valueOf(i);
            dog.a(this.f21480a.get(), valueOf, "onRenderFailed" + str);
        }
    }
