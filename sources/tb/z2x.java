...
public class z2x extends z8s {
    ...
    public z2x(String str) {
        super(str);
    }

    public static /* synthetic */ Object ipc$super(z2x z2xVar, String str, Object... objArr) {
        if (str.hashCode() == -1265548210) {
            super.f((Application) objArr[0], (HashMap) objArr[1]);
            return null;
        }
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/themis/taobao/initializer/task/early/Weex1SetDefaultAdapterTask");
    }
