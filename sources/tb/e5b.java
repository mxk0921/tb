...
public class e5b extends mr1 {
    ...
    public e5b(String str, JSONObject jSONObject) {
        super(str, jSONObject);
    }

    public static /* synthetic */ Object ipc$super(e5b e5bVar, String str, Object... objArr) {
        str.hashCode();
        int hashCode = str.hashCode();
        throw new InstantReloadException("String switch could not find '" + str + "' with hashcode " + hashCode + " in com/taobao/homepage/business/bizParams/HomepageCommonCollector");
    }
    ...
    public final JSONObject h(String str, String[] strArr) {
        ...
        JSONObject jSONObject = new JSONObject(mr1.c(strArr.length));
